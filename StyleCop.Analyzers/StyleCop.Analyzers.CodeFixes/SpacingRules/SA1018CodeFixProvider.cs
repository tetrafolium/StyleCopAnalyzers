...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// cref="SA1018NullableTypeSymbolsMustNotBePrecededBySpace"/>.
        /// </summary>
        /// <remarks>
        /// <para>To fix a violation of this rule, ensure that there is no whitespace before the
        /// nullable type symbol.</para>
        /// </remarks>
        ...
        internal class SA1018CodeFixProvider : CodeFixProvider
        {
                        ...
                        foreach (var diagnostic in context.Diagnostics)
                                {
                                        ...
                                        if (triviaList.Any (UnsupportedTriviaKind))
                                                {
                                                        // cannot only automatically fix multiline
                                                        // comments (/* ...
                                                        // */)
                                                        continue;
                                                }
                ...
                private static bool
                UnsupportedTriviaKind (SyntaxTrivia trivia)
                {
                        switch (trivia.Kind ())
                                {
                                             ...
                                             CancellationToken cancellationToken)
                {
                        ...
                        var newSyntaxRoot = syntaxRoot.ReplaceTokens (replaceMap.Keys,
                                                                      (t1, t2) => replaceMap[t1]);
