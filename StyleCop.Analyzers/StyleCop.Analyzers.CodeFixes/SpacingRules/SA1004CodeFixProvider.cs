...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// cref="SA1004DocumentationLinesMustBeginWithSingleSpace"/>.
        /// </summary>
        /// <remarks>
        /// <para>To fix a violation of this rule, ensure that the header line begins with a single
        /// space.</para>
        /// </remarks>
        ...
        internal class SA1004CodeFixProvider : CodeFixProvider
        {
                                             ...
                                             CancellationToken cancellationToken)
                {
                        ...
                        return document.WithText (
                            text.WithChanges (GetTextChange (root, diagnostic)));
                }

                private static TextChange
                GetTextChange (SyntaxNode root, Diagnostic diagnostic)
                {
                        var token
