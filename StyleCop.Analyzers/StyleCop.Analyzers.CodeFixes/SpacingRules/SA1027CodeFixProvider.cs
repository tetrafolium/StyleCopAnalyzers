...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        internal class SA1027CodeFixProvider : CodeFixProvider
        {
                ...
                FixDiagnostic (IndentationSettings indentationSettings, SourceText sourceText,
                               Diagnostic diagnostic)
                {
                        ...
                        bool useTabs = false;
                        string behavior;
                        if (diagnostic.Properties.TryGetValue (SA1027UseTabsCorrectly.BehaviorKey,
                                                               out behavior))
                                {
                                        useTabs = behavior
                                                  == SA1027UseTabsCorrectly.ConvertToTabsBehavior;
                                }
                                        ...
                                        if (c == '\t')
                                                {
                                                        ...
                                                        var tabWidth = indentationSettings.TabSize
                                                                       - offsetWithinTabColumn;
                                        ...
                                        else
                                                {
                                                        ...
                                                        if (c == '\r' || c == '\n')
                                                                {
                                                                        // Handle newlines. We can
                                                                        // ignore CR/LF/CRLF issues
                                                                        // because we are only
                                                                        // tracking column position
                                                                        // in a line, and not the
