...
namespace StyleCop.Analyzers.SpacingRules {
        ...
        /// cref="SA1005SingleLineCommentsMustBeginWithSingleSpace"/>.
        /// </summary>
        /// <remarks>
        /// <para>To fix a violation of this rule, ensure that the comment begins with a single
        /// space. If the comment is being used to comment out a line of code, ensure that the
