...
namespace StyleCop.Analyzers.Helpers
{
        ...
        {
                public static async
                    Task<ImmutableDictionary<Document, ImmutableArray<Diagnostic> > >
                        ...
                        switch (fixAllContext.Scope)
                                ...
                                case FixAllScope.Solution:
                                        ...
                                        var diagnostics = new ConcurrentDictionary<
                                            ProjectId, ImmutableArray<Diagnostic> > ();
                                        ...
                                        allDiagnostics
                                            = allDiagnostics.AddRange (diagnostics.SelectMany (
                                                i => i.Value.Where (x => fixAllContext.DiagnosticIds
                                                                             .Contains (x.Id))));
                                        break;
                                }
                ...
                public static async Task<ImmutableDictionary<Project, ImmutableArray<Diagnostic> > >
                                        ...
                                        switch (fixAllContext.Scope)
                                                ...
                                                case FixAllScope.Solution:
                                                        ...
                                                        var tasks = new List<Task> (
                                                            project.Solution.ProjectIds.Count);
                                                        ...
                                                        foreach (var proj in project.Solution
                                                                     .Projects)
                                                                {
                                                                        if (fixAllContext
                                                                                .CancellationToken
                                                        ...
                                                        await Task.WhenAll (tasks).ConfigureAwait (
                                                            false);
                                                        return projectsAndDiagnostics
                ...
                /// <summary>
                /// Gets all <see cref="Diagnostic"/> instances within a specific <see
                /// cref="Project"/> which are relevant to a <see cref="FixAllContext"/>.
                /// </summary>
                ...
                GetAllDiagnosticsAsync (FixAllContext fixAllContext, Project project)
                {
                ...
                GetReportedDocument (Diagnostic diagnostic,
