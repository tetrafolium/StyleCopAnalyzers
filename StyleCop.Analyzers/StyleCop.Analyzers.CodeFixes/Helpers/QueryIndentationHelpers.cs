...
namespace StyleCop.Analyzers.Helpers
{
    ...
    internal static class QueryIndentationHelpers
    {
        ...
        internal static SyntaxTrivia GetQueryIndentationTrivia(IndentationSettings indentationSettings,
                                                               QueryExpressionSyntax queryExpression)
        {
            var firstTokenOnTextLine =
                IndentationHelper.GetFirstTokenOnTextLine(queryExpression.FromClause.FromKeyword);
        ...
        /// <summary>
        /// Gets a whitespace trivia containing the proper amount of indentation for new lines in the query of which the
        /// given token is a part.
        /// </summary>
        /// <param name="indentationSettings">The indentation settings to use.</param>
