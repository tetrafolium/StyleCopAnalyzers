...
namespace StyleCop.Analyzers.Helpers
{
        ...
        internal static class IndentationHelper
        {
                ...
                GetFirstTokenOnTextLine (SyntaxToken token)
                {
                        while (true)
                                {
                ...
                public static int
                GetIndentationSteps (IndentationSettings indentationSettings, SyntaxNode node)
                {
                        return GetIndentationSteps (indentationSettings, node.SyntaxTree,
                ...
                public static int
                GetIndentationSteps (IndentationSettings indentationSettings, SyntaxToken token)
                {
                        ...
                        return token.SyntaxTree
                               != null
                ? GetIndentationSteps (indentationSettings, token.SyntaxTree,
                                                             token.LeadingTrivia)
                            : GetIndentationStepsUnchecked (indentationSettings,
                                                            token.LeadingTrivia);
                }
                                           ...
                                           int indentationSteps)
                {
                        ...
                        if (indentationSettings.UseTabs)
                                {
                                        var tabCount
                                            = indentationCount / indentationSettings.TabSize;
                                        var spaceCount
                                            = indentationCount % indentationSettings.TabSize;
                ...
                private static int
                GetIndentationSteps (IndentationSettings indentationSettings, SyntaxTree syntaxTree,
