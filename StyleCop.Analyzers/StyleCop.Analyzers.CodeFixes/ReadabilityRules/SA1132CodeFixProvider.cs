...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>To fix a violation of this rule, declare each field as part of its own field
        /// definition.</para>
        /// </remarks>
        ...
        internal class SA1132CodeFixProvider : CodeFixProvider
        {
                        ...
                        if (newFieldDeclarations != null)
                                {
                                        ...
                                        editor.InsertAfter (baseFieldDeclaration,
                    ...
                    SyntaxTriviaList declarationTrailingTrivia)
                {
                                                                            ...
                                                                            > 0)
                                                                                {
                                                                                        triviaList
                                                                                            = triviaList
                                                                                                  .RemoveRange (
                                                                                                      0,
                                                                                                      nonBlankLinetriviaIndex);
                                                                                }

                                                                        // Add a blank line if the
                        ...
                        newFieldDeclarations.Add (
                            previous.WithTrailingTrivia (declarationTrailingTrivia));
