...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        internal class SA1130CodeFixProvider : CodeFixProvider {
                ...
                public override async Task RegisterCodeFixesAsync(CodeFixContext context)
                {
                        foreach (var diagnostic in context.Diagnostics) {
                                ...
                                context.RegisterCodeFix(
                                    CodeAction.Create(ReadabilityResources.SA1130CodeFix,
                ...
                private static async Task<bool> CanFixAsync(
                    CodeFixContext context, Diagnostic diagnostic)
                {
                        ...
                        var anonymousMethod = (AnonymousMethodExpressionSyntax) syntaxRoot.FindNode(
                        ...
                        if (parameterList == null) {
                                ...
                                var newList = (parameters.Count > 0)
                                    ? SyntaxFactory.SeparatedList(parameters,
                                        Enumerable.Repeat(
                                            ParameterListSeparator, parameters.Count - 1))
                                    : SyntaxFactory.SeparatedList<ParameterSyntax>();

                                parameterList
                                    = SyntaxFactory.ParameterList(newList).WithLeadingTrivia(
                                        anonymousMethod.DelegateKeyword.LeadingTrivia);
                        ...
                        if (parameterList.Parameters.Count == 1) {
                                ...
                                var trailingTrivia
                                    = parameterSyntax.GetTrailingTrivia()
                                          ...
                                          .Concat(parameterList.CloseParenToken.TrailingTrivia
                                ...
                                parameterSyntax = parameterSyntax.WithLeadingTrivia(leadingTrivia)
                                                      .WithTrailingTrivia(trailingTrivia);

                                lambdaExpression = SyntaxFactory.SimpleLambdaExpression(
                                    anonymousMethod.AsyncKeyword, parameterSyntax, arrowToken,
                                ...
                                lambdaExpression = SyntaxFactory.ParenthesizedLambdaExpression(
                                    anonymousMethod.AsyncKeyword, parameterListSyntax, arrowToken,
                                    anonymousMethod.Body);
                        }
                    ...
                    SemanticModel semanticModel, AnonymousMethodExpressionSyntax anonymousMethod)
                {
                        ...
                        return namedTypeSymbol.DelegateInvokeMethod.Parameters.Select(ps => ps.Name)
                            .ToImmutableArray();
                }

                private static ImmutableArray<string> ? GetAssignmentArgumentList(
                    SemanticModel semanticModel, AnonymousMethodExpressionSyntax anonymousMethod)
                {
                    ...
                    SemanticModel semanticModel, AnonymousMethodExpressionSyntax anonymousMethod)
                {
                        ...
                        return !(((IMethodSymbol) enclosingSymbol)
                            ...
                            : returnType.DelegateInvokeMethod.Parameters.Select(ps => ps.Name)
                                  .ToImmutableArray();
                }
                    ...
                    ImmutableArray<string> argumentNames)
                {
                        ...
                        foreach (var argumentName in argumentNames) {
                                ...
                                parameters.Add(
                                    SyntaxFactory.Parameter(SyntaxFactory.Identifier(newName))
                                        .WithType(null));
                        }
