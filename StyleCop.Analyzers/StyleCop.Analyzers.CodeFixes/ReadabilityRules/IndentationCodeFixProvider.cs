...
namespace StyleCop.Analyzers.ReadabilityRules
{
    ...
    internal class IndentationCodeFixProvider : CodeFixProvider
    {
        ...
        public override Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            {
                context.RegisterCodeFix(CodeAction.Create(ReadabilityResources.IndentationCodeFix,
        ...
        {
            string replacement;
            if (!diagnostic.Properties.TryGetValue(SA1137ElementsShouldHaveTheSameIndentation.ExpectedIndentationKey,
                                                   out replacement))
            {
                textChange = default;
                return false;
