...
namespace StyleCop.Analyzers.OrderingRules
{
        ...
        internal sealed partial class UsingCodeFixProvider : CodeFixProvider
        {
                                ...
                                context.RegisterCodeFix(
                                  CodeAction.Create(
                                    ...
                                    cancellationToken => GetTransformedDocumentAsync(
                                      context.Document, syntaxRoot, !isSA1200, cancellationToken),
                  ...
                  CancellationToken cancellationToken)
                {
                        ...
                        var usingsHelper =
                          new UsingsSorter(settings, semanticModel, compilationUnit, fileHeader);
                        ...
                        BuildReplaceMapForConditionalDirectives(usingsHelper,
                                                                replaceMap,
                        ...
                        if (usingDirectivesPlacement == UsingDirectivesPlacement.InsideNamespace) {
                                newSyntaxRoot = AddUsingsToNamespace(
                                  newSyntaxRoot, usingsHelper, usingsIndentation, replaceMap.Any());
                        ...
                        foreach (var childSpan in rootSpan.Children) {
                                ...
                                if (originalUsings.Count > 0) {
                                        ...
                                        for (var i = 0; i < originalUsings.Count; i++) {
                                                replaceMap.Add(originalUsings[i],
                                                               modifiedUsings[i]);
                                        }
                                }
                ...
                private static int CompareSpanStart(UsingDirectiveSyntax left,
                                                               ...
                                                               bool hasConditionalDirectives)
                {
                        ...
                        var groupedUsings = usingsHelper.GenerateGroupedUsings(
                          TreeTextSpan.Empty, usingsIndentation, withTrailingBlankLine, qualifyNames
                          : false);
                                ...
                                if ((trailingCount + leadingCount) > 1) {
                                        ...
                                        if (trailingCount > 0) {
                                                ...
                                                replaceMap[usingDirective.SemicolonToken] =
                                                  usingDirective.SemicolonToken.WithTrailingTrivia(
                                                    trailingTrivia.Take(trailingTrivia.Count -
                                                                        trailingStripCount));
                        ...
                        public override SyntaxToken VisitToken(SyntaxToken token)
                        {
                                if (this.tokensToStrip.Contains(token)) {
                                        ...
                                        var newLeadingTrivia =
                                          (index == -1) ? SyntaxFactory.TriviaList()
                ...
                private class FixAll : DocumentBasedFixAllProvider
                {
                          ...
                          ImmutableArray<Diagnostic> diagnostics)
                        {
                                ...
                                Document newDocument =
                                  await GetTransformedDocumentAsync(document,
                                                                    syntaxRoot,
                                                                    forcePreserve,
