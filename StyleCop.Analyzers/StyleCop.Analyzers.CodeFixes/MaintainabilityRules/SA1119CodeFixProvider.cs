...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        internal class SA1119CodeFixProvider : CodeFixProvider
        {
                        ...
                        foreach (var diagnostic in context.Diagnostics) {
                                ...
                                if (node is ParenthesizedExpressionSyntax syntax) {
                                        context.RegisterCodeFix(
                                          CodeAction.Create(MaintainabilityResources.SA1119CodeFix,
                                                            cancellationToken =>
                ...
                {
                        var leadingTrivia =
                          SyntaxFactory.TriviaList(oldNode.OpenParenToken.GetAllTrivia().Concat(
                        ...
                        if (!leadingTrivia.Any()) {
                                ...
                                if (!(previousToken.IsKind(SyntaxKind.OpenParenToken) ||
                                    ...
                                    (TriviaHelper.IndexOfTrailingWhitespace(
                                       previousToken.TrailingTrivia) == -1)) {
                                        leadingTrivia =
                          ...
                          ImmutableArray<Diagnostic> diagnostics)
                        {
                                ...
                                return syntaxRoot.ReplaceNodes(
                                  ...
                                  (originalNode, rewrittenNode) =>
                                    GetReplacement((ParenthesizedExpressionSyntax) rewrittenNode));
                        }
                }
        }
}
