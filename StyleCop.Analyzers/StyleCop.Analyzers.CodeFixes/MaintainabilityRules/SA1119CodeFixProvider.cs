...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>To fix a violation of this rule, insert parenthesis within the arithmetic
        /// expression to declare the precedence of the operations.</para>
        /// </remarks>
        ...
        internal class SA1119CodeFixProvider : CodeFixProvider
        {
                ...
                GetReplacement (ParenthesizedExpressionSyntax oldNode)
                {
                        var leadingTrivia = SyntaxFactory.TriviaList (
                            oldNode.OpenParenToken.GetAllTrivia ().Concat (
                                oldNode.Expression.GetLeadingTrivia ()));
                        var trailingTrivia = oldNode.Expression.GetTrailingTrivia ().AddRange (
                            oldNode.CloseParenToken.GetAllTrivia ());

                        // Workaround for Roslyn not handling elastic markers for directive trivia
                        // correctly.
                        if (!leadingTrivia.Any ())
                                {
                                        var previousToken
                                            = oldNode.OpenParenToken.GetPreviousToken ();
                ...
                private class FixAll : DocumentBasedFixAllProvider
                {
                        ...
                        protected override string
                            CodeActionTitle => MaintainabilityResources.SA1119CodeFix;
                                               ...
                                               ImmutableArray<Diagnostic> diagnostics)
                        {
                                ...
                                return syntaxRoot.ReplaceNodes (
                                    nodes, (originalNode, rewrittenNode) => GetReplacement (
