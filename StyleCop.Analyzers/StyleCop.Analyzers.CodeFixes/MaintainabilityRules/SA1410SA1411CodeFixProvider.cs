...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// <summary>
        /// Implements a code fix for <see cref="SA1410RemoveDelegateParenthesisWhenPossible"/> and
        ...
        internal class SA1410SA1411CodeFixProvider : CodeFixProvider
        {
                ...
                GetTransformedDocumentAsync (Document document, SyntaxNode root, SyntaxNode node)
                {
                        ...
                        // We want to keep all trivia. The easiest way to do that is by doing it
                        // manually
                        var newSyntaxRoot
