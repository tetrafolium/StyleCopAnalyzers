...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>To fix a violation of this rule, add an access modifier to the declaration of the
        /// element.</para>
        /// </remarks>
        ...
        internal class SA1400CodeFixProvider : CodeFixProvider
        {
                        ...
                        foreach (var diagnostic in context.Diagnostics)
                                {
                                        ...
                                        SyntaxNode declarationNode
                                            = FindParentDeclarationNode (node);
                ...
                HandleClassDeclaration (ClassDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                HandleInterfaceDeclaration (InterfaceDeclarationSyntax node)
                {
                        SyntaxToken triviaToken = node.Keyword;
                        if (triviaToken.IsMissing)
                                {
                ...
                private static SyntaxNode
                HandleEnumDeclaration (EnumDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                HandleStructDeclaration (StructDeclarationSyntax node)
                {
                        SyntaxToken triviaToken = node.Keyword;
                        if (triviaToken.IsMissing)
                                {
                ...
                private static SyntaxNode
                HandleRecordDeclaration (RecordDeclarationSyntaxWrapper node)
                {
                        SyntaxToken triviaToken = node.Keyword;
                        if (triviaToken.IsMissing)
                                {
                ...
                private static SyntaxNode
                HandleDelegateDeclaration (DelegateDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                HandleEventDeclaration (EventDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                HandleEventFieldDeclaration (EventFieldDeclarationSyntax node)
                {
                        SyntaxToken triviaToken = node.EventKeyword;
                        if (triviaToken.IsMissing)
                                {
                ...
                private static SyntaxNode
                HandleMethodDeclaration (MethodDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                HandlePropertyDeclaration (PropertyDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                HandleFieldDeclaration (FieldDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                HandleOperatorDeclaration (OperatorDeclarationSyntax node)
                {
                        TypeSyntax type = node.ReturnType;
                        if (type == null || type.IsMissing)
                                {
                ...
                private static SyntaxNode
                HandleConversionOperatorDeclaration (ConversionOperatorDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                HandleIndexerDeclaration (IndexerDeclarationSyntax node)
                {
                        TypeSyntax type = node.Type;
                        if (type == null || type.IsMissing)
                                {
                ...
                private static SyntaxNode
                HandleConstructorDeclaration (ConstructorDeclarationSyntax node)
                {
                ...
                private static SyntaxNode
                FindParentDeclarationNode (SyntaxNode node)
                {
                        while (node != null)
                                {
                                        switch (node.Kind ())
                ...
                private static bool
                IsNestedType (BaseTypeDeclarationSyntax typeDeclaration)
                {
                        return typeDeclaration?.Parent is BaseTypeDeclarationSyntax;
                }

                private static bool
                IsNestedType (DelegateDeclarationSyntax delegateDeclaration)
                {
