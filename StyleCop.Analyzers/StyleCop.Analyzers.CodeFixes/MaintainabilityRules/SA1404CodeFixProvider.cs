...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// cref="SA1404CodeAnalysisSuppressionMustHaveJustification"/>.
        /// </summary>
        /// <remarks>
        ...
        internal class SA1404CodeFixProvider : CodeFixProvider
        {
                        ...
                        foreach (var diagnostic in context.Diagnostics)
                                {
                                        ...
                                        if (node is AttributeSyntax attribute)
                                                {
                                                        // In this case there is no justification at
                                                        // all
                                                  ...
                                                  AttributeSyntax attribute)
                {
                        ...
                        var newArgument = SyntaxFactory.AttributeArgument (
                            SyntaxFactory.NameEquals (attributeName), null,
                ...
                GetNewAttributeValue ()
                {
                        return SyntaxFactory.LiteralExpression (
                            ...
                            SyntaxFactory.Literal (
                                SA1404CodeAnalysisSuppressionMustHaveJustification
