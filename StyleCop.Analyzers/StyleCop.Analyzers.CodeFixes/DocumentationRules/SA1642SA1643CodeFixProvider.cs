...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        internal class SA1642SA1643CodeFixProvider : CodeFixProvider
        {
                                                        ...
                                                        context.RegisterCodeFix (
                                                            CodeAction.Create (
                                                                ...
                                                                cancellationToken => GetTransformedDocumentAsync (
                                                                    ...
                                                                    cancellationToken),
                                                                nameof (
                                                                    SA1642SA1643CodeFixProvider)),
                                                            diagnostic);
                                                }
                                        else
                                                {
                                                        var xmlEmptyElementSyntax
                        ...
                        if (methodDeclaration is ConstructorDeclarationSyntax)
                                {
                                        var typeKindText = resourceManager.GetString (
                                            ...
                                            : nameof (DocumentationResources.TypeTextClass),
                                              culture);
                                        if (methodDeclaration.Modifiers.Any (
                                                ...
                                                {
                                                        // Prefer to insert the "non-private"
                                                        // wording for all constructors, even though
                                                        // both are considered acceptable for
                                                        // private constructors by the diagnostic.
                        ...
                        if (IsMultiLine (node))
                                {
                                        string newLineText
                                            = document.Project.Solution.Workspace.Options
                                                  .GetOption (FormattingOptions.NewLine,
                                ...
                                {
                                        list = BuildStandardTextSyntaxList (
                                            typeDeclaration, standardText[0],
                                            standardText[1] + trailingString);
                                }
                ...
                private static bool
                IsMultiLine (XmlElementSyntax node)
                {
                                             ...
                                             XmlEmptyElementSyntax node)
                {
                        ...
                        if (typeDeclaration is ClassDeclarationSyntax classDeclaration)
                                ...
                                {
                                        typeParameterList
                                            = (typeDeclaration as StructDeclarationSyntax)
                                            ?.TypeParameterList;
                                }
                ...
                BuildSeeElement (SyntaxToken identifier, TypeParameterListSyntax typeParameters)
                {
                        ...
                        if (typeParameters == null || !typeParameters.Parameters.Any ())
                                {
                                        identifierName = SyntaxFactory.IdentifierName (
                        ...
                        return XmlSyntaxFactory.SeeElement (
                            SyntaxFactory.TypeCref (identifierName));
                }
                                        ...
                                        newContent
                                            = newContent
                                                  .Add (XmlSyntaxFactory.Text (
                                                      xmlText.TextTokens.Take (firstEmptyToken)
                                                          .ToArray ()))
                                                  .Add (XmlSyntaxFactory.Text (
                                                      xmlText.TextTokens.Last ()));
                                        return newContent;
                                }
