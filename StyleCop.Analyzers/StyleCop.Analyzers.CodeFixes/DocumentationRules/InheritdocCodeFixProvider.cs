...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        internal class InheritdocCodeFixProvider : CodeFixProvider
        {
                ...
                GetTransformedDocumentForBasePropertyDeclaration (
                    ...
                    CancellationToken cancellationToken)
                {
                        ...
                        return InsertInheritdocComment (document, root, basePropertyDeclaration,
                                                        cancellationToken);
                }

                private static Document
                GetTransformedDocumentForMethodDeclaration (
                    Document document, SyntaxNode root, SemanticModel semanticModel,
                    MethodDeclarationSyntax methodDeclaration, CancellationToken cancellationToken)
                {
                        ...
                        return InsertInheritdocComment (document, root, methodDeclaration,
                                                        cancellationToken);
                }

                private static Document
                GetTransformedDocumentForEventFieldDeclaration (
                    Document document, SyntaxNode root, SemanticModel semanticModel,
                    ...
                    CancellationToken cancellationToken)
                {
                        ...
                        return InsertInheritdocComment (document, root, eventFieldDeclaration,
                                                        cancellationToken);
                }
                    ...
                    CancellationToken cancellationToken)
                {
                        ...
                        return InsertInheritdocComment (document, root, indexerDeclaration,
                                                        cancellationToken);
                }
