        ...
        internal class SA1651CodeFixProvider : CodeFixProvider
        {
                        ...
                        foreach (var diagnostic in context.Diagnostics)
                                {
                                        if (diagnostic.Properties.ContainsKey (
                                                ...
                                                {
                                                        // skip diagnostics that should not offer a
                                                        // code fix.
                                                        continue;
                                                }
                                        ...
                                        if (!(syntax is XmlElementSyntax xmlElementSyntax))
                                                {
                                                        // We continue even for placeholders if they
                                                        // are empty elements
                                        ...
                                        context.RegisterCodeFix (
                                            CodeAction.Create (
                                                ...
                                                cancellationToken => this.GetTransformedDocumentAsync (
                                                    context.Document, xmlElementSyntax,
                                                    cancellationToken),
                ...
                RemovePlaceHolder (XmlElementSyntax elementSyntax)
                {
                        ...
                        leadingTrivia = leadingTrivia.AddRange (content [0]
                                                                    .GetLeadingTrivia ());
                        content
                            = content.Replace (content[0], content [0]
                ...
                private class FixAllVisitor : CSharpSyntaxRewriter
                {
                        ...
                        public override SyntaxList<TNode>
                        VisitList<TNode> (SyntaxList<TNode> list)
                        {
