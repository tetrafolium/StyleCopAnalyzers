...
namespace StyleCop.Analyzers.DocumentationRules
{
    ...
    internal class SA1649CodeFixProvider : CodeFixProvider
    {
        ...
        public override Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            {
                context.RegisterCodeFix(CodeAction.Create(DocumentationResources.SA1649CodeFix,
                                                                        ...
                                                                        CancellationToken cancellationToken)
        {
            ...
            var newPath = document.FilePath !=
                          null ? Path.Combine(Path.GetDirectoryName(document.FilePath), expectedFileName) : null;
            ...
            foreach (var linkedDocumentId in document.GetLinkedDocumentIds())
            {
                ...
                newSolution =
                    newSolution.AddDocument(linkedExtractedDocumentId, expectedFileName, syntaxRoot, document.Folders);
            }
