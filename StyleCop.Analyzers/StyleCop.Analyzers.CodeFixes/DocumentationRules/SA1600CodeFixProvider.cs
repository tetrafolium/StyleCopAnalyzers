...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        internal class SA1600CodeFixProvider : CodeFixProvider
        {
                ...
                private static bool
                IsCoveredByInheritDoc (SemanticModel semanticModel,
                                       MethodDeclarationSyntax methodDeclaration,
                                       CancellationToken cancellationToken)
                {
                        ...
                        ISymbol declaredSymbol = semanticModel.GetDeclaredSymbol (
                            methodDeclaration, cancellationToken);
                    ...
                    MethodDeclarationSyntax methodDeclaration, CancellationToken cancellationToken)
                {
                        ...
                        if (methodDeclaration.TypeParameterList != null)
                                {
                                        foreach (var typeParameter in methodDeclaration
                                                     .TypeParameterList.Parameters)
                                                {
                                                        documentationNodes.Add (
                                                            XmlSyntaxFactory.NewLine (newLineText));
                                                        documentationNodes.Add (
                                                            XmlSyntaxFactory.TypeParamElement (
                ...
                private static int
                GetInsertionIndex (ref SyntaxTriviaList leadingTrivia)
                {
