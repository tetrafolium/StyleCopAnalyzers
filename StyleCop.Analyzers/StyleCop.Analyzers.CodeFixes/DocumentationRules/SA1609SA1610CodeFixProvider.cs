...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>To fix a violation of this rule, fill-in a description of the value held by the
        /// property within the &lt;value&gt; tag.</para>
        /// </remarks>
        ...
        internal class SA1609SA1610CodeFixProvider : CodeFixProvider
        {
                ...
                private static bool
                IsContentElement (XmlNodeSyntax syntax)
                {
                        switch (syntax.Kind ())
                                {
                                             ...
                                             CancellationToken cancellationToken)
                {
                        ...
                        if (!this.TryRemoveSummaryPrefix (ref summaryContent, "Gets or sets "))
                                {
                                        if (!this.TryRemoveSummaryPrefix (ref summaryContent,
                                                                          "Gets "))
                                                {
                                                        this.TryRemoveSummaryPrefix (
                                                            ref summaryContent, "Sets ");
                                                }
                                }
                        ...
                        if (!exteriorTrivia.Token.IsMissing)
                                {
                                        ...
                                        valueElement
                                            = valueElement.ReplaceExteriorTrivia (exteriorTrivia);
                                }
                                        ...
                                        DocumentationCommentTriviaSyntax newDocumentationComment
                                            = documentationComment.WithContent (
                                                documentationComment.Content.InsertRange (
                                                    ...
                                                    XmlSyntaxFactory.List (leadingNewLine,
                                                                           valueElement)));

                                        newRoot = root.ReplaceNode (documentationComment,
                                                                    newDocumentationComment);
                                }
                ...
                private bool
                TryRemoveSummaryPrefix (ref SyntaxList<XmlNodeSyntax> summaryContent, string prefix)
                {
                        ...
                        if (!firstTextContent.TrimStart ().StartsWith (prefix,
                        ...
                        if (index >= 0)
                                {
                                        ...
                                        text
                                            = text.Substring (0, index)
                                              ...
                                              + text.Substring (
                                                  index
                                                  + (additionalCharacters ? (prefix.Length + 1)
                                                     : prefix.Length));
                                }
                        ...
                        SyntaxToken replaced
                            = SyntaxFactory.Token (prefixToken.LeadingTrivia, prefixToken.Kind (),
                                                   text, valueText, prefixToken.TrailingTrivia);
