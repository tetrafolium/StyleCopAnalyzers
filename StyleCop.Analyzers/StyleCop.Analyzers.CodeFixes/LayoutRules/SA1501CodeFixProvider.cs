        ...
        internal class SA1501CodeFixProvider : CodeFixProvider
        {
                        ...
                        foreach (Diagnostic diagnostic in context.Diagnostics)
                                {
                                        if (diagnostic.Properties.GetValueOrDefault (
                                                SA1501StatementMustNotBeOnASingleLine
                                                    .SuppressCodeFixKey)
                                            == SA1501StatementMustNotBeOnASingleLine
                    ...
                    Dictionary<SyntaxToken, SyntaxToken> tokenReplaceMap)
                {
                        ...
                        if (block != null)
                                ...
                                {
                                        ReformatStatement (indentationSettings, statement,
                                                           tokenReplaceMap);
                                }
                                           ...
                                           StatementSyntax statement)
                {
                        ...
                        if (tokenReplaceMap.TryGetValue (parent.GetFirstToken (),
                                ...
                                {
                                        // if the parent is being modified, use the new leading
                                        // trivia from the parent for determining the indentation
                               ...
                               Dictionary<SyntaxToken, SyntaxToken> tokenReplaceMap)
                {
                        ...
                        if (addNewLineAfterCloseBrace)
                                {
                                        newCloseBraceTrailingTrivia
                                            = newCloseBraceTrailingTrivia.Add (
                                                SyntaxFactory.CarriageReturnLineFeed);
                                }
                        ...
                        foreach (var statement in block.Statements)
                                {
                                        ...
                                        var newLeadingTrivia
                                            = firstToken.LeadingTrivia.WithoutTrailingWhitespace ()
                                                  .Add (SyntaxFactory.Whitespace (
                                                      statementIndentationString));

                                        var newTrailingTrivia
                                            = lastToken.TrailingTrivia.WithoutTrailingWhitespace ()
                                                  .Add (SyntaxFactory.CarriageReturnLineFeed);

                                        AddToReplaceMap (
                                            tokenReplaceMap, firstToken,
                                            firstToken.WithLeadingTrivia (newLeadingTrivia));
                                        AddToReplaceMap (
                                            tokenReplaceMap, lastToken,
                                   ...
                                   Dictionary<SyntaxToken, SyntaxToken> tokenReplaceMap)
                {
                        ...
                        var statementIndentationTrivia
                            = IndentationHelper.GenerateWhitespaceTrivia (indentationSettings,
                                                                          indentationLevel + 1);
                        ...
                        if (tokenReplaceMap.TryGetValue (original, out existingReplacement))
                                {
                                        reprocessedReplacement
                                            = AreTriviaEqual (original.LeadingTrivia,
                                                  ...
                                                  : existingReplacement;
                                        reprocessedReplacement
                                            = reprocessedReplacement.WithTrailingTrivia (
                ...
                private static bool
                AreTriviaEqual (SyntaxTriviaList left, SyntaxTriviaList right)
                {
                ...
                GetStatementParent (SyntaxNode node)
                {
                ...
                private static SyntaxNode
                GetFirstOnLineParent (SyntaxNode parent)
                {
                ...
                private class FixAll : DocumentBasedFixAllProvider
                {
                                               ...
                                               ImmutableArray<Diagnostic> diagnostics)
                        {
                                ...
                                foreach (var diagnostic in diagnostics.Sort (
                                             DiagnosticComparer.Instance))
                                        {
                                                ...
                                                ReformatStatementAndSurroundings (
                                                    statement, settings.Indentation,
                                                    tokenReplaceMap);
                                        }
                        ...
                        private class DiagnosticComparer : IComparer<Diagnostic>
                        {
                                ...
                                /// <inheritdoc/>
                                public int
                                Compare (Diagnostic x, Diagnostic y)
                                {
