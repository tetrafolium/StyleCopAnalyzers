...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        /// cref="SA1514ElementDocumentationHeaderMustBePrecededByBlankLine"/>.
        /// </summary>
        ...
        internal class SA1514CodeFixProvider : CodeFixProvider {
                ...
                = ImmutableArray.Create(
                    SA1514ElementDocumentationHeaderMustBePrecededByBlankLine.DiagnosticId);
                ...
                public override Task RegisterCodeFixesAsync(CodeFixContext context)
                {
                        foreach (Diagnostic diagnostic in context.Diagnostics) {
                                context.RegisterCodeFix(
                                    CodeAction.Create(LayoutResources.SA1514CodeFix,
                    ...
                    Document document, Diagnostic diagnostic, CancellationToken cancellationToken)
                {
                        ...
                        var newLeadingTrivia = documentationHeader.Token.LeadingTrivia.Insert(
                            index + 1, SyntaxFactory.CarriageReturnLineFeed);
