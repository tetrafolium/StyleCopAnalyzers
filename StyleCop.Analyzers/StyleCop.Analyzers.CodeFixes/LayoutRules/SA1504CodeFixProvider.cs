        ...
        internal class SA1504CodeFixProvider : CodeFixProvider
        {
                  ...
                  CancellationToken cancellationToken)
                {
                        ...
                        var newSyntaxRoot = syntaxRoot.ReplaceNodes(
                          replacements.Keys, (original, maybeRewritten) => replacements[original]);
                ...
                {
                        var newAccessor =
                          accessor.WithModifiers(ReformatModifiersAsSingleLine(accessor.Modifiers))
                ...
                private static SyntaxTokenList ReformatModifiersAsSingleLine(
                  SyntaxTokenList modifiers)
                {
                        ...
                        var reformattedModifiers = modifiers.Select(
                          t =>
                            t.WithLeadingTrivia(ReformatTriviaListNoLeadingSpace(t.LeadingTrivia))
                ...
                private static BlockSyntax ReformatBodyAsSingleLine(BlockSyntax body)
                {
                        ...
                        if (body.Statements.Count > 0) {
                                var reformattedStatement =
                                  body
                                    .Statements [0]
                                    .WithLeadingTrivia(ReformatTriviaList(body
                                                                            .Statements [0]
                                                                            .GetLeadingTrivia()))
                                    .WithTrailingTrivia(
                                      ReformatTriviaListNoTrailingSpace(body
                                                                          .Statements [0]
                                                                          .GetTrailingTrivia()));
                        ...
                        var newCloseBraceToken =
                          body.CloseBraceToken
                            ...
                            .WithTrailingTrivia(
                              ReformatTriviaListNoTrailingSpace(body.CloseBraceToken.TrailingTrivia)
                  ...
                  AccessorDeclarationSyntax accessor)
                {
                        ...
                        var newAccessor =
                          accessor
                            .WithModifiers(
                              ReformatModifiersAsMultipleLines(accessor.Modifiers, indentation))
                  ...
                  SyntaxTrivia indentationStatements)
                {
                        ...
                        if (body.Statements.Count > 0) {
                                ...
                                var triviaBetweenBraces =
                                  TriviaHelper.MergeTriviaLists(body.OpenBraceToken.TrailingTrivia,
                                                                body.CloseBraceToken.LeadingTrivia);
                                reformattedOpenBraceTrailingTrivia =
                        ...
                        var newOpenBraceToken =
                          body.OpenBraceToken
                            .WithLeadingTrivia(
                              ReformatTriviaListNoLeadingSpace(body.OpenBraceToken.LeadingTrivia)
                ...
                private static SyntaxTriviaList ReformatTriviaList(
                  IReadOnlyList<SyntaxTrivia> triviaList)
                {
                        return ReformatTriviaListNoTrailingSpace(triviaList)
                          .Add(SyntaxFactory.Space);
                }

                private static SyntaxTriviaList ReformatTriviaListNoTrailingSpace(
                  IReadOnlyList<SyntaxTrivia> triviaList)
                {
                ...
                private static SyntaxTriviaList ReformatTriviaListNoLeadingSpace(
                  IReadOnlyList<SyntaxTrivia> triviaList)
                {
