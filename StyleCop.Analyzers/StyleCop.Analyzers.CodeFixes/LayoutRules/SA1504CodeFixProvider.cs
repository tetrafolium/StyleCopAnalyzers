...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        internal class SA1504CodeFixProvider : CodeFixProvider {
                    ...
                    Document document, Diagnostic diagnostic, CancellationToken cancellationToken)
                {
                        ...
                        var newSyntaxRoot = syntaxRoot.ReplaceNodes(replacements.Keys,
                    ...
                    SyntaxTokenList modifiers, SyntaxTrivia indentation)
                {
                        ...
                        var reformattedModifiers
                            = modifiers
                                  .Select(t => t.WithLeadingTrivia(ReformatTriviaListNoLeadingSpace(
                                                                       t.LeadingTrivia))
                                                   .WithTrailingTrivia(
                ...
                private static SyntaxToken ReformatKeywordAsMultipleLines(
                    SyntaxToken keyword, SyntaxTrivia indentation, bool insertIdentation)
                {
                ...
                private static BlockSyntax ReformatBodyAsMultipleLines(
                    BlockSyntax body, SyntaxTrivia indentation, SyntaxTrivia indentationStatements)
                {
