...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        internal class SA1502CodeFixProvider : CodeFixProvider {
                ...
                public override Task RegisterCodeFixesAsync(CodeFixContext context)
                {
                        foreach (Diagnostic diagnostic in context.Diagnostics) {
                                context.RegisterCodeFix(
                                    CodeAction.Create(LayoutResources.SA1502CodeFix,
                ...
                private Document CreateCodeFix(Document document,
                    IndentationSettings indentationSettings, Diagnostic diagnostic,
                    SyntaxNode syntaxRoot)
                {
                        ...
                        case SyntaxKind.EnumDeclaration:
                                newSyntaxRoot = this.RegisterBaseTypeDeclarationCodeFix(syntaxRoot,
                                    (BaseTypeDeclarationSyntax) node, indentationSettings);
                                break;
                        ...
                        case SyntaxKind.Block:
                                if (node.Parent.IsKind(SyntaxKindEx.LocalFunctionStatement)) {
                                        newSyntaxRoot
                                            = this.RegisterLocalFunctionStatementCodeFix(syntaxRoot,
                        ...
                        case SyntaxKind.NamespaceDeclaration:
                                newSyntaxRoot = this.RegisterNamespaceDeclarationCodeFix(syntaxRoot,
                                    (NamespaceDeclarationSyntax) node, indentationSettings);
                                break;
                        }
                ...
                private SyntaxNode RegisterBaseTypeDeclarationCodeFix(SyntaxNode syntaxRoot,
                    BaseTypeDeclarationSyntax node, IndentationSettings indentationSettings)
                {
                ...
                private SyntaxNode RegisterPropertyLikeDeclarationCodeFix(SyntaxNode syntaxRoot,
                    BasePropertyDeclarationSyntax node, IndentationSettings indentationSettings)
                {
                        return this.ReformatElement(syntaxRoot, node,
                            node.AccessorList.OpenBraceToken, node.AccessorList.CloseBraceToken,
                            indentationSettings);
                }

                private SyntaxNode RegisterMethodLikeDeclarationCodeFix(SyntaxNode syntaxRoot,
                    BaseMethodDeclarationSyntax node, IndentationSettings indentationSettings)
                {
                ...
                private SyntaxNode RegisterNamespaceDeclarationCodeFix(SyntaxNode syntaxRoot,
                    NamespaceDeclarationSyntax node, IndentationSettings indentationSettings)
                {
                        return this.ReformatElement(syntaxRoot, node, node.OpenBraceToken,
                            node.CloseBraceToken, indentationSettings);
                }
                    ...
                    IndentationSettings indentationSettings)
                {
                        ...
                        if (parentEndLine == blockStartLine) {
                                var newTrailingTrivia
                                    = parentLastToken.TrailingTrivia.WithoutTrailingWhitespace()
                                          .Add(SyntaxFactory.CarriageReturnLineFeed);

                                tokenSubstitutions.Add(parentLastToken,
                        ...
                        tokenSubstitutions.Add(openBraceToken,
                        ...
                        tokenSubstitutions.Add(closeBraceToken,
                ...
                private SyntaxToken FormatBraceToken(
                    SyntaxToken braceToken, string indentationString)
                {
