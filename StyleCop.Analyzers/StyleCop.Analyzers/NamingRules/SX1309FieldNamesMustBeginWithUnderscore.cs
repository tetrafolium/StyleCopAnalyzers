...
namespace StyleCop.Analyzers.NamingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when a field name does not begin with an
        /// underscore.</para>
        ///
        /// <para>This rule is an alternative to rule <see
        /// cref="SA1309FieldNamesMustNotBeginWithUnderscore"/> for development teams who prefer to
        /// prefix fields with an underscore.</para>
        ///
        /// <para>If the field or variable name is intended to match the name of an item associated
        /// with Win32 or COM, and thus needs to not begin with an underscore, place the field or
        ...
        internal class SX1309FieldNamesMustBeginWithUnderscore : DiagnosticAnalyzer
        {
                ...
                /// cref="SX1309FieldNamesMustBeginWithUnderscore"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title =
                  new LocalizableResourceString(nameof(NamingResources.SX1309Title),
                                                NamingResources.ResourceManager,
                                                typeof(NamingResources));
                private static readonly LocalizableString MessageFormat =
                  new LocalizableResourceString(nameof(NamingResources.SX1309MessageFormat),
                                                NamingResources.ResourceManager,
                                                typeof(NamingResources));
                private static readonly LocalizableString Description =
                  new LocalizableResourceString(nameof(NamingResources.SX1309Description),
                                                NamingResources.ResourceManager,
                                                typeof(NamingResources));
