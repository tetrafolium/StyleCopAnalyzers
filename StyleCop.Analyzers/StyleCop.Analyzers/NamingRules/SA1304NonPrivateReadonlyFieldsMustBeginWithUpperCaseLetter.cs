...
namespace StyleCop.Analyzers.NamingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the name of a readonly field which is not
        /// private does not begin with an upper-case letter. Non-private readonly fields should
        /// always start with an upper-case letter.</para>
        ///
            ...
            : DiagnosticAnalyzer
        {
                ...
                HandleFieldDeclaration (SyntaxNodeAnalysisContext context)
                {
                        ...
                        if (!syntax.Modifiers.Any (SyntaxKind.InternalKeyword))
                                {
                                        // SA1307 is taken precedence here. SA1307 should be
                                        // reported if the field is accessible. So if SA1307 is
                                        // enabled this diagnostic will only be reported for
                                        // internal fields.
                        ...
                        foreach (VariableDeclaratorSyntax variableDeclarator in variables.Value)
                                {
                                        ...
                                        // Non-private readonly fields should begin with upper-case
                                        // letter.
