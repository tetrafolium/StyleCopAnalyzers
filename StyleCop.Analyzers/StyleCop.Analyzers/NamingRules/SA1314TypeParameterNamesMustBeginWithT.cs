...
namespace StyleCop.Analyzers.NamingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the name of a C# type parameter does not
        /// begin with the capital letter T. Type parameter names should always begin with T. For
        ...
        internal class SA1314TypeParameterNamesMustBeginWithT : DiagnosticAnalyzer
        {
                ...
                Initialize (AnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction (TypeParameterAction,
                                                          SyntaxKind.TypeParameter);
                }

                private static void
                HandleTypeParameter (SyntaxNodeAnalysisContext context)
                {
