...
namespace StyleCop.Analyzers.NamingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the name of a field marked with the
        /// <c>const</c> attribute does not begin with an upper-case letter.</para>
        ///
        ...
        internal class SA1303ConstFieldNamesMustBeginWithUpperCaseLetter : DiagnosticAnalyzer
        {
                ...
                private static class Analyzer
                {
                        public static void HandleFieldDeclaration(SymbolAnalysisContext context)
                        {
                                 ...
                                 *  1. Fields starting with `_` should be reported as SA1309 instead
                                 * of this diagnostic
                                 *  2. Foreign languages may not have upper case variants for
                                 * certain characters
