...
namespace StyleCop.Analyzers.NamingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the name of an interface does not begin with
        /// the capital letter I. Interface names should always begin with I. For example,
        /// <c>ICustomer</c>.</para>
        ///
        /// <para>If the field or variable name is intended to match the name of an item associated
        /// with Win32 or COM, and thus cannot begin with the letter I, place the field or variable
        ...
        internal class SA1302InterfaceNamesMustBeginWithI : DiagnosticAnalyzer
        {
                ...
                private static void
                HandleInterfaceDeclaration (SyntaxNodeAnalysisContext context)
                {
