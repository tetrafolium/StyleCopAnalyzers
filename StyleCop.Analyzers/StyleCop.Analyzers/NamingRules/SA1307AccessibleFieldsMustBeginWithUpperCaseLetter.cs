...
namespace StyleCop.Analyzers.NamingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the name of a public or internal field begins
        /// with a lower-case letter. Public or internal fields should being with an upper-case
        /// letter.</para>
        ///
        /// <para>If the field or variable name is intended to match the name of an item associated
        /// with Win32 or COM, and thus needs to start with a lower-case letter, place the field or
                        ...
                        if (declaration.Declaration != null)
                                {
                                        ...
                                        if (declaration.Modifiers.Any (SyntaxKind.PublicKeyword)
                                            || declaration.Modifiers.Any (
                                                ...
                                                {
                                                        foreach (VariableDeclaratorSyntax
