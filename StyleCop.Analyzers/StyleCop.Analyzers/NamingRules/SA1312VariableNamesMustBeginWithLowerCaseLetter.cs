...
/// </summary>
/// <remarks>
/// <para>A violation of this rule occurs when the name of a variable does not begin with a lower-case
/// letter.</para>
///
...
{
/// <summary>
/// The ID for diagnostics produced by the <see cref="SA1312VariableNamesMustBeginWithLowerCaseLetter"/>
/// analyzer.
/// </summary>
...
private static readonly LocalizableString Title = new LocalizableResourceString(
	nameof(NamingResources.SA1312Title), NamingResources.ResourceManager, typeof(NamingResources));
private static readonly LocalizableString MessageFormat = new LocalizableResourceString(
	nameof(NamingResources.SA1312MessageFormat), NamingResources.ResourceManager, typeof(NamingResources));
private static readonly LocalizableString Description = new LocalizableResourceString(
	nameof(NamingResources.SA1312Description), NamingResources.ResourceManager, typeof(NamingResources));
...
private static readonly Action<SyntaxNodeAnalysisContext> SingleVariableDesignationAction =
	HandleSingleVariableDesignation;
