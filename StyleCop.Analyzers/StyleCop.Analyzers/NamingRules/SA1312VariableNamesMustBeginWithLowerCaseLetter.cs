...
namespace StyleCop.Analyzers.NamingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the name of a variable does not begin with a
        /// lower-case letter.</para>
        ///
        /// <para>If the variable name is intended to match the name of an item associated with
        /// Win32 or COM, and thus needs to begin with an upper-case letter, place the variable
