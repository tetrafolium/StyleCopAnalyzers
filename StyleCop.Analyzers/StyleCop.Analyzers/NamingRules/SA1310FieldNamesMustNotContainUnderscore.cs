...
namespace StyleCop.Analyzers.NamingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when a field name contains an underscore. Fields
        /// and variables should be named using descriptive, readable wording which describes the
        /// function of the field or variable. Typically, these names will be written using camel
        /// case, and should not use underscores. For example, use <c>customerPostCode</c> rather
        /// than <c>customer_post_code</c>.</para>
        ///
        /// <para>If the field or variable name is intended to match the name of an item associated
        /// with Win32 or COM, and thus needs to include underscores, place the field or variable
        ...
        internal class SA1310FieldNamesMustNotContainUnderscore : DiagnosticAnalyzer {
                ...
                private static readonly LocalizableString Title
                    = new LocalizableResourceString(nameof(NamingResources.SA1310Title),
