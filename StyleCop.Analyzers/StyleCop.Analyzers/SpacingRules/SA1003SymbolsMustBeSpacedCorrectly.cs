...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        internal class SA1003SymbolsMustBeSpacedCorrectly : DiagnosticAnalyzer {
                ...
                private static readonly ImmutableArray<SyntaxKind> BinaryExpressionKinds
                    = ImmutableArray.Create(SyntaxKind.CoalesceExpression, SyntaxKind.IsExpression,
                ...
                private static readonly ImmutableArray<SyntaxKind> PrefixUnaryExpressionKinds
                    = ImmutableArray.Create(SyntaxKind.UnaryPlusExpression,
                        SyntaxKind.UnaryMinusExpression, SyntaxKind.BitwiseNotExpression,
                        SyntaxKind.LogicalNotExpression, SyntaxKind.PreIncrementExpression,
                        SyntaxKind.PreDecrementExpression, SyntaxKind.AddressOfExpression);
                ...
                = new DiagnosticDescriptor(DiagnosticId, Title,
                    MessageFormatNotPrecededByWhitespace, AnalyzerCategory.SpacingRules,
                ...
                = new DiagnosticDescriptor(DiagnosticId, Title,
                    MessageFormatNotFollowedByWhitespace, AnalyzerCategory.SpacingRules,
                    DiagnosticSeverity.Warning, AnalyzerConstants.EnabledByDefault, Description,
                    HelpLink);
                ...
                = new DiagnosticDescriptor(DiagnosticId, Title, MessageFormatNotAtEndOfLine,
                    AnalyzerCategory.SpacingRules, DiagnosticSeverity.Warning,
                    AnalyzerConstants.EnabledByDefault, Description, HelpLink);
                ...
                public override void Initialize(AnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction(
                            ConditionalExpressionAction, SyntaxKind.ConditionalExpression);
                        context.RegisterSyntaxNodeAction(TypeParameterConstraintClauseAction,
                            SyntaxKind.TypeParameterConstraintClause);
                        context.RegisterSyntaxNodeAction(
                            BinaryExpressionAction, BinaryExpressionKinds);
                        context.RegisterSyntaxNodeAction(
                            PrefixUnaryExpressionAction, PrefixUnaryExpressionKinds);
                        context.RegisterSyntaxNodeAction(
                            PostfixUnaryExpressionAction, PostfixUnaryExpressionKinds);
                        context.RegisterSyntaxNodeAction(
                            AssignmentExpressionAction, AssignmentExpressionKinds);
                        context.RegisterSyntaxNodeAction(
                            CastExpressionAction, SyntaxKind.CastExpression);
                        context.RegisterSyntaxNodeAction(
                            EqualsValueClauseAction, SyntaxKind.EqualsValueClause);
                        context.RegisterSyntaxNodeAction(
                            LambdaExpressionAction, SyntaxKinds.LambdaExpression);
                        context.RegisterSyntaxNodeAction(
                            ArrowExpressionClauseAction, SyntaxKind.ArrowExpressionClause);
                }
                                ...
                                if (followingTrivia.Any(SyntaxKind.SingleLineCommentTrivia)
                                    || followingTrivia.Any(SyntaxKind.MultiLineCommentTrivia)) {
                                        context.ReportDiagnostic(
                                            Diagnostic.Create(DescriptorNotFollowedByComment,
                ...
                private static void CheckToken(SyntaxNodeAnalysisContext context, SyntaxToken token,
                    bool withLeadingWhitespace, bool allowAtEndOfLine, bool withTrailingWhitespace,
