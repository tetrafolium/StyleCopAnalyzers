...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when a single-line comment does not begin with a
        /// single space. For example:</para>
        ///
        /// <code language="cs">
        ...
        /// </code>
        ///
        /// <para>The comments should begin with a single space after the leading forward
        /// slashes:</para>
        ///
        /// <code language="cs">
        /// private void Method1()
        ...
        /// </code>
        ///
        /// <para>An exception to this rule occurs when the comment is being used to comment out a
        /// line of code. In this case, the space can be omitted if the comment begins with four
        /// forward slashes to indicate out-commented code. For example:</para>
        ///
        /// <code language="cs">
        /// private void Method1()
        /// {
        ...
        internal class SA1005SingleLineCommentsMustBeginWithSingleSpace : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (SpacingResources.SA1005Title), SpacingResources.ResourceManager,
                ...
                private static void
                HandleSingleLineCommentTrivia (SyntaxTreeAnalysisContext context,
                                               SyntaxTrivia trivia, bool isFirstSingleLineTrivia)
                {
                        ...
                        // special case: commented code or documentation if the parsers
                        // documentation mode is DocumentationMode.None
