...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// <summary>
        /// A line within a documentation header above a C# element does not begin with a single
        /// space.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when a line within a documentation header does not
        /// begin with a single space. For example:</para>
        ///
        /// <code language="cs">
        /// ///&lt;summary&gt;
        /// ///The summary text.
        ...
        /// </code>
        ///
        /// <para>The header lines should begin with a single space after the three leading forward
        /// slashes:</para>
        ///
        /// <code language="cs">
        /// /// &lt;summary&gt;
                        ...
                        foreach (var trivia in root.DescendantTrivia (descendIntoTrivia : true))
                                {
                                        switch (trivia.Kind ())
                                                ...
                                                case SyntaxKind.DocumentationCommentExteriorTrivia:
                                                        HandleDocumentationCommentExteriorTrivia (
                                                            context, trivia);
                                                        break;
                                                          ...
                                                          SyntaxTrivia trivia)
                {
                        ...
                        switch (token.Kind ())
                                ...
                                case SyntaxKind.XmlCDataEndToken:
                                        ...
                                        SyntaxTrivia lastLeadingTrivia
                                ...
                                case SyntaxKind.XmlTextLiteralToken:
                                        if (token.Text.StartsWith ("  ", StringComparison.Ordinal))
                                        ...
                                        else if (trivia.ToFullString ().EndsWith (" "))
                                                {
                                                        ...
                                                        // without a leading * on one of the lines.
                                                        return;
                                                }
