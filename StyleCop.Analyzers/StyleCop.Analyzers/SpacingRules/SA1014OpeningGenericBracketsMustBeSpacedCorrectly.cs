...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the spacing around an opening generic bracket
        /// is not correct.</para>
        ///
        /// <para>An opening generic bracket should never be preceded or followed by whitespace,
        /// unless the bracket is the first or last character on the line.</para>
        /// </remarks>
        ...
        internal class SA1014OpeningGenericBracketsMustBeSpacedCorrectly : DiagnosticAnalyzer
        {
                ...
                /// cref="SA1014OpeningGenericBracketsMustBeSpacedCorrectly"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (SpacingResources.SA1014Title), SpacingResources.ResourceManager,
                    typeof (SpacingResources));
                private static readonly LocalizableString MessageFormat
                    = new LocalizableResourceString (nameof (SpacingResources.SA1014MessageFormat),
                                                     SpacingResources.ResourceManager,
                                                     typeof (SpacingResources));
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (nameof (SpacingResources.SA1014Description),
                                                     SpacingResources.ResourceManager,
                                                     typeof (SpacingResources));
                ...
                private static void
                HandleLessThanToken (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                        ...
                        if (!firstInLine && precededBySpace)
                                {
                                        // Opening generic brackets should not be {preceded} by a
                                        // space.
                        ...
                        if (followedBySpace)
                                {
                                        // Opening generic brackets should not be {followed} by a
                                        // space.
