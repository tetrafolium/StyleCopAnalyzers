...
namespace StyleCop.Analyzers.SpacingRules {
        ...
        internal class SA1014OpeningGenericBracketsMustBeSpacedCorrectly : DiagnosticAnalyzer {
                ...
                private static void HandleLessThanToken(SyntaxTreeAnalysisContext context,
                                                        SyntaxToken token) {
                        if (token.IsMissing) {
                                return;
                        }
                        ...
                        if (!firstInLine && precededBySpace) {
                                ...
                                context.ReportDiagnostic(Diagnostic.Create(
                                    Descriptor, token.GetLocation(), properties, "preceded"));
                        }
                        ...
                        if (followedBySpace) {
                                ...
                                context.ReportDiagnostic(Diagnostic.Create(
                                    Descriptor, token.GetLocation(), properties, "followed"));
                        }
                }
        }
}
