...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the opening parenthesis within a statement is
        /// not spaced correctly. An opening parenthesis should not be preceded by any whitespace,
        /// unless it is the first character on the line, or it is preceded by certain C# keywords
        /// such as if, while, or for. In addition, an opening parenthesis is allowed to be preceded
        /// by whitespace when it follows an operator symbol within an expression.</para>
        ///
        /// <para>An opening parenthesis should not be followed by whitespace, unless it is the last
        ...
        internal class SA1008OpeningParenthesisMustBeSpacedCorrectly : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (SpacingResources.SA1008Title), SpacingResources.ResourceManager,
                ...
                /// </summary>
                /// <value>The diagnostic descriptor for an opening parenthesis that should not be
                /// preceded by whitespace.</value>
                ...
                /// <summary>
                /// Gets the diagnostic descriptor for an opening parenthesis that should be
                /// preceded by whitespace.
                /// </summary>
                /// <value>The diagnostic descriptor for an opening parenthesis that should be
                /// preceded by whitespace.</value>
                ...
                private static void
                HandleOpenParenToken (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                        ...
                        // Don't check leading spaces when preceded by a keyword that is already
                        // handled by SA1000
                        ...
                        if (prevToken.GetLineSpan ().EndLinePosition.Line
                            < token.GetLineSpan ().StartLinePosition.Line)
                                {
                                        var done = false;
                                        for (var i = leadingTriviaList.Count - 1; !done && (i >= 0);
                                             i--)
                                                {
                        ...
                        switch (token.Parent.Kind ())
                                ...
                                case SyntaxKindEx.PositionalPatternClause:
                                        haveLeadingSpace
                                            = prevToken.IsKind (SyntaxKind.IsKeyword)
                        ...
                        if (!prevTokenIsOpenParen && !precededByKeyword)
                                {
                                        ...
                                        var hasLeadingSpace = (leadingTriviaList.Count > 0)
                                                              && leadingTriviaList.Last ().IsKind (
