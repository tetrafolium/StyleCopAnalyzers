...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the spacing around a colon is not
        /// correct.</para>
        ///
        /// <para>The spacing around a colon depends upon the type of colon and how it is used
        /// within the code. A colon appearing within an element declaration should always have a
        /// single space on either side, unless it is the first or last character on the line. For
        /// example all of the colons below follow this rule:</para>
        ///
        /// <code language="cs">
        ...
        /// </code>
        ///
        /// <para>When the colon comes at the end of a label or case statement, it should always be
        /// followed by whitespace or be the last character on the line, but should never be
        /// preceded by whitespace. For example:</para>
        ///
        /// <code language="cs">
        /// _label:
        /// switch (x)
        ...
        /// </code>
        ///
        /// <para>A colon that appears as part of a string interpolation formatting component should
        /// not have leading whitespace characters. For example:</para>
        ///
        /// <code language="cs">
        /// var s = $"{x:N}";
        /// </code>
        ///
        /// <para>Finally, when a colon is used within a conditional statement, it should always
        /// contain a single space on either side, unless the colon is the first or last character
        /// on the line. For example:</para>
        ///
        /// <code language="cs">
        /// int x = y ? 2 : 3;
        /// </code>
        ...
        internal class SA1024ColonsMustBeSpacedCorrectly : DiagnosticAnalyzer
        {
                ...
                /// cref="SA1024ColonsMustBeSpacedCorrectly"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (SpacingResources.SA1024Title), SpacingResources.ResourceManager,
                    typeof (SpacingResources));
                private static readonly LocalizableString MessageFormat
                    = new LocalizableResourceString (
                        nameof (SpacingResources.SA1024MessageNotPreceded),
                        SpacingResources.ResourceManager, typeof (SpacingResources));
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (nameof (SpacingResources.SA1024Description),
                ...
                private static readonly LocalizableString MessagePreceded
                    = new LocalizableResourceString (
                        nameof (SpacingResources.SA1024MessagePreceded),
                        SpacingResources.ResourceManager, typeof (SpacingResources));
                private static readonly LocalizableString MessageFollowed
                    = new LocalizableResourceString (
                        nameof (SpacingResources.SA1024MessageFollowed),
                        SpacingResources.ResourceManager, typeof (SpacingResources));
...
#pragma warning disable SA1202 // Elements should be ordered by access
                ...
                internal static readonly DiagnosticDescriptor DescriptorPreceded
                    = new DiagnosticDescriptor (
                        DiagnosticId, Title, MessagePreceded, AnalyzerCategory.SpacingRules,
                        DiagnosticSeverity.Warning, AnalyzerConstants.EnabledByDefault, Description,
                        HelpLink);
...
#pragma warning restore SA1202 // Elements should be ordered by access
                ...
                private static void
                HandleColonToken (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                        ...
                        if (!hasPrecedingSpace)
                                {
                                        // only the first token on the line has leading trivia, and
                                        // those are ignored
                                        SyntaxToken precedingToken = token.GetPreviousToken ();
                                        var combinedTrivia = TriviaHelper.MergeTriviaLists (
                                            precedingToken.TrailingTrivia, token.LeadingTrivia);
                                        if (combinedTrivia.Count > 0
                                            && !combinedTrivia.Last ().IsKind (
                        ...
                        if (hasPrecedingSpace != requireBefore)
                                {
                                        ...
                                        var properties = requireBefore ? TokenSpacingProperties
                                                             .InsertPreceding
                                            : TokenSpacingProperties.RemovePreceding;
                                        context.ReportDiagnostic (
                                            Diagnostic.Create (requireBefore ? DescriptorPreceded
...
#pragma warning disable RS1005 // ReportDiagnostic invoked with an unsupported DiagnosticDescriptor
                               // (https://github.com/dotnet/roslyn-analyzers/issues/4103)
                                        context.ReportDiagnostic (Diagnostic.Create (
                                            DescriptorFollowed, token.GetLocation (),
