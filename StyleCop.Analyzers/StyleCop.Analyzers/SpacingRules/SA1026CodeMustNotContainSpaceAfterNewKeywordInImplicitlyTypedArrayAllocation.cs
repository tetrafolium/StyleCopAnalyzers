...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs whenever the code contains an implicitly typed new
        /// array allocation which is not spaced correctly. Within an implicitly typed new array
        /// allocation, there should not be any space between the new keyword and the opening array
            ...
            : DiagnosticAnalyzer
        {
                ...
                /// <see
                /// cref="SA1026CodeMustNotContainSpaceAfterNewKeywordInImplicitlyTypedArrayAllocation"/>
                /// analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (SpacingResources.SA1026Title), SpacingResources.ResourceManager,
                            ...
                            || newKeywordToken.IsLastInLine ())
                                {
                                        context.ReportDiagnostic (Diagnostic.Create (
                                            Descriptor, newKeywordToken.GetLocation (),
