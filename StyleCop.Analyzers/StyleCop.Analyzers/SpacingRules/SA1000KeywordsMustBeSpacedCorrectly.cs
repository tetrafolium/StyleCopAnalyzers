...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the spacing around a keyword is
        /// incorrect.</para>
        ///
        /// <para>The following C# keywords should always be followed by a single space:
        /// <strong>catch</strong>, <strong>fixed</strong>, <strong>for</strong>,
        /// <strong>foreach</strong>, <strong>from</strong>, <strong>group</strong>,
        /// <strong>if</strong>, <strong>in</strong>, <strong>into</strong>, <strong>join</strong>,
        /// <strong>let</strong>, <strong>lock</strong>, <strong>orderby</strong>,
        /// <strong>out</strong>, <strong>ref</strong>, <strong>return</strong>,
        /// <strong>select</strong>, <strong>switch</strong>, <strong>throw</strong>,
        /// <strong>using</strong>, <strong>var</strong>, <strong>where</strong>,
        /// <strong>while</strong>, <strong>yield</strong>.</para>
        ///
        /// <para>The following keywords should not be followed by any space:
        /// <strong>checked</strong>, <strong>default</strong>, <strong>sizeof</strong>,
        /// <strong>typeof</strong>, <strong>unchecked</strong>.</para>
        ///
        /// <para>The <strong>new</strong> and <strong>stackalloc</strong> keywords should always be
        /// followed by a space, except where used to create a new implicitly-typed array, in which
        ...
        internal class SA1000KeywordsMustBeSpacedCorrectly : DiagnosticAnalyzer
        {
                        ...
                        foreach (var token in root.DescendantTokens ())
                                {
                                        switch (token.Kind ())
                                                ...
                                                case SyntaxKind.ReturnKeyword:
                                                        HandleReturnKeywordToken (ref context,
                                                                                  token);
                                                        break;

                                                case SyntaxKind.ThrowKeyword:
                                                        HandleThrowKeywordToken (ref context,
                                                                                 token);
                                                        break;
                ...
                private static void
                HandleIdentifierName (SyntaxNodeAnalysisContext context)
                {
                        var identifierNameSyntax = (IdentifierNameSyntax) context.Node;
                        if (identifierNameSyntax.IsVar)
                                {
                                        var nextToken
                                            = identifierNameSyntax.Identifier.GetNextToken ();
                ...
                private static void HandleRequiredSpaceToken (
                    ref SyntaxTreeAnalysisContext context,
                ...
                private static void
                HandleRequiredSpaceToken<TContext> (
                ...
                private static void
                HandleDisallowedSpaceToken<TContext> (
                    ReportDiagnosticCallback<TContext> reportDiagnostic, ref TContext context,
                    SyntaxToken token)
                {
                ...
                private static void
                HandleReturnKeywordToken (ref SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                ...
                private static void
                HandleThrowKeywordToken (ref SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
