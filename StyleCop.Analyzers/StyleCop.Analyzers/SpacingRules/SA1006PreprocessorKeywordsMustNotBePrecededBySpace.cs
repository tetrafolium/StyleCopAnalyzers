...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the preprocessor-type keyword in a
        /// preprocessor directive is preceded by space. For example:</para>
        ///
        /// <code language="cs">
        /// # if DEBUG
        /// </code>
        ///
        /// <para>There should not be any whitespace between the opening hash mark and the
        ...
        internal class SA1006PreprocessorKeywordsMustNotBePrecededBySpace : DiagnosticAnalyzer
        {
                ...
                private static void
                HandleHashToken (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
