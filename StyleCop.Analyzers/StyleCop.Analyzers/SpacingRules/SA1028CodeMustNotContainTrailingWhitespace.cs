...
private static readonly DiagnosticDescriptor Descriptor = new DiagnosticDescriptor(DiagnosticId, Title, MessageFormat, AnalyzerCategory.SpacingRules, DiagnosticSeverity.Warning, AnalyzerConstants.EnabledByDefault, Description, HelpLink, WellKnownDiagnosticTags.Unnecessary);
...
private static void HandleSyntaxTree(SyntaxTreeAnalysisContext context)
{
	...
	foreach (var trivia in root.DescendantTrivia(descendIntoTrivia
		...
		case SyntaxKind.MultiLineDocumentationCommentTrivia:
			...
			foreach (var token in trivia.GetStructure().DescendantTokens(descendIntoTrivia
			                                                             : true)) {
