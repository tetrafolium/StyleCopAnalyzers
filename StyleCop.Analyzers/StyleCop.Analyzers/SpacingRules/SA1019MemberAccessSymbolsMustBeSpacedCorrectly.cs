...
#pragma warning restore SA1202 // Elements should be ordered by access
                ...
                private static void
                HandleDotToken (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                ...
                private static void
                HandleQuestionToken (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                ...
                private static void
                HandleMemberAccessSymbol (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        ...
                        if (!firstInLine && precededBySpace)
                                {
                                        // Member access symbol '{.}' should not be {preceded} by a
                                        // space.
                        ...
                        if (followedBySpace)
                                {
                                        // Member access symbol '{.}' should not be {followed} by a
                                        // space.
