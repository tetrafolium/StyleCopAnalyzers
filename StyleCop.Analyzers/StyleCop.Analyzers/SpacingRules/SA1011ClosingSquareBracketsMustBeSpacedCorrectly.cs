...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the spacing around a closing square bracket
        /// is not correct.</para>
        ///
        /// <para>A closing square bracket should never be preceded by whitespace, unless it is the
        /// first character on the line.</para>
        ///
        /// <para>A closing square bracket should be followed by whitespace, unless it is the last
        /// character on the line, it is followed by a closing bracket or an opening parenthesis, it
        /// is followed by a comma or semicolon, it is followed by a string interpolation alignment
        /// component or string interpolation formatting component, or it is followed by certain
        ...
        internal class SA1011ClosingSquareBracketsMustBeSpacedCorrectly : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (SpacingResources.SA1011Title), SpacingResources.ResourceManager,
                ...
                private static void
                HandleCloseBracketToken (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                        ...
                        // Tests for this rule have a lot of exclusions which are supposed to be
                        ...
                        if (!firstInLine && precededBySpace)
                                {
                                        // Closing square bracket should{ not} be {preceded} by a
                                        // space.
                        ...
                        if (!lastInLine)
                                {
                                        if (!precedesSpecialCharacter && !followedBySpace)
                                                {
                                                        // Closing square bracket should{} be
                                                        // {followed} by a space.
                                                ...
                                                {
                                                        // Closing square brackets should {not} be
                                                        // {followed} by a space
                                                        var properties = TokenSpacingProperties
                                                                             .RemoveFollowing;
                                                        context.ReportDiagnostic (
