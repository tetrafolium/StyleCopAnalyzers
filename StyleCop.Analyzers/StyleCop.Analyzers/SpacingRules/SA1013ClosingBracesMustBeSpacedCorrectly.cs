...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the spacing around a closing brace is not
        /// correct.</para>
        ///
        /// <para>A closing brace should always be followed by a single space, unless it is the last
        /// character on the line, or unless it is followed by a closing parenthesis, a comma, a
        /// semicolon, or a member access operator.</para>
        ///
        ...
        internal class SA1013ClosingBracesMustBeSpacedCorrectly : DiagnosticAnalyzer {
                ...
                private static readonly LocalizableString Title
                    = new LocalizableResourceString(nameof(SpacingResources.SA1013Title),
                ...
                private static void HandleCloseBraceToken(
                    SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        ...
                        if (!precededBySpace) {
                                ...
                                context.ReportDiagnostic(Diagnostic.Create(Descriptor,
                                    token.GetLocation(), properties, string.Empty, "preceded"));
                        }
