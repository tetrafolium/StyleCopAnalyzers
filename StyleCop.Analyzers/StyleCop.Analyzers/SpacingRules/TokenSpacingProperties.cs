...
namespace StyleCop.Analyzers.SpacingRules
{
    ...
    internal static class TokenSpacingProperties {
        ...
        = ImmutableDictionary<string, string>.Empty.SetItem(LocationKey, LocationPreceding).SetItem(ActionKey, ActionRemoveImmediate).SetItem(LayoutKey, LayoutPack);

        internal static ImmutableDictionary<string, string> RemovePreceding { get; }
        = ImmutableDictionary<string, string>.Empty.SetItem(LocationKey, LocationPreceding).SetItem(ActionKey, ActionRemove).SetItem(LayoutKey, LayoutPack);

        internal static ImmutableDictionary<string, string> RemovePrecedingPreserveLayout { get; }
        = ImmutableDictionary<string, string>.Empty.SetItem(LocationKey, LocationPreceding).SetItem(ActionKey, ActionRemove).SetItem(LayoutKey, LayoutPreserve);
        ...
        = ImmutableDictionary<string, string>.Empty.SetItem(LocationKey, LocationFollowing).SetItem(ActionKey, ActionRemove).SetItem(LayoutKey, LayoutPreserve);
    }
}
