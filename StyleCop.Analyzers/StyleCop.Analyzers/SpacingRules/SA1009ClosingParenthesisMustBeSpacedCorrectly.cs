...
namespace StyleCop.Analyzers.SpacingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the closing parenthesis within a statement is
        /// not spaced correctly.</para>
        ///
        /// <para>A closing parenthesis should never be preceded by whitespace. In most cases, a
        ...
        /// operator symbols, such as positive signs, negative signs, and colons.</para>
        ///
        /// <para>If the closing parenthesis is followed by whitespace, the next non-whitespace
        /// character should not be an opening or closing parenthesis or square bracket, or a
        ...
        internal class SA1009ClosingParenthesisMustBeSpacedCorrectly : DiagnosticAnalyzer
        {
                ...
                /// cref="SA1009ClosingParenthesisMustBeSpacedCorrectly"/> analyzer.
                /// </summary>
...
#pragma warning restore SA1202 // Elements should be ordered by access
                ...
                private static void
                HandleCloseParenToken (SyntaxTreeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                        ...
                        switch (nextToken.Kind ())
                                ...
                                case SyntaxKind.QuestionToken:
                                        if (nextToken.Parent.IsKind (
                                                ...
                                                {
                                                        // allow a space for this case, but only if
                                                        // the ')' character is the last on the line
                                                        allowEndOfLine = true;
                                                        precedesStickyCharacter = true;
                                                }
                                        else
                                                {
                                                        // A space follows unless this is a nullable
                                                        // tuple type
                                                        precedesStickyCharacter
                                                            = nextToken.Parent.IsKind (
                        ...
                        if (precededBySpace)
                                {
                                        // Closing parenthesis should{ not} be {preceded} by a
                                        // space.
...
#pragma warning restore RS1005 // ReportDiagnostic invoked with an unsupported DiagnosticDescriptor
                                                ...
                                                {
                                                        // Closing parenthesis should{ not} be
                                                        // {followed} by a space.
                                                        var properties = TokenSpacingProperties
                                                                             .RemoveFollowing;
#pragma warning disable RS1005 // ReportDiagnostic invoked with an unsupported DiagnosticDescriptor
