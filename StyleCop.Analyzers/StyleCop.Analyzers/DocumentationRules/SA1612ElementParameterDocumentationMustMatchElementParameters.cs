...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// <summary>
        /// The documentation describing the parameters to a C# method, constructor, delegate or
        /// indexer element does not match the actual parameters on the element.
        /// </summary>
        /// <remarks>
        ...
        ///
        /// <para>A violation of this rule occurs if the documentation for an element's parameters
        ...
        internal class SA1612ElementParameterDocumentationMustMatchElementParameters
            : ElementDocumentationBase {
                ...
                /// <see cref="SA1612ElementParameterDocumentationMustMatchElementParameters"/>
                /// analyzer.
                /// </summary>
                ...
                private static readonly DiagnosticDescriptor MissingParameterDescriptor
                    = new DiagnosticDescriptor(DiagnosticId, Title,
                        MissingParamForDocumentationMessageFormat,
                ...
                private static readonly DiagnosticDescriptor OrderDescriptor
                    = new DiagnosticDescriptor(DiagnosticId, Title, ParamWrongOrderMessageFormat,
                        AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
                        AnalyzerConstants.EnabledByDefault, Description, HelpLink);
...
#pragma warning restore RS1005 // ReportDiagnostic invoked with an unsupported DiagnosticDescriptor
                    ...
                    XElement completeDocumentation, params Location[] diagnosticLocations)
                {
                        ...
                        foreach (var paramTag in xmlParamTags) {
                                ...
                                if (parentParameter == null) {
                                        context.ReportDiagnostic(
                                            Diagnostic.Create(MissingParameterDescriptor,
                                                identifierLocation, nameAttributeText));
                                } else {
                                        if (!needsComment) {
                                                // Parameter documentation is allowed to be omitted,
                                                // so skip parameters for which there is no
