...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// <summary>
        /// Analyzer that covers generic typeparam documentation checks. This currently includes
        /// SA1620, SA1621, and SA1622.
        /// </summary>
        ...
        internal class GenericTypeParameterDocumentationAnalyzer : DiagnosticAnalyzer {
                ...
                private static readonly LocalizableString SA1620Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1620Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1621Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1621Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1622Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1622Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                = new DiagnosticDescriptor(SA1620DiagnosticId, SA1620Title,
                    SA1620MissingMessageFormat, AnalyzerCategory.DocumentationRules,
                    DiagnosticSeverity.Warning, AnalyzerConstants.EnabledByDefault,
                    SA1620Description, SA1620HelpLink);
                ...
                = new DiagnosticDescriptor(SA1620DiagnosticId, SA1620Title,
                    SA1620WrongOrderMessageFormat, AnalyzerCategory.DocumentationRules,
                    DiagnosticSeverity.Warning, AnalyzerConstants.EnabledByDefault,
                    SA1620Description, SA1620HelpLink);
                ...
                = ImmutableArray.Create(
                    SA1620MissingTypeParameterDescriptor, SA1621Descriptor, SA1622Descriptor);
                ...
                private static void HandleTypeDeclaration(SyntaxNodeAnalysisContext context)
                {
                        ...
                        HandleDeclaration(
                            context, typeDeclaration, typeDeclaration.TypeParameterList);
                }
                ...
                private static void HandleDelegateDeclaration(SyntaxNodeAnalysisContext context)
                {
                        ...
                        HandleDeclaration(
                            context, delegateDeclaration, delegateDeclaration.TypeParameterList);
                }
                ...
                private static void HandleMethodDeclaration(SyntaxNodeAnalysisContext context)
                {
                        ...
                        HandleDeclaration(
                            context, methodDeclaration, methodDeclaration.TypeParameterList);
                }

                private static void HandleDeclaration(SyntaxNodeAnalysisContext context,
                    SyntaxNode node, TypeParameterListSyntax typeParameterList)
                {
                        ...
                        if (includeElement != null) {
                                ...
                                // Check based on the documented type parameters, as we must detect
                                // scenarios where there are too many type parameters documented. It
                                // is not necessary to detect missing type parameter documentation,
                                // this belongs to SA1618.
                                for (var i = 0; i < typeParameterAttributes.Length; i++) {
                                        var documentedParameterName
                                            = typeParameterAttributes [i]
                                                  .Attribute(XmlCommentHelper.NameArgumentName)
                                            ?.Value;
                                        HandleTypeParamElement(context, documentedParameterName, i,
                                            typeParameterList, includeElement.GetLocation());

                                        if (XmlCommentHelper.IsConsideredEmpty(
                                                typeParameterAttributes[i])) {
                                                context.ReportDiagnostic(
                                                    Diagnostic.Create(SA1622Descriptor,
                                ...
                                for (var i = 0; i < typeParameterTags.Length; i++) {
                                        var nameAttribute
                                            = XmlCommentHelper.GetFirstAttributeOrDefault<
                                                XmlNameAttributeSyntax>(typeParameterTags[i]);
                                        var documentedParameterName
                                            = nameAttribute?.Identifier?.Identifier.ValueText;

                                        var location = nameAttribute?.Identifier?.GetLocation()
                                            ?? typeParameterTags [i]
                                                   .GetLocation();
                                        HandleTypeParamElement(context, documentedParameterName, i,
                                            typeParameterList, location);

                                        if (XmlCommentHelper.IsConsideredEmpty(
                                                typeParameterTags[i], true)) {
                                                context.ReportDiagnostic(
                                                    Diagnostic.Create(SA1622Descriptor,
                                                        typeParameterTags [i]
                                                            .GetLocation()));
                ...
                private static void HandleTypeParamElement(SyntaxNodeAnalysisContext context,
                    string documentedParameterName, int index,
                    TypeParameterListSyntax typeParameterList, Location locationToReport)
                {
                        ...
                        var typeParameterName = (index < typeParameterList.Parameters.Count)
                            ...
                            : null;
                        if (string.Equals(typeParameterName, documentedParameterName,
                                StringComparison.Ordinal)) {
                                return;
                        }

                        var matchingTypeParameter = typeParameterList.Parameters.FirstOrDefault(
                            tp => string.Equals(tp.Identifier.ValueText, documentedParameterName,
                                StringComparison.Ordinal));
                        if (matchingTypeParameter != null) {
                                context.ReportDiagnostic(
                                    Diagnostic.Create(SA1620WrongOrderDescriptor, locationToReport,
                                        documentedParameterName,
                                        typeParameterList.Parameters.IndexOf(matchingTypeParameter)
                                            + 1));
                        } else {
                                context.ReportDiagnostic(
                                    Diagnostic.Create(SA1620MissingTypeParameterDescriptor,
                                        locationToReport, documentedParameterName));
                        }
                }
        }
}
