...
namespace StyleCop.Analyzers.DocumentationRules
{
    ...
    internal class GenericTypeParameterDocumentationAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString SA1620Title =
            new LocalizableResourceString(nameof(DocumentationResources.SA1620Title),
        ...
        private static readonly LocalizableString SA1620MissingMessageFormat =
            new LocalizableResourceString(nameof(DocumentationResources.SA1620MissingMessageFormat),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly LocalizableString SA1620WrongOrderMessageFormat =
            new LocalizableResourceString(nameof(DocumentationResources.SA1620WrongOrderMessageFormat),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly LocalizableString SA1620Description =
            new LocalizableResourceString(nameof(DocumentationResources.SA1620Description),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly string SA1620HelpLink =
        ...
        private static readonly LocalizableString SA1621Title =
            new LocalizableResourceString(nameof(DocumentationResources.SA1621Title),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly LocalizableString SA1621MessageFormat =
            new LocalizableResourceString(nameof(DocumentationResources.SA1621MessageFormat),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly LocalizableString SA1621Description =
            new LocalizableResourceString(nameof(DocumentationResources.SA1621Description),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly string SA1621HelpLink =
        ...
        private static readonly LocalizableString SA1622Title =
            new LocalizableResourceString(nameof(DocumentationResources.SA1622Title),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly LocalizableString SA1622MessageFormat =
            new LocalizableResourceString(nameof(DocumentationResources.SA1622MessageFormat),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly LocalizableString SA1622Description =
            new LocalizableResourceString(nameof(DocumentationResources.SA1622Description),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly string SA1622HelpLink =
        ...
        public static DiagnosticDescriptor SA1620MissingTypeParameterDescriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1620DiagnosticId, SA1620Title, SA1620MissingMessageFormat,
        ...
        /// </summary>
        /// <value>The <see cref="DiagnosticDescriptor"/> for SA1620.</value>
        public static DiagnosticDescriptor SA1620WrongOrderDescriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1620DiagnosticId, SA1620Title, SA1620WrongOrderMessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
                                   AnalyzerConstants.EnabledByDefault, SA1620Description, SA1620HelpLink);
        ...
        public static DiagnosticDescriptor SA1621Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1621DiagnosticId, SA1621Title, SA1621MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        /// </summary>
        /// <value>The <see cref="DiagnosticDescriptor"/> for SA1621.</value>
        public static DiagnosticDescriptor SA1622Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1622DiagnosticId, SA1622Title, SA1622MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeAction(TypeDeclarationAction, SyntaxKind.ClassDeclaration,
        ...
        private static void HandleDeclaration(SyntaxNodeAnalysisContext context, SyntaxNode node,
                                              TypeParameterListSyntax typeParameterList)
        {
            ...
            if (includeElement != null)
            {
                ...
                // Check based on the documented type parameters, as we must detect scenarios where there are too many
                // type parameters documented. It is not necessary to detect missing type parameter documentation, this
                // belongs to SA1618.
                for (var i = 0; i < typeParameterAttributes.Length; i++)
                {
                    var documentedParameterName = typeParameterAttributes [i]
                        ...
                        ?.Value;
                    HandleTypeParamElement(context, documentedParameterName, i, typeParameterList,
                                           includeElement.GetLocation());

                    if (XmlCommentHelper.IsConsideredEmpty(typeParameterAttributes[i]))
                    {
                        context.ReportDiagnostic(Diagnostic.Create(SA1622Descriptor, includeElement.GetLocation()));
                    }
                }
            }
            else
            {
                var typeParameterTags =
                    documentation.Content.GetXmlElements(XmlCommentHelper.TypeParamXmlTag).ToImmutableArray();
                ...
                {
                    var nameAttribute =
                        XmlCommentHelper.GetFirstAttributeOrDefault<XmlNameAttributeSyntax>(typeParameterTags[i]);
                    ...
                    {
                        context.ReportDiagnostic(Diagnostic.Create(SA1622Descriptor, typeParameterTags [i]
                                                                                         .GetLocation()));
                    }
                }
            }
        ...
        private static void HandleTypeParamElement(SyntaxNodeAnalysisContext context, string documentedParameterName,
                                                   int index, TypeParameterListSyntax typeParameterList,
                                                   Location locationToReport)
        {
            if (string.IsNullOrWhiteSpace(documentedParameterName))
            {
                context.ReportDiagnostic(Diagnostic.Create(SA1621Descriptor, locationToReport));

                return;
            }

            var typeParameterName = (index < typeParameterList.Parameters.Count)
                                        ? typeParameterList.Parameters[index].Identifier.ValueText
                                        : null;
            ...
            var matchingTypeParameter = typeParameterList.Parameters.FirstOrDefault(
                tp => string.Equals(tp.Identifier.ValueText, documentedParameterName, StringComparison.Ordinal));
            if (matchingTypeParameter != null)
            {
                context.ReportDiagnostic(
                    Diagnostic.Create(SA1620WrongOrderDescriptor, locationToReport, documentedParameterName,
                                      typeParameterList.Parameters.IndexOf(matchingTypeParameter) + 1));
            }
            else
            {
                context.ReportDiagnostic(
                    Diagnostic.Create(SA1620MissingTypeParameterDescriptor, locationToReport, documentedParameterName));
            }
        }
    }
}
