        ...
        internal class GenericTypeParameterDocumentationAnalyzer : DiagnosticAnalyzer
        {
                ...
                Initialize (AnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction (
                            TypeDeclarationAction, SyntaxKind.ClassDeclaration,
                ...
                HandleTypeDeclaration (SyntaxNodeAnalysisContext context)
                {
                        ...
                        HandleDeclaration (context, typeDeclaration,
                ...
                HandleDelegateDeclaration (SyntaxNodeAnalysisContext context)
                {
                        ...
                        HandleDeclaration (context, delegateDeclaration,
                ...
                HandleMethodDeclaration (SyntaxNodeAnalysisContext context)
                {
                        ...
                        HandleDeclaration (context, methodDeclaration,
                                           methodDeclaration.TypeParameterList);
                }

                private static void
                HandleDeclaration (SyntaxNodeAnalysisContext context, SyntaxNode node,
                        ...
                        if (includeElement != null)
                                {
                                        ...
                                        // Check based on the documented type parameters, as we must
                                        // detect scenarios where there are too many type parameters
                                        // documented. It is not necessary to detect missing type
                                        // parameter documentation, this belongs to SA1618.
                                        for (var i = 0; i < typeParameterAttributes.Length; i++)
                                                {
                                                        var documentedParameterName
                                                            = typeParameterAttributes [i]
                                                                  .Attribute (XmlCommentHelper
                                                                                  .NameArgumentName)
                                                            ?.Value;
                                                        HandleTypeParamElement (
                                                            context, documentedParameterName, i,
                                                            typeParameterList,
                                                        ...
                                                        var nameAttribute
                                                            = XmlCommentHelper
                                                                  .GetFirstAttributeOrDefault<
                                                                      ...
                                                                      typeParameterTags[i]);
                                                        var documentedParameterName
                                                            = nameAttribute?.Identifier?.Identifier
                                                                  .ValueText;

                                                        var location = nameAttribute?.Identifier?
                                                                           .GetLocation ()
                                                            ?? typeParameterTags [i]
                                                                   .GetLocation ();
                                                        HandleTypeParamElement (
                ...
                private static void
                HandleTypeParamElement (SyntaxNodeAnalysisContext context,
                                        ...
                                        Location locationToReport)
                {
                        ...
                        var typeParameterName
                            = (index < typeParameterList.Parameters.Count)
                        ...
                        if (matchingTypeParameter != null)
                                {
                                        context.ReportDiagnostic (Diagnostic.Create (
                                            ...
                                            typeParameterList.Parameters.IndexOf (
                                                matchingTypeParameter)
                                                + 1));
                                }
                        else
                                {
                                        context.ReportDiagnostic (Diagnostic.Create (
                                            SA1620MissingTypeParameterDescriptor, locationToReport,
                                            documentedParameterName));
                                }
                }
        }
