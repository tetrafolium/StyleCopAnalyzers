...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// <summary>
        /// The XML documentation header for a C# finalizer does not contain the appropriate summary
        /// text.
        /// </summary>
        /// <remarks>
        ...
        /// header for a finalizer does not begin with the proper text.</para>
        ///
        /// <para>The rule is intended to standardize the summary text for a finalizer. The summary
        /// for a finalizer should begin with "Finalizes an instance of the {class name} class." For
        /// example, the following shows the finalizer for the <c>Customer</c> class.</para>
        ///
            ...
            : StandardTextDiagnosticBase
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (DocumentationResources.SA1643Title),
                ...
                private static void
                HandleDestructor (SyntaxNodeAnalysisContext context)
                {
                        var settings
