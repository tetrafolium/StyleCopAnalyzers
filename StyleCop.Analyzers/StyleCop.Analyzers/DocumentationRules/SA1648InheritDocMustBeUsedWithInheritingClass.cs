...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// <summary>
        /// <c>&lt;inheritdoc&gt;</c> has been used on an element that doesn't inherit from a base
        ...
        internal class SA1648InheritDocMustBeUsedWithInheritingClass : DiagnosticAnalyzer
        {
                ...
                private static void
                HandleMemberDeclaration (SyntaxNodeAnalysisContext context)
                {
                        ...
                        if (documentation.Content.GetFirstXmlElement (
                                ...
                                is XmlEmptyElementSyntax includeElement)
                                {
                                        ...
                                        var rawDocumentation
                                            = declaredSymbol.GetDocumentationCommentXml (
                                                expandIncludes
                                                : true, cancellationToken
                                                : context.CancellationToken);
                                        var completeDocumentation
                ...
                private static bool
                HasXmlCrefAttribute (XmlNodeSyntax inheritDocElement)
                {
            ...
            return false;
                ...
                private static bool
                HasXmlCrefAttribute (XElement inheritDocElement)
                {
