...
namespace StyleCop.Analyzers.DocumentationRules
{
    ...
    internal class SA1648InheritDocMustBeUsedWithInheritingClass : DiagnosticAnalyzer {
        ...
        private static readonly ImmutableArray<SyntaxKind> HandledTypeLikeDeclarationKinds = ImmutableArray.Create(SyntaxKind.ClassDeclaration, SyntaxKind.StructDeclaration, SyntaxKind.InterfaceDeclaration, SyntaxKind.EnumDeclaration, SyntaxKind.DelegateDeclaration);
