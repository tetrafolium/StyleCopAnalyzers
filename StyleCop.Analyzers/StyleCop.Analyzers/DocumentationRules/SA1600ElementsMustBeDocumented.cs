...
namespace StyleCop.Analyzers.DocumentationRules
{
    ...
    internal class SA1600ElementsMustBeDocumented : DiagnosticAnalyzer {
        ...
        private static readonly ImmutableArray<SyntaxKind> BaseTypeDeclarationKinds = ImmutableArray.Create(SyntaxKind.ClassDeclaration, SyntaxKind.StructDeclaration, SyntaxKind.InterfaceDeclaration, SyntaxKind.EnumDeclaration);
