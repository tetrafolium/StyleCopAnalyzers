...
namespace StyleCop.Analyzers.DocumentationRules
{
    ...
    /// </summary>
    /// <seealso href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1633.md">SA1633
    /// File should have header</seealso> <seealso
    /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1634.md">SA1634 File
    /// header should show copyright</seealso> <seealso
    /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1635.md">SA1635 File
    /// header should have copyright text</seealso> <seealso
    /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1636.md">SA1636 File
    /// header copyright text should match</seealso> <seealso
    /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1637.md">SA1637 File
    /// header should contain file name</seealso> <seealso
    /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1638.md">SA1638 File
    /// header file name documentation should match file name</seealso> <seealso
    /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1639.md">SA1639 File
    /// header should have summary</seealso> <seealso
    /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1640.md">SA1640 File
    /// header should have valid company text</seealso> <seealso
    /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1641.md">SA1641 File
    /// header company name text should match</seealso>
    ...
    internal class FileHeaderAnalyzers : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString SA1633MessageFormatMissing =
            new LocalizableResourceString(nameof(DocumentationResources.SA1633MessageFormatMissing),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        private static readonly LocalizableString SA1633MessageFormatMalformed =
            new LocalizableResourceString(nameof(DocumentationResources.SA1633MessageFormatMalformed),
                                          DocumentationResources.ResourceManager, typeof(DocumentationResources));
        ...
        public static DiagnosticDescriptor SA1633DescriptorMissing
        {
            get;
        }
        = new DiagnosticDescriptor(SA1633Identifier, SA1633Title, SA1633MessageFormatMissing,
        ...
        /// </summary>
        /// <value>The <see cref="DiagnosticDescriptor"/> for SA1633.</value>
        public static DiagnosticDescriptor SA1633DescriptorMalformed
        {
            get;
        }
        = new DiagnosticDescriptor(SA1633Identifier, SA1633Title, SA1633MessageFormatMalformed,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
                                   AnalyzerConstants.EnabledByDefault, SA1633Description, SA1633HelpLink);
        ...
        public static DiagnosticDescriptor SA1634Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1634Identifier, SA1634Title, SA1634MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        public static DiagnosticDescriptor SA1635Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1635Identifier, SA1635Title, SA1635MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        public static DiagnosticDescriptor SA1636Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1636Identifier, SA1636Title, SA1636MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        public static DiagnosticDescriptor SA1637Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1637Identifier, SA1637Title, SA1637MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        public static DiagnosticDescriptor SA1638Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1638Identifier, SA1638Title, SA1638MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        public static DiagnosticDescriptor SA1639Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1639Identifier, SA1639Title, SA1639MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        public static DiagnosticDescriptor SA1640Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1640Identifier, SA1640Title, SA1640MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        public static DiagnosticDescriptor SA1641Descriptor
        {
            get;
        }
        = new DiagnosticDescriptor(SA1641Identifier, SA1641Title, SA1641MessageFormat,
                                   AnalyzerCategory.DocumentationRules, DiagnosticSeverity.Warning,
        ...
        = ImmutableArray.Create(SA1633DescriptorMissing, SA1634Descriptor, SA1635Descriptor, SA1636Descriptor,
                                SA1637Descriptor, SA1638Descriptor, SA1639Descriptor, SA1640Descriptor,
                                SA1641Descriptor);
        ...
        private static void HandleCompilationStart(CompilationStartAnalysisContext context)
        {
            ...
            {
                context.RegisterSyntaxTreeAction((ctx, settings) =>
        ...
        private static class Analyzer
        {
                                                ...
                                                Compilation compilation)
            {
                ...
                if (settings.DocumentationRules.XmlHeader)
                {
                    ...
                    if (fileHeader.IsMissing)
                    {
                        context.ReportDiagnostic(
                            Diagnostic.Create(SA1633DescriptorMissing, fileHeader.GetLocation(context.Tree)));
                        return;
                    }
                    ...
                    {
                        context.ReportDiagnostic(
                            Diagnostic.Create(SA1633DescriptorMalformed, fileHeader.GetLocation(context.Tree)));
                        return;
                    }
                ...
                else
                {
                    ...
                    if (!compilation.IsAnalyzerSuppressed(SA1635Descriptor))
                    {
                        ...
                        {
                            context.ReportDiagnostic(
                                Diagnostic.Create(SA1635Descriptor, fileHeader.GetLocation(context.Tree)));
                            return;
                        }
                        ...
                        {
                            context.ReportDiagnostic(
                                Diagnostic.Create(SA1636Descriptor, fileHeader.GetLocation(context.Tree)));
                            return;
                        }
                    }
                }
            ...
            private static void CheckCopyrightHeader(SyntaxTreeAnalysisContext context,
            ...
            private static void CheckFile(SyntaxTreeAnalysisContext context, Compilation compilation,
            ...
            private static void CheckCopyrightText(SyntaxTreeAnalysisContext context,
                                                   ...
                                                   XmlFileHeader fileHeader, XElement copyrightElement)
            {
                ...
                if (string.Equals(settingsCopyrightText, DocumentationSettings.DefaultCopyrightText,
                ...
                // trim any leading / trailing new line or whitespace characters (those are a result of the XML
                // formatting)
            ...
            private static void CheckCompanyName(SyntaxTreeAnalysisContext context,
                                                 DocumentationSettings documentationSettings, Compilation compilation,
                                                 XmlFileHeader fileHeader, XElement copyrightElement)
            {
                ...
                if (string.Equals(documentationSettings.CompanyName, DocumentationSettings.DefaultCompanyName,
                                  StringComparison.OrdinalIgnoreCase))
                {
            ...
            private static bool CompareCopyrightText(SyntaxTreeAnalysisContext context,
                                                     DocumentationSettings documentationSettings, string copyrightText)
            {
                ...
                var reformattedCopyrightTextParts =
                    documentationSettings.GetCopyrightText(fileName).Replace("\r\n", "\n").Split('\n');
