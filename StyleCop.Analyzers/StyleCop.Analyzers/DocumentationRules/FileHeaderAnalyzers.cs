...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// </summary>
        /// <seealso
        /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1633.md">SA1633
        /// File should have header</seealso> <seealso
        /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1634.md">SA1634
        /// File header should show copyright</seealso> <seealso
        /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1635.md">SA1635
        /// File header should have copyright text</seealso> <seealso
        /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1636.md">SA1636
        /// File header copyright text should match</seealso> <seealso
        /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1637.md">SA1637
        /// File header should contain file name</seealso> <seealso
        /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1638.md">SA1638
        /// File header file name documentation should match file name</seealso> <seealso
        /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1639.md">SA1639
        /// File header should have summary</seealso> <seealso
        /// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1640.md">SA1640
        /// File header should have valid company text</seealso> <seealso
        ...
        internal class FileHeaderAnalyzers : DiagnosticAnalyzer {
                ...
                private static readonly LocalizableString SA1633Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1633Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1634Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1634Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1635Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1635Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1636Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1636Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1637Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1637Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1638Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1638Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1639Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1639Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1640Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1640Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                private static readonly LocalizableString SA1641Description
                    = new LocalizableResourceString(
                        nameof(DocumentationResources.SA1641Description),
                        DocumentationResources.ResourceManager, typeof(DocumentationResources));
                ...
                = new DiagnosticDescriptor(SA1633Identifier, SA1633Title,
                    SA1633MessageFormatMissing, AnalyzerCategory.DocumentationRules,
                    DiagnosticSeverity.Warning, AnalyzerConstants.EnabledByDefault,
                    SA1633Description, SA1633HelpLink);
                ...
                = new DiagnosticDescriptor(SA1633Identifier, SA1633Title,
                    SA1633MessageFormatMalformed, AnalyzerCategory.DocumentationRules,
                    DiagnosticSeverity.Warning, AnalyzerConstants.EnabledByDefault,
                    SA1633Description, SA1633HelpLink);
                ...
                = ImmutableArray.Create(SA1633DescriptorMissing, SA1634Descriptor, SA1635Descriptor,
                    SA1636Descriptor, SA1637Descriptor, SA1638Descriptor, SA1639Descriptor,
                    SA1640Descriptor, SA1641Descriptor);
                ...
                private static void HandleCompilationStart(CompilationStartAnalysisContext context)
                {
                        ...
                        if (!compilation.IsAnalyzerSuppressed(SA1633DescriptorMissing)) {
                                context.RegisterSyntaxTreeAction(
                                    (ctx, settings) => Analyzer.HandleSyntaxTree(
                                        ctx, settings, compilation));
                        }
                }

                private static class Analyzer {
                        public static void HandleSyntaxTree(SyntaxTreeAnalysisContext context,
                            StyleCopSettings settings, Compilation compilation)
                        {
                                ...
                                if (settings.DocumentationRules.XmlHeader) {
                                        ...
                                        if (fileHeader.IsMissing) {
                                                context.ReportDiagnostic(
                                                    Diagnostic.Create(SA1633DescriptorMissing,
                                        ...
                                        if (fileHeader.IsMalformed) {
                                                context.ReportDiagnostic(
                                                    Diagnostic.Create(SA1633DescriptorMalformed,
                                                        fileHeader.GetLocation(context.Tree)));
                                                return;
                                        }
                                        ...
                                        if (!compilation.IsAnalyzerSuppressed(SA1634Descriptor)) {
                                                CheckCopyrightHeader(context,
                                                    settings.DocumentationRules, compilation,
                                                    fileHeader);
                                        }
                                        ...
                                        if (!compilation.IsAnalyzerSuppressed(SA1635Descriptor)) {
                                                ...
                                                if (!CompareCopyrightText(context,
                            ...
                            XmlFileHeader fileHeader)
                        {
                                ...
                                if (copyrightElement == null) {
                                        context.ReportDiagnostic(Diagnostic.Create(SA1634Descriptor,
                                            fileHeader.GetLocation(context.Tree)));
                                        return;
                                }
                            ...
                            XmlFileHeader fileHeader, XElement copyrightElement)
                        {
                                ...
                                if (string.Equals(settingsCopyrightText,
                                        ...
                                        // The copyright text is meaningless until the company name
                                ...
                                if (!CompareCopyrightText(context, documentationSettings,
                            ...
                            XmlFileHeader fileHeader, XElement copyrightElement)
                        {
                                ...
                                if (string.Equals(documentationSettings.CompanyName,
                                        DocumentationSettings.DefaultCompanyName,
                                        StringComparison.OrdinalIgnoreCase)) {
                                        // The company name is meaningless until configured by the
                                        // user.
                                        return;
                                }

                                if (string.CompareOrdinal(
                                        companyName, documentationSettings.CompanyName)
                                    != 0) {
                                        var location = fileHeader.GetElementLocation(
                                            context.Tree, copyrightElement);
                                        context.ReportDiagnostic(
                        ...
                        private static void CheckSummaryHeader(
                            SyntaxTreeAnalysisContext context, XmlFileHeader fileHeader)
                        {
                                var summaryElement = fileHeader.GetElement("summary");
                                if (summaryElement == null) {
                                        context.ReportDiagnostic(Diagnostic.Create(SA1639Descriptor,
                                            fileHeader.GetLocation(context.Tree)));
                                        return;
                                }
                            ...
                            DocumentationSettings documentationSettings, string copyrightText)
                        {
                                ...
                                // compare line by line, ignoring leading and trailing whitespace on
                                // each line.
