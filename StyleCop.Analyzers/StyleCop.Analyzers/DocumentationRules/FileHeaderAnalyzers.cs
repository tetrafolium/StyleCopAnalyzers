...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        internal class FileHeaderAnalyzers : DiagnosticAnalyzer
        {
                ...
                = ImmutableArray.Create (SA1633DescriptorMissing, SA1634Descriptor,
                                         SA1635Descriptor, SA1636Descriptor, SA1637Descriptor,
                                         SA1638Descriptor, SA1639Descriptor, SA1640Descriptor,
                                         SA1641Descriptor);
                ...
                private static class Analyzer
                {
                        ...
                        private static void
                        CheckFile (SyntaxTreeAnalysisContext context, Compilation compilation,
                                            ...
                                            XElement copyrightElement)
                        {
                                ...
                                if (string.Equals (settingsCopyrightText,
                                        ...
                                        {
                                                // The copyright text is meaningless until the
                                                // company name is configured by the user.
                                                return;
                                        }
                                          ...
                                          XElement copyrightElement)
                        {
                                ...
                                if (string.Equals (documentationSettings.CompanyName,
                                                   ...
                                                   StringComparison.OrdinalIgnoreCase))
                                        {
                                                // The company name is meaningless until configured
                                                // by the user.
                                                return;
                                        }

                                if (string.CompareOrdinal (companyName,
                                                           documentationSettings.CompanyName)
                                    != 0)
                                        {
                                                var location = fileHeader.GetElementLocation (
                                                    context.Tree, copyrightElement);
                        ...
                        private static void
                        CheckSummaryHeader (SyntaxTreeAnalysisContext context,
                                ...
                                for (var i = 0; i < reformattedCopyrightTextParts.Length; i++)
                                        {
                                                if (string.CompareOrdinal (
                                                        reformattedCopyrightTextParts [i]
                                                            .Trim (),
