...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// <summary>
        /// A section of the XML header documentation for a C# element does not contain enough
        ...
        ///
        /// <para>A violation of this rule occurs when part of the documentation does contain enough
        /// characters. This rule is calculated by counting the number of alphabetic characters and
        /// numbers within the documentation text, and comparing it against the number of symbols
        /// and other non-alphabetic characters. If the percentage of non-alphabetic characters is
        /// too high, this generally indicates poorly formatted documentation which will be
        ...
        internal class SA1631DocumentationMustMeetCharacterPercentage : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString MessageFormat =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1631MessageFormat),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
