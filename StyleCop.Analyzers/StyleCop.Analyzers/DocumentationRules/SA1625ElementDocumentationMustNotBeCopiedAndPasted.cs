...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// indicating that the documentation has been copied and pasted. This can sometimes
        /// indicate invalid or poorly written documentation.
        /// </summary>
        /// <remarks>
        ...
        ///
        /// <para>A violation of this rule occurs when an element contains two or more identical
        /// documentation texts. For example:</para>
        ///
        ...
        /// </code>
        ///
        /// <para>In some cases, a method may contain one or more parameters which are not used
        /// within the body of the method. In this case, the documentation for the parameter can be
        /// set to "The parameter is not used." StyleCop will allow multiple parameters to contain
        /// identical documentation as long as the documentation string is "The parameter is not
        /// used.".</para>
        ///
        /// <code language="csharp">
        /// /// &lt;summary&gt;
        ...
        internal class SA1625ElementDocumentationMustNotBeCopiedAndPasted : ElementDocumentationBase
        {
                ...
                private static readonly LocalizableString MessageFormat =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1625MessageFormat),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
