...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// <summary>
        /// The C# code contains a single-line comment which begins with three forward slashes in a
        /// row.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the code contains a single-line comment which
        /// begins with three slashes. Comments beginning with three slashes are reserved for XML
        /// documentation headers. Single-line comments should begin with only two slashes. When
        /// commenting out lines of code, it is advisable to begin the comment with four slashes to
        /// differentiate it from normal comments. For example:</para>
        ///
