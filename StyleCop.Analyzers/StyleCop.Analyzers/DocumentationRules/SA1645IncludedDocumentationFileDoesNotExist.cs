...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        ///
        /// <para>As an alternative to authoring documentation directly within the code file, it is
        /// possible to place documentation for multiple elements within a separate XML file, and
        /// then reference a section of that file within an element's documentation header. This
        /// causes the compiler to import the documentation for that element from the included
        ...
        /// </code>
        ///
        /// <para>A violation of this rule occurs when the included file does not exist at the given
        /// location, or cannot be loaded.</para>
        /// </remarks>
        ...
        internal class SA1645IncludedDocumentationFileDoesNotExist : DiagnosticAnalyzer
        {
                ...
                /// cref="SA1645IncludedDocumentationFileDoesNotExist"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1645Title),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
                private static readonly LocalizableString MessageFormat =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1645MessageFormat),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
                private static readonly LocalizableString Description =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1645Description),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
