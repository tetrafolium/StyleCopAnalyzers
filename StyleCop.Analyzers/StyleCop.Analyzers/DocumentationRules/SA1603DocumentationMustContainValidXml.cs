...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        ///
        /// <para>A violation of this rule occurs when the documentation XML is badly formed and
        /// cannot be parsed. This can occur if the XML contains invalid characters, or if an XML
        /// node is missing a closing tag, for example.</para>
        /// </remarks>
        ...
        internal class SA1603DocumentationMustContainValidXml : DiagnosticAnalyzer
        {
                ...
                /// cref="SA1603DocumentationMustContainValidXml"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1603Title),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
                private static readonly LocalizableString MessageFormat =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1603MessageFormat),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
                private static readonly LocalizableString Description =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1603Description),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
