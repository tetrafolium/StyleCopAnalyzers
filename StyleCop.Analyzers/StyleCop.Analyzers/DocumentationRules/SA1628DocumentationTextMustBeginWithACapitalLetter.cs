...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// <summary>
        /// A section of the XML header documentation for a C# element does not begin with a capital
        /// letter.
        /// </summary>
        /// <remarks>
        ...
        ///
        /// <para>A violation of this rule occurs when part of the documentation does not begin with
        /// a capital letter. For example, the summary text in the documentation below begins with a
        ...
        internal class SA1628DocumentationTextMustBeginWithACapitalLetter : DiagnosticAnalyzer
        {
                ...
                /// cref="SA1628DocumentationTextMustBeginWithACapitalLetter"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1628Title),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
                private static readonly LocalizableString MessageFormat =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1628MessageFormat),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
                private static readonly LocalizableString Description =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1628Description),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
