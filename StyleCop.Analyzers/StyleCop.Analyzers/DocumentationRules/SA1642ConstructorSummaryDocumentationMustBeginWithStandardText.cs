...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// <summary>
        /// The XML documentation header for a C# constructor does not contain the appropriate
        /// summary text.
        /// </summary>
        /// <remarks>
        ...
        ///
        /// <para>A violation of this rule occurs when the summary tag within the documentation
        /// header for a constructor does not begin with the proper text.</para>
        ///
        /// <para>The rule is intended to standardize the summary text for a constructor based on
        /// the access level of the constructor. The summary for a non-private instance constructor
        /// should begin with "Initializes a new instance of the {class name} class." For example,
        /// the following shows the constructor for the <c>Customer</c> class.</para>
        ///
        ...
        /// </code>
        ///
        /// <para>If the class contains generic parameters, these can be annotated within the
        /// <c>cref</c> link using either of the following two formats:</para>
        ///
        /// <code language="csharp">
        /// /// &lt;summary&gt;
        ...
        /// </code>
        ///
        /// <para>If the constructor is <see langword="static"/>, the summary text should begin with
        /// "Initializes static members of the {class name} class.” For example:</para>
        ///
        /// <code language="csharp">
        /// /// &lt;summary&gt;
        ...
        /// </code>
        ///
        /// <para>Private instance constructors should use the summary text "Prevents a default
        /// instance of the {class name} class from being created.".</para>
        ///
        /// <code language="csharp">
        /// /// &lt;summary&gt;
            ...
            : StandardTextDiagnosticBase
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (DocumentationResources.SA1642Title),
                ...
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (DocumentationResources.SA1642Description),
                        DocumentationResources.ResourceManager, typeof (DocumentationResources));
                ...
                HandleConstructorDeclaration (SyntaxNodeAnalysisContext context)
                {
                        ...
                        if (constructorDeclarationSyntax.Modifiers.Any (SyntaxKind.StaticKeyword))
                                     ...
                                     SyntaxKind.PrivateKeyword))
                                {
                                        ...
                                        // also allow the non-private wording for private
                                        // constructors
                                        HandleDeclaration (
                                            context,
                                            string.Format (
