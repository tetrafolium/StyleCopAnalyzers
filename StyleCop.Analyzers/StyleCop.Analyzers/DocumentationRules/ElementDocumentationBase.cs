...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        internal abstract class ElementDocumentationBase : DiagnosticAnalyzer
        {
                                                       ...
                                                       StyleCopSettings settings)
                {
                        ...
                        bool needsComment =
                          SA1600ElementsMustBeDocumented.NeedsComment(settings.DocumentationRules,
                                                                      ...
                                                                      effectiveAccessibility);
                        this.HandleDeclaration(
                          context, settings, needsComment, node, node.OperatorToken.GetLocation());
                }
                ...
                private void HandleEnumMemberDeclaration(SyntaxNodeAnalysisContext context,
                                                         StyleCopSettings settings)
                {
                        ...
                        if (hasIncludedDocumentation) {
                                ...
                                IEnumerable<XmlNodeSyntax> matchingXmlElements =
                                  ...
                                  ? documentation.Content
                                      .Where(x =>
                                               x is XmlElementSyntax || x is XmlEmptyElementSyntax)
                                ...
                                this.HandleXmlElement(
                                  context, settings, needsComment, matchingXmlElements, locations);
                        }
                }
        }
}
