...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the element documentation contains
        /// &lt;placeholder&gt; elements:</para>
        ///
        ...
        internal class SA1651DoNotUsePlaceholderElements : DiagnosticAnalyzer
        {
                ...
                private static void
                CheckTag (SyntaxNodeAnalysisContext context, string tagName)
                {
                        if (string.Equals (XmlCommentHelper.IncludeXmlTag, tagName,
                                           StringComparison.Ordinal))
                                {
                                        ...
                                        context.ReportDiagnostic (Diagnostic.Create (
                                            Descriptor, context.Node.GetLocation (),
                                            NoCodeFixProperties));
                                }
                        else
                                {
                                        if (!string.Equals (XmlCommentHelper.PlaceholderTag,
                                                            tagName, StringComparison.Ordinal))
                                                {
                                                        return;
                                                }
