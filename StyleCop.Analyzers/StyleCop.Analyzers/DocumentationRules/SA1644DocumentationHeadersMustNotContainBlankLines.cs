...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        ///
        /// <para>A violation of this rule occurs when the documentation header contains one or more
        /// blank lines within a section of documentation. For example:</para>
        ///
        ...
        /// </code>
        ///
        /// <para>Rather than inserting blank lines into the documentation, use the
        /// <c>&lt;para&gt;</c> tag to denote paragraphs. For example:</para>
        ///
        /// <code language="csharp">
        /// /// &lt;summary&gt;
        /// /// &lt;para&gt;
        ...
        internal class SA1644DocumentationHeadersMustNotContainBlankLines : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1644Title),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
                private static readonly LocalizableString MessageFormat =
                  new LocalizableResourceString(nameof(DocumentationResources.SA1644MessageFormat),
                                                DocumentationResources.ResourceManager,
                                                typeof(DocumentationResources));
