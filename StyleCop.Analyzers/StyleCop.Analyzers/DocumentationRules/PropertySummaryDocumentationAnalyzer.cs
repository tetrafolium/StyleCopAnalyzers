        ...
        internal class PropertySummaryDocumentationAnalyzer : PropertyDocumentationBase
        {
                        ...
                        if (propertyType.Type.SpecialType == SpecialType.System_Boolean) {
                                AnalyzeSummaryElement(
                                  ...
                                  resourceManager.GetString(
                                    ...
                                    culture),
                                  resourceManager.GetString(
                                    nameof(DocumentationResources.StartingTextGetsOrSetsWhether),
                                    culture),
                                  resourceManager.GetString(
                                ...
                                AnalyzeSummaryElement(
                                  ...
                                  resourceManager.GetString(
                                    nameof(DocumentationResources.StartingTextGetsOrSets), culture),
                                  resourceManager.GetString(
                                    nameof(DocumentationResources.StartingTextReturns), culture));
                        }
                }
                  ...
                  string unexpectedStartingText3 = null)
                {
                        ...
                        context.ReportDiagnostic(
                          Diagnostic.Create(SA1623Descriptor,
                                            diagnosticLocation,
                  ...
                  string startingTextToRemove)
                {
                        ...
                        context.ReportDiagnostic(
                          Diagnostic.Create(SA1624Descriptor,
                                            diagnosticLocation,
                                            diagnosticProperties.ToImmutable(),
                                            accessor,
                                            expectedStartingText));
