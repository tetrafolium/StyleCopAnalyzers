        ...
        internal class PropertySummaryDocumentationAnalyzer : PropertyDocumentationBase
        {
                        ...
                        if (propertyType.Type.SpecialType == SpecialType.System_Boolean)
                                {
                                        AnalyzeSummaryElement (
                                            context, syntax, diagnosticLocation,
                                            propertyDeclaration,
                                            resourceManager.GetString (
                                                nameof (
                                                    DocumentationResources.StartingTextGetsWhether),
                                                culture),
                                            resourceManager.GetString (
                                                nameof (
                                                    DocumentationResources.StartingTextSetsWhether),
                                                culture),
                                            resourceManager.GetString (
                                                nameof (DocumentationResources
                                                            .StartingTextGetsOrSetsWhether),
                                                culture),
                                            resourceManager.GetString (
                                                nameof (DocumentationResources
                                                            .StartingTextReturnsWhether),
                                                culture));
                                }
                        else
                                {
                                        AnalyzeSummaryElement (
                                            ...
                                            propertyDeclaration,
                                            resourceManager.GetString (
                                                nameof (DocumentationResources.StartingTextGets),
                                                culture),
                                            resourceManager.GetString (
                                                nameof (DocumentationResources.StartingTextSets),
                                                culture),
                                            resourceManager.GetString (
                                                nameof (
                                                    DocumentationResources.StartingTextGetsOrSets),
                                                culture),
                                            resourceManager.GetString (
                                       ...
                                       string startingTextGetsOrSets, string startingTextReturns)
                {
                        ...
                        bool prefixIsGets = !prefixIsGetsOrSets
                                            && text.StartsWith (startingTextGets,
                                                                StringComparison.OrdinalIgnoreCase);
                        bool prefixIsSets = text.StartsWith (startingTextSets,
                                                             StringComparison.OrdinalIgnoreCase);
                        ...
                        if (getter != null && setter != null)
                                {
                                        if (!getter.Modifiers.Any () && !setter.Modifiers.Any ())
                                                {
                                                        // The getter and setter have the same
                        ...
                        if (getterVisible)
                                {
                                        if (setterVisible)
                                                ...
                                                {
                                                        // Both getter and setter exist, but only
                                                        // getter is visible.
                                                        if (!prefixIsGets)
                                                                {
                                                                        if (prefixIsGetsOrSets)
                                                ...
                                                {
                                                        // Getter exists and is visible. Setter does
                                                        // not exist.
                                                        if (!prefixIsGets)
                                                                {
                                                                        ReportSA1623 (
                        ...
                        else if (setterVisible)
                                {
                                        if (getter != null)
                                                ...
                                                {
                                                        // Setter exists and is visible. Getter does
                                                        // not exist.
                                                        if (!prefixIsSets)
                                                                {
                                                                        ReportSA1623 (
