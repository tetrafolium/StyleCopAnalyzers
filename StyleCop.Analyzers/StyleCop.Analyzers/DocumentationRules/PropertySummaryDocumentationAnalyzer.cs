...
namespace StyleCop.Analyzers.DocumentationRules
{
        ...
        internal class PropertySummaryDocumentationAnalyzer : PropertyDocumentationBase
        {
                ...
                public static DiagnosticDescriptor SA1623Descriptor
                {
                        get;
                }
                ...
                public static DiagnosticDescriptor SA1624Descriptor
                {
                        get;
                }
                = new DiagnosticDescriptor(
                                                         ...
                                                         Location diagnosticLocation)
                {
                        ...
                        if (propertyType.Type.SpecialType == SpecialType.System_Boolean)
                        {
                                AnalyzeSummaryElement(
                                    context, syntax, diagnosticLocation, propertyDeclaration,
                    ...
                    string startingTextReturns)
                {
                        ...
                        bool prefixIsGets =
                            !prefixIsGetsOrSets &&
                            text.StartsWith(startingTextGets, StringComparison.OrdinalIgnoreCase);
                        bool prefixIsSets =
                        ...
                        if (getterVisible)
                        {
                                ...
                                else if (setter != null)
                                {
                                        ...
                                        if (!prefixIsGets)
                                        {
                                                if (prefixIsGetsOrSets)
                                                {
                                                        ReportSA1624(context, diagnosticLocation,
                                                                     diagnosticProperties, accessor
                                                                     : "get", expectedStartingText
                                                                     : startingTextGets,
                                                                       startingTextToRemove
                                                                     : startingTextGetsOrSets);
                                                }
                                                else
                                                {
                    ...
                    string unexpectedStartingText2 = null, string unexpectedStartingText3 = null)
                {
                                            ...
                                            StringComparison.OrdinalIgnoreCase))
                        {
                                diagnosticProperties.Add(
                                 ...
                                 text.StartsWith(unexpectedStartingText2,
                                                 StringComparison.OrdinalIgnoreCase))
                        {
                                diagnosticProperties.Add(
                                    TextToRemoveKey,
                                 ...
                                 text.StartsWith(unexpectedStartingText3,
                                                 StringComparison.OrdinalIgnoreCase))
                        {
                                diagnosticProperties.Add(
                                    TextToRemoveKey,
                        ...
                        context.ReportDiagnostic(Diagnostic.Create(
                            SA1623Descriptor, diagnosticLocation,
                    ...
                    string accessor, string expectedStartingText, string startingTextToRemove)
                {
                        ...
                        context.ReportDiagnostic(Diagnostic.Create(
                            SA1624Descriptor, diagnosticLocation,
                            diagnosticProperties.ToImmutable(), accessor, expectedStartingText));
                }
        }
}
