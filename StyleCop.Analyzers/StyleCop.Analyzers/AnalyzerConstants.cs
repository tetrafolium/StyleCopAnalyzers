...
namespace StyleCop.Analyzers
{
        ...
        internal static class AnalyzerConstants
        {
                ...
                /// <see cref="DiagnosticDescriptor(string, string, string, string,
                /// DiagnosticSeverity, bool, string, string, string[])"/> to disable a diagnostic
                ...
                /// Gets a reference value which can be passed to
                /// <see cref="DiagnosticDescriptor(string, string, string, string,
                /// DiagnosticSeverity, bool, string, string, string[])"/> to indicate that the
                /// diagnostic is disabled by default because it is an alternative to a reference
                /// StyleCop rule.
                /// </summary>
                /// <value>
                /// A reference value which can be passed to
