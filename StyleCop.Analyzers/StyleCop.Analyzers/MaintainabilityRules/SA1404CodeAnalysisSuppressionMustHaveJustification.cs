...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// <see cref="SuppressMessageAttribute"/> attribute, but a justification for the
        /// suppression has not been provided within the attribute. Whenever a Code Analysis rule is
        /// suppressed, a justification should be provided. This can increase the long-term
        /// maintainability of the code.</para>
        ///
        /// <code language="csharp">
        /// [SuppressMessage("Microsoft.Performance", "CA1804:RemoveUnusedLocals", Justification =
        /// "Used during unit testing")] public bool Enable()
        /// {
        /// }
        /// </code>
        /// </remarks>
        ...
        internal class SA1404CodeAnalysisSuppressionMustHaveJustification : DiagnosticAnalyzer
        {
                ...
                private sealed class AnalyzerInstance
                {
                        ...
                        /// <summary>
                        /// A lazily-initialized reference to <see cref="SuppressMessageAttribute"/>
                        /// within the context of a particular <see cref="Compilation"/>.
                        /// </summary>
                        ...
                        public void
                        HandleAttributeNode (SyntaxNodeAnalysisContext context)
                        {
                                ...
                                if (symbol != null)
                                        {
                                                ...
                                                if (Equals (symbol.ContainingType,
                                                            this.suppressMessageAttribute))
                                                        {
                                                                foreach (var attributeArgument in
