...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// It is used to share code in diagnostics <see
        ...
        internal abstract class SystemDiagnosticsDebugDiagnosticBase : DiagnosticAnalyzer
        {
                ...
                /// added if the parameter count is lower than <paramref name="parameterIndex"/> or
                /// the string given at the index can be evaluated to null, string.Empty or just
                /// whitespaces.
                /// </summary>
                /// <param name="context">The current analysis context.</param>
                /// <param name="methodName">The method name that should be detected.</param>
                /// <param name="parameterIndex">The index, the string parameter that should be
                ...
                HandleInvocationExpression (SyntaxNodeAnalysisContext context, string methodName,
                        ...
                        if (name == methodName)
                                {
                                        if (context.SemanticModel
                                                ...
                                                .Symbol is IMethodSymbol symbolInfo)
                                                {
                                                        ...
                                                        if (Equals (symbolInfo.ContainingType,
                                                                    debugType)
