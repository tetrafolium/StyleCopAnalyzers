...
namespace StyleCop.Analyzers.MaintainabilityRules {
        ...
        /// </summary>
        /// <remarks>
        /// <para>Storing files in this encoding ensures that the files are always treated the same
        /// way by the compiler, even when compiled on systems with varying default system
        /// encodings. In addition, this encoding is the most widely supported encoding for features
        /// like visual diffs on GitHub and other tooling. This encoding is also the default
