...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// <summary>
        /// A C# statement contains a complex arithmetic expression which omits parenthesis around
        /// operators.
        /// </summary>
        /// <remarks>
        /// <para>C# maintains a hierarchy of precedence for arithmetic operators. It is possible in
        /// C# to string multiple arithmetic operations together in one statement without wrapping
        /// any of the operations in parenthesis, in which case the compiler will automatically set
        /// the order and precedence of the operations based on these pre-established rules. For
        /// example:</para>
        ///
        ...
        /// </code>
        ///
        /// <para>Although this code is legal, it is not highly readable or maintainable. In order
        /// to achieve full understanding of this code, the developer must know and understand the
        /// basic operator precedence rules in C#.</para>
        ///
        /// <para>This rule is intended to increase the readability and maintainability of this type
        /// of code, and to reduce the risk of introducing bugs later, by forcing the developer to
        /// insert parenthesis to explicitly declare the operator precedence. The example below
        /// shows multiple arithmetic operations surrounded by parenthesis:</para>
        ///
        /// <code language="csharp">
        /// int x = 5 + (y * ((b / 6) % z)) - 2;
        /// </code>
        ...
        internal class SA1407ArithmeticExpressionsMustDeclarePrecedence : DiagnosticAnalyzer {
                ...
                public override void Initialize(AnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction(
                            BinaryExpressionAction, HandledBinaryExpressionKinds);
                }
                ...
                private static bool IsSameFamily(
                    SyntaxToken operatorToken1, SyntaxToken operatorToken2)
                {
