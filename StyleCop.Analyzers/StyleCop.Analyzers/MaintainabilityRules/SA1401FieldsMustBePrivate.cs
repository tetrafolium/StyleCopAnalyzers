    ...
    internal class SA1401FieldsMustBePrivate : DiagnosticAnalyzer {
        ...
        private static class Analyzer {
            public static void AnalyzeField(SymbolAnalysisContext symbolAnalysisContext)
            {
                ...
                if (!IsFieldPrivate(fieldDeclarationSyntax) && !IsStaticReadonly(fieldDeclarationSyntax) && IsParentAClass(fieldDeclarationSyntax) && !fieldDeclarationSyntax.IsConst) {
            ...
            {
                if (fieldDeclarationSyntax.ContainingSymbol != null && fieldDeclarationSyntax.ContainingSymbol.Kind == SymbolKind.NamedType) {
