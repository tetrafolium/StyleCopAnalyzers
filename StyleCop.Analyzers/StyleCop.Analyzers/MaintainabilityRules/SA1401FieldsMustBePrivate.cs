...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs whenever a field in a class is given non-private
        /// access. For maintainability reasons, properties should always be used as the mechanism
        /// for exposing fields outside of a class, and fields should always be declared with
        /// private access. This allows the internal implementation of the property to change over
        /// time without changing the interface of the class.</para>
        ///
        ...
        internal class SA1401FieldsMustBePrivate : DiagnosticAnalyzer
        {
                ...
                private static class Analyzer
                {
                        ...
                        AnalyzeField (SymbolAnalysisContext symbolAnalysisContext)
                        {
                                ...
                                if (!IsFieldPrivate (fieldDeclarationSyntax)
                                    ...
                                    && !fieldDeclarationSyntax.IsConst)
                                        {
                                                foreach (var location in symbolAnalysisContext
                                                             .Symbol.Locations)
                                                        {
                                                ...
                                                symbolAnalysisContext.ReportDiagnostic (
                                                    Diagnostic.Create (
                                                        Descriptor,
                                                        fieldDeclarationSyntax.Locations[0]));
                                        }
                        }

                        private static bool
                        IsFieldPrivate (IFieldSymbol fieldDeclarationSyntax)
                        {
                        ...
                        private static bool
                        IsStaticReadonly (IFieldSymbol fieldDeclarationSyntax)
                        {
                        ...
                        private static bool
                        IsParentAClass (IFieldSymbol fieldDeclarationSyntax)
                        {
