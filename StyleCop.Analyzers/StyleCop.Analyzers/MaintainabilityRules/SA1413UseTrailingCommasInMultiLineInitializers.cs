...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>The last statement in a multi-line C# initializer is missing a trailing
        /// comma.</para>
        ///
        /// <para>A violation of this rule occurs when the last statement of a C# initializer is
        /// missing a trailing comma. For example, the following code would generate one instance of
        /// this violation:</para>
        ///
        ...
        internal class SA1413UseTrailingCommasInMultiLineInitializers : DiagnosticAnalyzer
        {
                ...
                private static readonly Action<SyntaxNodeAnalysisContext>
                  HandleAnonymousObjectInitializerAction = HandleAnonymousObjectInitializer;
                private static readonly Action<SyntaxNodeAnalysisContext>
