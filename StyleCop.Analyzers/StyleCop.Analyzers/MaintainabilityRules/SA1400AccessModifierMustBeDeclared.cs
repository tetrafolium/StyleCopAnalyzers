...
namespace StyleCop.Analyzers.MaintainabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>C# allows elements to be defined without an access modifier. Depending upon the
        /// type of element, C# will automatically assign an access level to the element in this
        /// case.</para>
        ///
        /// <para>This rule requires an access modifier to be explicitly defined for every element.
        /// This removes the need for the reader to make assumptions about the code, improving the
        ...
        internal class SA1400AccessModifierMustBeDeclared : DiagnosticAnalyzer
        {
                ...
                private static void
                CheckAccessModifiers (SyntaxNodeAnalysisContext context, SyntaxToken identifier,
                        ...
                        foreach (SyntaxToken token in modifiers)
                                {
                                        switch (token.Kind ())
                                                ...
                                                case SyntaxKind.PartialKeyword:
                                                        // the access modifier might be declared on
                                                        // another part, which isn't handled at this
                                                        // time
                                                        return;
