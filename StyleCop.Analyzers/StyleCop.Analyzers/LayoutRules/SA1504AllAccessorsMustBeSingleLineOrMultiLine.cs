...
private static readonly LocalizableString Title = new LocalizableResourceString(
	nameof(LayoutResources.SA1504Title), LayoutResources.ResourceManager, typeof(LayoutResources));
private static readonly LocalizableString MessageFormat = new LocalizableResourceString(
	nameof(LayoutResources.SA1504MessageFormat), LayoutResources.ResourceManager, typeof(LayoutResources));
private static readonly LocalizableString Description = new LocalizableResourceString(
	nameof(LayoutResources.SA1504Description), LayoutResources.ResourceManager, typeof(LayoutResources));
...
private static void HandleAccessorList(SyntaxNodeAnalysisContext context)
{
	...
	if (hasSingleLineAccessor && hasMultipleLinesAccessor)
	{
		context.ReportDiagnostic(
			Diagnostic.Create(Descriptor, accessorList.Accessors.First().Keyword.GetLocation()));
	}
}
}
}
