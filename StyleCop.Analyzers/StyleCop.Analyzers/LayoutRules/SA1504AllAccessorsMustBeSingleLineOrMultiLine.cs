...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        /// <summary>
        /// Within a C# property, indexer or event, at least one of the child accessors is written
        /// on a single line, and at least one of the child accessors is written across multiple
        /// lines.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the accessors within a property, indexer or
        /// event are not consistently written on a single line or on multiple lines. This rule is
        /// intended to increase the readability of the code by requiring all of the accessors
        /// within an element to be formatted in the same way.</para>
        ///
        /// <para>For example, the following property would generate a violation of this rule,
        /// because one accessor is written on a single line while the other accessor snaps multiple
        /// lines.</para>
        ///
        ...
        /// </code>
        ///
        /// <para>The violation can be avoided by placing both accessors on a single line, or
        /// expanding both accessors across multiple lines:</para>
        ///
        /// <code language="csharp">
        /// public bool Enabled
        /// {
        ...
        internal class SA1504AllAccessorsMustBeSingleLineOrMultiLine : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (LayoutResources.SA1504Title), LayoutResources.ResourceManager,
                        ...
                        if (hasSingleLineAccessor && hasMultipleLinesAccessor)
                                {
                                        context.ReportDiagnostic (Diagnostic.Create (
                                            Descriptor, accessorList.Accessors.First ()
                                                            .Keyword.GetLocation ()));
                                }
                }
        }
