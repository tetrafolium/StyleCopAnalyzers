...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        /// statement have been omitted. In C#, some types of statements may optionally include
        /// braces. Examples include <c>if</c>, <c>while</c>, and <c>for</c> statements. For
        ...
        /// </code>
        ///
        /// <para>Although this is legal in C#, StyleCop always requires the braces to be present,
        /// to increase the readability and maintainability of the code.</para>
        ///
        /// <para>When the braces are omitted, it is possible to introduce an error in the code by
        /// inserting an additional statement beneath the if-statement. For example:</para>
        ///
        /// <code language="csharp">
        /// if (true)
        ///     this.value = 2;
        ...
        /// </code>
        ///
        /// <para>Glancing at this code, it appears as if both the assignment statement and the
        /// return statement are children of the if-statement. In fact, this is not true. Only the
        /// assignment statement is a child of the if-statement, and the return statement will
        /// always execute regardless of the outcome of the if-statement.</para>
        ///
        /// <para>StyleCop always requires the opening and closing braces to be present, to prevent
        /// these kinds of errors:</para>
        ///
        /// <code language="csharp">
        /// if (true)
        /// {
...
#pragma warning restore SA1202 // Elements should be ordered by access
                ...
                Initialize (AnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction (
                            ctx => CheckChildStatement (ctx,
                                                        ((DoStatementSyntax) ctx.Node).Statement),
                        ...
                        context.RegisterSyntaxNodeAction (
                            ctx => CheckChildStatement (ctx,
                                                        ((ForStatementSyntax) ctx.Node).Statement),
                        ...
                        context.RegisterSyntaxNodeAction (
                            ctx => CheckChildStatement (ctx,
                                                        ((LockStatementSyntax) ctx.Node).Statement),
