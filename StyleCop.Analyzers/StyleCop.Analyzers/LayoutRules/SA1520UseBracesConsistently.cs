...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        /// <summary>
        /// The opening and closing braces of a chained <c>if</c>/<c>else if</c>/<c>else</c>
        /// construct were included for some clauses, but omitted for others.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the opening and closing braces for a chained
        /// statement have been included for some clauses but omitted for others. In C#, some types
        /// of statements may optionally include braces. For example, an <c>if</c>-statement may be
        /// written with inconsistent braces:</para>
        ///
        ...
        /// </code>
        ///
        /// <para>Although this is legal in C#, StyleCop requires the braces to be present for all
        /// clauses of a chained <c>if</c>/<c>else if</c>/<c>else</c> construct when braces are
        /// included for any clause, to increase the readability and maintainability of the
        /// code.</para>
        /// </remarks>
        ...
        internal class SA1520UseBracesConsistently : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (LayoutResources.SA1520Title), LayoutResources.ResourceManager,
