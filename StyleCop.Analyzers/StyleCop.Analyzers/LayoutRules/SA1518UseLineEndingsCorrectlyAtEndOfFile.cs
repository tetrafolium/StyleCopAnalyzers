...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>To improve the layout of the code, StyleCop requires no blank lines at the end of
        /// files.</para>
        ///
        /// <para>A violation of this rule occurs when one or more blank lines are at the end of the
        /// file.</para>
        /// </remarks>
        ...
        internal class SA1518UseLineEndingsCorrectlyAtEndOfFile : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString DescriptionRequire
                    = new LocalizableResourceString (
                        nameof (LayoutResources.SA1518DescriptionRequire),
                        LayoutResources.ResourceManager, typeof (LayoutResources));
                private static readonly LocalizableString MessageFormatOmit
                    = new LocalizableResourceString (
                        nameof (LayoutResources.SA1518MessageFormatOmit),
                        LayoutResources.ResourceManager, typeof (LayoutResources));
...
#pragma warning restore SA1202 // Elements should be ordered by access
                ...
                HandleSyntaxTree (SyntaxTreeAnalysisContext context, StyleCopSettings settings)
                {
                                        ...
                                        if (trailingWhitespaceIndex > 0)
                                                {
                                                        ...
                                                        reportedSpan = TextSpan.FromBounds (
                                                            leadingTrivia[trailingWhitespaceIndex]
                                                                .SpanStart,
                                                            reportedSpan.End);
                                                        precedingTrivia
                                                            = leadingTrivia[trailingWhitespaceIndex
                        ...
                        if (precedingTrivia.IsDirective)
                                ...
                                {
                                        reportedSpan = TextSpan.FromBounds (
                                            precedingTrivia.SpanStart, reportedSpan.End);
                                }
