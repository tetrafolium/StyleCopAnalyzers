...
private static readonly LocalizableString Title = new LocalizableResourceString(
	nameof(LayoutResources.SA1500Title), LayoutResources.ResourceManager, typeof(LayoutResources));
private static readonly LocalizableString MessageFormat = new LocalizableResourceString(
	nameof(LayoutResources.SA1500MessageFormat), LayoutResources.ResourceManager, typeof(LayoutResources));
private static readonly LocalizableString Description = new LocalizableResourceString(
	nameof(LayoutResources.SA1500Description), LayoutResources.ResourceManager, typeof(LayoutResources));
	...
	if (openBraceTokenLine == closeBraceToken.GetLine())
	{
		if (context.Node.IsKind(SyntaxKind.ArrayInitializerExpression))
		{
			...
			case SyntaxKind.ArrayCreationExpression:
				if (((ArrayCreationExpressionSyntax) context.Node.Parent).NewKeyword.GetLine() ==
				    openBraceTokenLine)
				{
					return;
				}
			...
			case SyntaxKind.ImplicitArrayCreationExpression:
				if (((ImplicitArrayCreationExpressionSyntax) context.Node.Parent).NewKeyword.GetLine() ==
				    openBraceTokenLine)
				{
					return;
				}
			...
			case SyntaxKind.StackAllocArrayCreationExpression:
				if (((StackAllocArrayCreationExpressionSyntax) context.Node.Parent)
				    .StackAllocKeyword.GetLine() == openBraceTokenLine)
				{
					return;
				}
			...
			case SyntaxKindEx.ImplicitStackAllocArrayCreationExpression:
				if (((ImplicitStackAllocArrayCreationExpressionSyntaxWrapper) context.Node.Parent)
				    .StackAllocKeyword.GetLine() == openBraceTokenLine)
				{
					return;
				}
