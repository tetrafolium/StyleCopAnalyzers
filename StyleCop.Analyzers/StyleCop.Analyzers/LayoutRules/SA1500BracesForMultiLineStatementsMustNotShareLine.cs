...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        /// <summary>
        /// The opening or closing brace within a C# statement, element, or expression is not placed
        /// on its own line.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the opening or closing brace within a
        /// statement, element, or expression is not placed on its own line. For example:</para>
        ///
        /// <code language="cs">
        ...
        /// opening brace of the lock statement is placed on the same line as the lock keyword,
        /// rather than being placed on its own line, as follows:</para>
        ///
        /// <code language="cs">
        /// public object Method()
        /// {
        ...
        /// </code>
        ///
        /// <para>A violation will also occur if the closing brace shares a line with other code.
        /// For example:</para>
        ///
        /// <code language="cs">
        /// public object Method()
        ...
        internal class SA1500BracesForMultiLineStatementsMustNotShareLine : DiagnosticAnalyzer
        {
                ...
                private static void
                CheckBraceToken (SyntaxNodeAnalysisContext context, SyntaxToken token)
                {
                        if (token.IsMissing)
                                {
                                        return;
                        ...
                        SyntaxToken previousToken = token.GetPreviousToken (includeZeroWidth
                                                                            : true);
                        if (!previousToken.IsMissing)
                                {
                                        if (previousToken.GetLineSpan ().StartLinePosition.Line
                                            == line)
                                                {
                                                        ...
                                                        // no need to report more than one instance
                                                        // for this token
                                                        return;
                                                }
                                }
                        ...
                        if (!nextToken.IsMissing)
                                {
                                        switch (nextToken.Kind ())
                                                ...
                                                case SyntaxKind.DotToken:
                                                        // these are allowed to appear on the same
                                                        // line
                                                        return;
