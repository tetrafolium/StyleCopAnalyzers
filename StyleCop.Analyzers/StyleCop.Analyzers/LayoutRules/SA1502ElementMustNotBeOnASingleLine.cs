...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        /// <summary>
        /// A C# element containing opening and closing braces is written completely on a single
        /// line.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when an element that is wrapped in opening and
        /// closing braces is written on a single line. For example:</para> <code language="csharp">
        /// public object Method() { return null; }
        /// </code>
        ///
        /// <para>When StyleCop checks this code, a violation of this rule will occur because the
        /// entire method is written on one line. The method should be written across multiple
        /// lines, with the opening and closing braces each on their own line, as follows:</para>
        ///
        ...
        /// </code>
        ///
        /// <para>As an exception to this rule, accessors within properties, events, or indexers are
        ...
        internal class SA1502ElementMustNotBeOnASingleLine : DiagnosticAnalyzer
        {
                        ...
                        if (baseMethodDeclaration.Body != null)
                                {
                                        CheckViolation (context,
                                                        baseMethodDeclaration.Body.OpenBraceToken,
                ...
                HandleLocalFunctionStatement (SyntaxNodeAnalysisContext context)
                {
                        ...
                        if (localFunctionStatement.Body != null)
                                {
                                        CheckViolation (
                                            context, localFunctionStatement.Body.OpenBraceToken,
                ...
                private static void
                CheckViolation (SyntaxNodeAnalysisContext context, SyntaxToken openBraceToken,
