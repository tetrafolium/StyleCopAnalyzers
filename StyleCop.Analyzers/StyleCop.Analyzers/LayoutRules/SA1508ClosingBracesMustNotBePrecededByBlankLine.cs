...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        /// <summary>
        /// A closing brace within a C# element, statement, or expression is preceded by a blank
        /// line.
        /// </summary>
        /// <remarks>
        ...
        ///
        /// <para>A violation of this rule occurs when a closing brace is preceded by a blank line.
        /// For example:</para>
        ///
        ...
        internal class SA1508ClosingBracesMustNotBePrecededByBlankLine : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (LayoutResources.SA1508Title), LayoutResources.ResourceManager,
                ...
                private static void
                AnalyzeCloseBrace (SyntaxNodeAnalysisContext context, SyntaxToken closeBraceToken)
                {
                        var previousToken = closeBraceToken.GetPreviousToken ();
                        if ((closeBraceToken.GetLineSpan ().StartLinePosition.Line
                             - previousToken.GetLineSpan ().EndLinePosition.Line)
                            < 2)
                                {
                                        // there will be no blank lines when the closing brace and
                                        // the preceding token are not at least two lines apart.
                                        return;
                                }
                        ...
                        // apart and still only be separated by whitespace trivia due to compilation
                        // errors
                        var index = separatingTrivia.Count - 1;
                        while (index >= 0
                               && separatingTrivia [index]
