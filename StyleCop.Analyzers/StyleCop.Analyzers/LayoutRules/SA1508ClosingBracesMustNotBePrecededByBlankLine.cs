...
private static readonly LocalizableString Title = new LocalizableResourceString(
	nameof(LayoutResources.SA1508Title), LayoutResources.ResourceManager, typeof(LayoutResources));
private static readonly LocalizableString MessageFormat = new LocalizableResourceString(
	nameof(LayoutResources.SA1508MessageFormat), LayoutResources.ResourceManager, typeof(LayoutResources));
private static readonly LocalizableString Description = new LocalizableResourceString(
	nameof(LayoutResources.SA1508Description), LayoutResources.ResourceManager, typeof(LayoutResources));
...
private static void AnalyzeCloseBrace(SyntaxNodeAnalysisContext context, SyntaxToken closeBraceToken)
{
	...
	{
		// there will be no blank lines when the closing brace and the preceding token are not at least two
		// lines apart.
		return;
	}

	var separatingTrivia =
		TriviaHelper.MergeTriviaLists(previousToken.TrailingTrivia, closeBraceToken.LeadingTrivia);
