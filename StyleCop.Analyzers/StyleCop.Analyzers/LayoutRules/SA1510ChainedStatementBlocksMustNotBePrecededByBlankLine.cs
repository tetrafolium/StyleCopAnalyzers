...
namespace StyleCop.Analyzers.LayoutRules
{
        ...
        ///
        /// <para>Some types of C# statements can only be used when chained to the bottom of another
        /// statement. Examples include catch and finally statements, which must always be chained
        /// to the bottom of a try-statement. Another example is an else-statement, which must
        /// always be chained to the bottom of an if-statement, or to another else-statement. These
        /// types of chained statements should not be separated by a blank line. For example:</para>
        ///
            ...
            : DiagnosticAnalyzer {
                ...
                public override void Initialize(AnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction(
                            ElseStatementAction, SyntaxKind.ElseClause);
                        context.RegisterSyntaxNodeAction(CatchClauseAction, SyntaxKind.CatchClause);
                        context.RegisterSyntaxNodeAction(
                            FinallyClauseAction, SyntaxKind.FinallyClause);
                }
