...
namespace StyleCop.Analyzers.OrderingRules
{
        ...
        /// <summary>
        /// An element within a C# code file is out of order within regard to access level, in
        /// relation to other elements in the code.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the code elements within a file do not follow
        /// a standard ordering scheme based on access level.</para>
        ///
        /// <para>To comply with this rule, adjacent elements of the same type should be positioned
        /// in the following order by access level:</para>
        ///
        /// <list type="bullet">
        ...
        /// </list>
        ///
        /// <para>Complying with a standard ordering scheme based on access level can increase the
        /// readability and maintainability of the file and make it easier to identify the public
        ...
        internal class SA1202ElementsMustBeOrderedByAccess : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (OrderingResources.SA1202Title), OrderingResources.ResourceManager,
                ...
                private static readonly ImmutableHashSet<SyntaxKind> MemberKinds
                    = ImmutableHashSet.Create (
                        ...
                        SyntaxKind.ConstructorDeclaration, SyntaxKind.EventDeclaration,
                        SyntaxKind.PropertyDeclaration, SyntaxKind.IndexerDeclaration,
                        SyntaxKind.MethodDeclaration, SyntaxKind.ConversionOperatorDeclaration,
                ...
                HandleCompilationUnit (SyntaxNodeAnalysisContext context, StyleCopSettings settings)
                {
                        ...
                        HandleMemberList (context, elementOrder, accessibilityIndex,
                        ...
                        foreach (var member in members)
                                {
                                        ...
                                        currentSyntaxKind
                                            = currentSyntaxKind
                                              == SyntaxKind.EventFieldDeclaration ? SyntaxKind
                                                     .EventDeclaration : currentSyntaxKind;

                                        // if the SyntaxKind of this member (e.g.
                                        // SyntaxKind.IncompleteMember) will not be handled, skip
                                        // early.
                                        ...
                                        if (previousAccessLevel != AccessLevel.NotSpecified)
                                                {
                                                        ...
                                                        for (int j = 0; compareAccessLevel
