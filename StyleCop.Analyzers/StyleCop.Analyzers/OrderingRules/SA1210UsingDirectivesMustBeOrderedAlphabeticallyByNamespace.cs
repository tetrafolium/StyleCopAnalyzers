...
namespace StyleCop.Analyzers.OrderingRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the using directives are not sorted
        /// alphabetically by namespace. Sorting the using directives alphabetically makes the code
        /// cleaner and easier to read, and can help make it easier to identify the namespaces that
        /// are being used by the code. The <see cref="System"/> namespaces are an exception to this
        /// rule and will always precede all other namespaces. See <see
        /// cref="SA1208SystemUsingDirectivesMustBePlacedBeforeOtherUsingDirectives"/> for more
        /// details.</para>
        /// </remarks>
            ...
            : DiagnosticAnalyzer
        {
                                            ...
                                            StyleCopSettings settings)
                {
                        ...
                        ProcessUsings (context, settings.OrderingRules,
                                       namespaceDeclaration.Usings);
                }

                private static void
                ProcessUsings (SyntaxNodeAnalysisContext context, OrderingSettings orderingSettings,
                               SyntaxList<UsingDirectiveSyntax> usings)
                {
                        ...
                        CheckIncorrectlyOrderedUsingsAndReportDiagnostic (context,
                                                                          systemUsingDirectives);
                }
                ...
                private static bool IsAliasOrStaticUsingDirective (
                    UsingDirectiveSyntax usingDirective) => usingDirective.Alias != null
