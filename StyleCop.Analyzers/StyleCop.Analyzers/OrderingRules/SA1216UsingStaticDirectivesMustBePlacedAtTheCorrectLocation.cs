...
namespace StyleCop.Analyzers.OrderingRules
{
    ...
    /// <remarks>
    /// <para>
    /// A violation of this rule occurs when a using static directive is placed before a normal or after an alias using
    /// directive. Placing the using static directives together below normal and before alias using-directives can make
    /// the code cleaner and easier to read, and can help make it easier to identify the static members used throughout
    /// the code.
    /// </para>
    /// </remarks>
    ...
    internal class SA1216UsingStaticDirectivesMustBePlacedAtTheCorrectLocation : DiagnosticAnalyzer
    {
        ...
        /// cref="SA1216UsingStaticDirectivesMustBePlacedAtTheCorrectLocation"/> analyzer.
        /// </summary>
        ...
        private static readonly LocalizableString Title = new LocalizableResourceString(
            nameof(OrderingResources.SA1216Title), OrderingResources.ResourceManager, typeof(OrderingResources));
        private static readonly LocalizableString MessageFormat =
            new LocalizableResourceString(nameof(OrderingResources.SA1216MessageFormat),
                                          OrderingResources.ResourceManager, typeof(OrderingResources));
        private static readonly LocalizableString Description = new LocalizableResourceString(
            nameof(OrderingResources.SA1216Description), OrderingResources.ResourceManager, typeof(OrderingResources));
        ...
        private static void CheckUsingDeclarations(SyntaxNodeAnalysisContext context,
                                                   SyntaxList<UsingDirectiveSyntax> usingDirectives)
        {
            ...
            foreach (var usingDirective in usingDirectives)
            {
                ...
                if (usingDirective.StaticKeyword.IsKind(SyntaxKind.StaticKeyword))
                {
                    ...
                    {
                        // only report a single instance when a static using directive is following an alias using
                        // directive.
                ...
                {
                    // only report a single diagnostic for the last static using directive that is followed by a
                    // non-static using directive
