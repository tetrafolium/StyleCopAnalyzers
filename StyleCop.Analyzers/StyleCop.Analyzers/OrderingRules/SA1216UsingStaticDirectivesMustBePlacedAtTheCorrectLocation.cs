...
namespace StyleCop.Analyzers.OrderingRules
{
        ...
        /// <remarks>
        /// <para>
        /// A violation of this rule occurs when a using static directive is placed before a normal
        /// or after an alias using directive. Placing the using static directives together below
        /// normal and before alias using-directives can make the code cleaner and easier to read,
        /// and can help make it easier to identify the static members used throughout the code.
        /// </para>
        /// </remarks>
        [DiagnosticAnalyzer(LanguageNames.CSharp)]
        internal class SA1216UsingStaticDirectivesMustBePlacedAtTheCorrectLocation
            : DiagnosticAnalyzer {
                /// <summary>
                ...
                private static readonly LocalizableString Title
                    = new LocalizableResourceString(nameof(OrderingResources.SA1216Title),
                ...
                private static readonly LocalizableString Description
                    = new LocalizableResourceString(nameof(OrderingResources.SA1216Description),
                        OrderingResources.ResourceManager, typeof(OrderingResources));
                        ...
                        foreach (var usingDirective in usingDirectives) {
                                ...
                                if (usingDirective.StaticKeyword.IsKind(SyntaxKind.StaticKeyword)) {
                                        if (lastAliasUsingDirective != null) {
                                                // only report a single instance when a static using
                                                // directive is following an alias using directive.
                                        ...
                                        // only report a single diagnostic for the last static using
                                        // directive that is followed by a non-static using
                                        // directive
                                        context.ReportDiagnostic(Diagnostic.Create(
