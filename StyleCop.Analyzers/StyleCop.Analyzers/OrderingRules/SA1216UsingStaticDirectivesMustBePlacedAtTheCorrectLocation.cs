                                        ...
                                        if (usingDirective.StaticKeyword.IsKind (
                                                SyntaxKind.StaticKeyword))
                                                {
                                                        if (lastAliasUsingDirective != null)
                                                                {
                                                                        // only report a single
                                                                        // instance when a static
                                                                        // using directive is
                                                                        // following an alias using
                                                                        // directive.
                                                ...
                                                {
                                                        // only report a single diagnostic for the
                                                        // last static using directive that is
                                                        // followed by a non-static using directive
                                                        context.ReportDiagnostic (
                                                            Diagnostic.Create (
                                                                Descriptor, lastStaticUsingDirective
                                                                                .GetLocation ()));
                                                        break;
                                                }
                                }
