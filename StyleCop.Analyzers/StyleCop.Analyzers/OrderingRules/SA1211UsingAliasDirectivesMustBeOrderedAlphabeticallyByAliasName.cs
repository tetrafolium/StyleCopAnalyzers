...
namespace StyleCop.Analyzers.OrderingRules
{
        ...
        /// <summary>
        /// The using-alias directives within a C# code file are not sorted alphabetically by alias
        /// name.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the using-alias directives are not sorted
        /// alphabetically by alias name. Sorting the using-alias directives alphabetically can make
        /// the code cleaner and easier to read, and can help make it easier to identify the
                                        ...
                                        if (prevAliasUsingDirective != null)
                                                {
                                                        ...
                                                        string prevAliasName
                                                            = prevAliasUsingDirective.Alias.Name
                                                                  .Identifier.ValueText;
                                                        if (string.CompareOrdinal (
                                                                prevAliasName.ToLowerInvariant (),
                                                                currentLowerInvariant)
                                                            > 0)
                                                                {
                                                                        // Find alias before which
                                                                        // should be placed current
                                                                        // alias
                                                                        foreach (
                                                                            string aliasName in
                                                                                usingAliasNames)
