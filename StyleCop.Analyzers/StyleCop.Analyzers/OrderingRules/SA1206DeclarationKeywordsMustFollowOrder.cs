...
namespace StyleCop.Analyzers.OrderingRules
{
        ...
        /// <summary>
        /// The keywords within the declaration of an element do not follow a standard ordering
        /// scheme.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the keywords within an element’s declaration
        /// do not follow a standard ordering scheme.</para>
        ///
        /// <para>Within an element declaration, keywords should appear in the following
        /// order:</para>
        ///
        /// <list type="bullet">
        ...
        /// </list>
        ///
        /// <para>Using a standard ordering scheme for element declaration keywords can make the
        ...
        internal class SA1206DeclarationKeywordsMustFollowOrder : DiagnosticAnalyzer {
                ...
                private static readonly ImmutableArray<SyntaxKind> HandledSyntaxKinds
                    = ImmutableArray.Create(SyntaxKind.ClassDeclaration,
                        ...
                        SyntaxKind.FieldDeclaration, SyntaxKind.MethodDeclaration,
                        SyntaxKind.PropertyDeclaration, SyntaxKind.EventDeclaration,
                        SyntaxKind.EventFieldDeclaration, SyntaxKind.IndexerDeclaration,
                    ...
                    SyntaxNodeAnalysisContext context, SyntaxTokenList modifiers)
                {
                        ...
                        foreach (var modifier in modifiers) {
                                ...
                                if (CompareModifiersType(currentModifierType, previousModifierType)
                                    < 0) {
                                ...
                                if (reportPreviousModifier || reportPreviousOtherModifier) {
                                        ...
                                        // earlier modifier.
                                        var reportedModifier = reportPreviousModifier
                                        ...
                                        context.ReportDiagnostic(
                                            Diagnostic.Create(Descriptor, modifier.GetLocation(),
                                                modifier.ValueText, reportedModifier));
                                }
