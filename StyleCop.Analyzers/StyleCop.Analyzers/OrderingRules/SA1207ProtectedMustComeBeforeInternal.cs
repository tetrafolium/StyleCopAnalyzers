...
namespace StyleCop.Analyzers.OrderingRules
{
        ...
        /// <summary>
        /// The keyword <c>protected</c> is positioned after the keyword <c>internal</c> within the
        /// declaration of a protected internal C# element, or the keyword <c>private</c> is
        /// positioned after the keyword <c>protected</c>.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when a protected internal element's access
        /// modifiers are written as <c>internal protected</c>, or when a private protected
        /// element's access modifiers are written as <c>protected private</c>. In reality, an
        /// element with the keywords <c>protected internal</c> will have the same access level as
        /// an element with the keywords <c>internal protected</c>. To make the code easier to read
        /// and more consistent, StyleCop standardizes the ordering of these keywords, so that a
        /// protected internal element will always be described as such, and never as internal
        ...
        internal class SA1207ProtectedMustComeBeforeInternal : DiagnosticAnalyzer {
                ...
                private static readonly LocalizableString Title
                    = new LocalizableResourceString(nameof(OrderingResources.SA1207Title),
                ...
                private static readonly ImmutableArray<SyntaxKind> HandledSyntaxKinds
                    = ImmutableArray.Create(SyntaxKind.ClassDeclaration,
                        ...
                        SyntaxKind.IndexerDeclaration, SyntaxKind.InterfaceDeclaration,
                                ...
                                if (childToken.IsKind(SyntaxKind.InternalKeyword)) {
                                    ...
                                    && childToken.IsKind(SyntaxKind.PrivateKeyword)) {
                                        context.ReportDiagnostic(Diagnostic.Create(Descriptor,
                                            childToken.GetLocation(), "private", "protected"));
                                        break;
                                }
                        }
                }
