...
namespace StyleCop.Analyzers.Helpers
{
        ...
        internal static class SymbolNameHelpers
        {
                ...
                ToQualifiedString (this ISymbol symbol, NameSyntax name)
                {
                ...
                /// <summary>
                /// Generates the fully qualified System.ValueTuple based name for the given tuple
                /// type.
                /// </summary>
                        ...
                        if (tupleElements.IsDefault)
                                {
                                        ...
                                        // formatting will produce System.ValueTuple and not the C#
                                        // tuple format.
                                ...
                                {
                                        // workaround for
                                        // SymbolDisplayCompilerInternalOptions.UseValueTuple not
                                        ...
                                        for (var i = 0; i < tupleElements.Length; i++)
                                                {
                                                        ...
                                                        builder.Append (
                                                            tupleElements[i].Type.ToDisplayString (
                                                                SymbolDisplayFormat
                                        ...
                                        return ObjectPools.StringBuilderPool.ReturnAndFree (
                                            builder);
                                }
                }

                private static bool
                AppendQualifiedSymbolName (StringBuilder builder, ISymbol symbol, TypeSyntax type)
                {
                        switch (symbol.Kind)
                                {
                                ...
                                case SymbolKind.NamedType:
                                        ...
                                        if (SpecialTypeHelper.TryGetPredefinedType (
                                            ...
                                            && (type?.IsKind (SyntaxKind.PredefinedType) == true
                                                ...
                                                {
                                                        // This handles these cases: int, int?,
                                                        // object, object? But not these cases:
                                                        // System.Int32, System.Int32?,
                                                        // System.Object, System.Object?
                                                        builder.Append (
                                                            specialTypeSyntax.ToFullString ());
                                                        AppendNullableSuffixIfNeeded (builder,
                                                                                      type);
                                                        return true;
                                                }
                                                ...
                                                {
                                                        // This handles the case '(int, int)?' but
                                                        // not 'System.Nullable<(int, int)>'
                ...
                private static bool
                AppendNamedType (StringBuilder builder, INamedTypeSymbol namedTypeSymbol,
                                 TypeSyntax type)
                {
                            ...
                            for (int i = 0; i < arguments.Length; i++)
                                    {
                                            ...
                                            var argumentType
                                                = argumentTypes != null
                                                  && argumentTypes.Arguments.Count
                                                         > i ? argumentTypes.Arguments[i] : null;
                                            ...
                                            if (!argumentType.IsKind (
                                                    SyntaxKind.OmittedTypeArgument))
                                                    {
                                                            AppendQualifiedSymbolName (
                                                                builder, argument, argumentType);
                                                    }
                                    }
            ...
            return true;
                ...
                private static bool
                AppendTupleType (StringBuilder builder, INamedTypeSymbol namedTypeSymbol,
                                 TypeSyntax type)
                {
                        if (TupleTypeSyntaxWrapper.IsInstance (type))
                                ...
                                {
                                        return AppendNamedType (
                                            builder, namedTypeSymbol.TupleUnderlyingTypeOrSelf (),
                                            type);
                                }
                }

                private static TypeSyntax
                GetElementSyntax (TypeSyntax typeSyntax)
                {
                ...
                private static void
                AppendNullableSuffixIfNeeded (StringBuilder builder, TypeSyntax type)
                {
