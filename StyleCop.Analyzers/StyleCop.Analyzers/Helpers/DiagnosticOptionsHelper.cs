...
namespace StyleCop.Analyzers.Helpers
{
        ...
        internal static class DiagnosticOptionsHelper {
                /// <summary>
                /// Determines if the diagnostic identified by the given identifier is currently
                /// suppressed.
                /// </summary>
                /// <param name="context">The context that will be used to determine if the
                ...
                internal static bool IsAnalyzerSuppressed(
                    this SyntaxNodeAnalysisContext context, DiagnosticDescriptor descriptor)
                {
                ...
                /// suppressed.
                /// </summary>
                /// <param name="compilation">The compilation that will be used to determine if the
                /// diagnostic is currently suppressed.</param> <param name="descriptor">The
                /// diagnostic descriptor to check.</param> <returns>True if the diagnostic is
                /// currently suppressed.</returns>
                internal static bool IsAnalyzerSuppressed(
                    this Compilation compilation, DiagnosticDescriptor descriptor)
                {
                ...
                /// suppressed.
                /// </summary>
                /// <param name="compilationOptions">The compilation options that will be used to
                ...
                /// <summary>
                /// Gets the effective <see cref="DocumentationMode"/> used when parsing the <see
                /// cref="SyntaxTree"/> containing the specified context.
                /// </summary>
                /// <param name="context">The analysis context.</param>
                /// <returns>
                /// <para>The <see cref="DocumentationMode"/> of the <see cref="SyntaxTree"/>
                /// containing the context.</para> <para>-or-</para> <para><see
