...
namespace StyleCop.Analyzers.Helpers
{
        ...
        internal static class FileNameHelpers
        {
                ...
                GetFileNameAndSuffix (string path, out string suffix)
                {
                ...
                internal static string
                GetConventionalFileName (MemberDeclarationSyntax declaration,
                ...
                GetMetadataFileName (TypeDeclarationSyntax typeDeclaration)
                {
                        return $"{typeDeclaration.Identifier.ValueText}`{typeDeclaration.Arity}";
                }

                private static string
                GetStyleCopFileName (TypeDeclarationSyntax typeDeclaration)
                {
