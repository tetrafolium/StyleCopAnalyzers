...
namespace StyleCop.Analyzers.Helpers {
        ...
        internal static class XmlCommentHelper {
                ...
                /// <summary>
                /// The &lt;placeholder&gt; tag is a Sandcastle Help File Builder extension to the
                /// standard XML documentation comment tags, and is used to mark sections of
                /// documentation which need to be reviewed.
                /// </summary>
                internal const string PlaceholderTag = "placeholder";

                /// <summary>
                /// This helper is used by documentation diagnostics to check if a XML comment
                /// should be considered empty. A comment is empty if
                /// - it is null
                /// - it does not have any text in any XML element and it does not have an empty XML
                /// element in it.
                /// </summary>
                ...
                /// <summary>
                /// This helper is used by documentation diagnostics to check if a XML comment
                /// should be considered empty. A comment is empty if it does not have any text in
                /// any XML element and it does not have an empty XML element in it.
                /// </summary>
                ...
                /// <summary>
                /// This helper is used by documentation diagnostics to check if an XML comment
                /// should be considered empty. A comment is empty if it does not have any text in
                /// any XML element and it does not have an empty XML element in it.
                /// </summary>
                ...
                /// <summary>
                /// Checks if a <see cref="SyntaxTrivia"/> contains a <see
                /// cref="DocumentationCommentTriviaSyntax"/> and returns <see langword="true"/> if
                /// it is considered empty.
                /// </summary>
                /// <param name="commentTrivia">A <see cref="SyntaxTrivia"/> containing possible
                /// documentation.</param> <returns> <see langword="true"/> if <paramref
                /// name="commentTrivia"/> does not have documentation in it or the documentation in
