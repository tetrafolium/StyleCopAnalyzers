...
namespace StyleCop.Analyzers.Helpers
{
        ...
        internal static class SyntaxTreeHelpers {
                ...
                /// </summary>
                /// <remarks>
                /// <para>This allows many analyzers that run on every token in the file to avoid
                ...
                /// <summary>
                /// Checks if a given <see cref="SyntaxTree"/> only contains whitespace. We don't
                /// want to analyze empty files.
                /// </summary>
                /// <param name="tree">The syntax tree to examine.</param>
                /// <param name="cancellationToken">The <see cref="CancellationToken"/> that the
                ...
                /// </returns>
                public static bool IsWhitespaceOnly(
                    this SyntaxTree tree, CancellationToken cancellationToken)
                {
