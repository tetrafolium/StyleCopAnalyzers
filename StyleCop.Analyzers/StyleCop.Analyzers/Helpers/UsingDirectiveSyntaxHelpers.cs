...
/// <returns>Return true if the <see cref="UsingDirectiveSyntax"/>is system using directive, otherwise
/// false.</returns>
...
/// <returns>True if the <see cref="UsingDirectiveSyntax"/> is preceded by a preprocessor directive, otherwise
/// false.</returns>
...
internal static UsingGroup GetUsingGroupType(this UsingDirectiveSyntax usingDirective, StyleCopSettings settings)
{
	...
	if (settings.OrderingRules.SystemUsingDirectivesFirst && usingDirective.IsSystemUsingDirective())
	{
...
internal static bool StartsWithAlias(this UsingDirectiveSyntax usingDirective, SemanticModel semanticModel,
