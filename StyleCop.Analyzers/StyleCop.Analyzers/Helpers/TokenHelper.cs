...
namespace StyleCop.Analyzers.Helpers
{
        ...
        internal static class TokenHelper {
                ...
                /// <param name="allowNonWhitespaceTrivia"><see langword="true"/> to consider the
                /// token first-in-line even when non-whitespace trivia precedes the token;
                /// otherwise, <see langword="false"/> to only consider tokens first in line if they
                ...
                /// </returns>
                internal static bool IsFirstInLine(
                    this SyntaxToken token, bool allowNonWhitespaceTrivia = true)
                {
                ...
                internal static bool IsLastInLine(this SyntaxToken token)
                {
                        ...
                        if (token.SyntaxTree == null
                            || fullLineSpan.EndLinePosition.Character == 0) {
                                return true;
                        }
                ...
                /// <summary>
                /// Gets a value indicating whether the <paramref name="token"/> is preceded by a
                /// whitespace.
                /// </summary>
                /// <param name="token">The token to process.</param>
                ...
                /// false.</returns>
                internal static bool IsPrecededByWhitespace(
                    this SyntaxToken token, CancellationToken cancellationToken)
                {
                ...
                /// <summary>
                /// Gets a value indicating whether the <paramref name="token"/> is the first token
                /// in a line and it is only preceded by whitespace.
                /// </summary>
                /// <param name="token">The token to process.</param>
                ...
                /// <summary>
                /// Gets a value indicating whether the <paramref name="token"/> is followed by a
                /// whitespace.
                /// </summary>
                /// <param name="token">The token to process.</param>
