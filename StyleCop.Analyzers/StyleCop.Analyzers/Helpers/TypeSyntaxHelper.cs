...
namespace StyleCop.Analyzers.Helpers
{
        ...
        {
                public static TypeSyntax
                GetContainingNotEnclosingType (this TypeSyntax syntax)
                {
                        while (true)
                                {
                ...
                public static bool
                IsReturnType (this TypeSyntax syntax)
                {
                        switch (syntax.Parent.Kind ())
                                {
                ...
                public static TypeSyntax
                StripRefFromType (this TypeSyntax syntax)
                {
