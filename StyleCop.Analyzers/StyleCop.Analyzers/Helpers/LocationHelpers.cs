...
namespace StyleCop.Analyzers.Helpers
{
        ...
        internal static class LocationHelpers
        {
                ...
                GetLineSpan (this SyntaxToken token)
                {
                ...
                /// node.</returns>
                internal static FileLinePositionSpan
                GetLineSpan (this SyntaxNode node)
                {
                ...
                /// trivia.</returns>
                internal static FileLinePositionSpan
                GetLineSpan (this SyntaxTrivia trivia)
                {
                ...
                internal static int
                GetLine (this SyntaxToken token)
                {
                ...
                internal static int
                GetLine (this SyntaxTrivia trivia)
                {
                ...
                internal static int
                GetEndLine (this SyntaxToken token)
                {
                ...
                internal static int
                GetEndLine (this SyntaxNode node)
                {
                ...
                internal static int
                GetEndLine (this SyntaxTrivia trivia)
                {
                ...
                SpansMultipleLines (this SyntaxNode node)
                {
                ...
                /// <summary>
                /// Gets a value indicating whether the given trivia span multiple source text
                /// lines.
                /// </summary>
                ...
                /// </returns>
                internal static bool
                SpansMultipleLines (this SyntaxTrivia trivia)
                {
