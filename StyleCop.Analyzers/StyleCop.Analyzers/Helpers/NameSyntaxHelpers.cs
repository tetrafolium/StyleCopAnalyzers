...
namespace StyleCop.Analyzers.Helpers
{
        ...
        internal static class NameSyntaxHelpers
        {
                ...
                /// <summary>
                /// Gets the name contained in the <see cref="NameSyntax"/>, including the alias
                /// prefix (if any).
                /// </summary>
                ...
                ToNormalizedString (this NameSyntax nameSyntax)
                {
                ...
                /// <summary>
                /// Gets the name contained in the <see cref="NameSyntax"/>, without an alias
                /// prefix.
                /// </summary>
                /// <param name="nameSyntax">The <see cref="NameSyntax"/> from which the name will
                /// be extracted.</param> <returns>The name contained in the <see
                ...
                internal static string
                ToUnaliasedString (this NameSyntax nameSyntax)
                {
                ...
                internal static int
                Compare (NameSyntax first, NameSyntax second)
                {
                ...
                private static void
                BuildName (NameSyntax nameSyntax, StringBuilder builder, bool includeAlias)
                {
                        if (nameSyntax.IsKind (SyntaxKind.IdentifierName))
                        ...
                        else if (nameSyntax.IsKind (SyntaxKind.GenericName))
                                {
                                        ...
                                        builder.AppendFormat (
                                            "{0}{1}", genericNameSyntax.Identifier.ValueText,
                        ...
                        else if (nameSyntax.IsKind (SyntaxKind.AliasQualifiedName))
                                {
                                        ...
                                        builder.Append (
                                            aliasQualifiedNameSyntax.Name.Identifier.ValueText);
                                }
                }
        }
}
