...
namespace StyleCop.Analyzers.Settings.ObjectModel
{
        ...
        internal class DocumentationSettings
        {
                ...
                /// <summary>
                /// This is the backing field for the <see cref="DocumentExposedElements"/>
                /// property.
                /// </summary>
                private readonly bool documentExposedElements;

                /// <summary>
                /// This is the backing field for the <see cref="DocumentInternalElements"/>
                /// property.
                /// </summary>
                private readonly bool documentInternalElements;

                /// <summary>
                /// This is the backing field for the <see cref="DocumentPrivateElements"/>
                /// property.
                /// </summary>
                ...
                /// <summary>
                /// This is the backing field for the <see cref="ExcludeFromPunctuationCheck"/>
                /// property.
                /// </summary>
                ...
                /// settings.</param>
                protected internal
                DocumentationSettings (JsonObject documentationSettingsObject)
                    : this()
                {
                        foreach (var kvp in documentationSettingsObject)
                                {
                                        switch (kvp.Key)
                                                ...
                                                case "fileNamingConvention":
                                                        this.fileNamingConvention = kvp.ToEnumValue<
                ...
                public string
                GetCopyrightText (string fileName)
                {
                        ...
                        if (!expandedCopyrightText.Value)
                                {
                                        // Unable to cache the copyright text due to use of a
                                        // {fileName} variable.
                ...
                private KeyValuePair<string, bool>
                BuildCopyrightText (string fileName)
                {
                        bool canCache = true;
                        ...
                        string Evaluator (Match match)
                        {
                                ...
                                switch (key)
                                        ...
                                        default:
                                                ...
                                                if (key == "fileName")
                                                        {
                                                                // The 'fileName' built-in variable
                                                                // is only applied when the user did
                                                                // not include an explicit value for
                                                                // a custom 'fileName' variable.
                                                                canCache = false;
                                                                return fileName;
                                                        }
