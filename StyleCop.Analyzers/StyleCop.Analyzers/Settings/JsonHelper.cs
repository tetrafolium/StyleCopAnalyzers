...
namespace StyleCop.Analyzers
{
        ...
        internal static class JsonHelper
        {
                ...
                internal static int
                ToInt32Value (this KeyValuePair<string, JsonValue> jsonValue)
                {
                ...
                /// <returns>The string value contained within the JSON value.</returns>
                internal static string
                ToStringValue (this JsonValue jsonValue, string elementName)
                {
                ...
                /// <returns>The enum value contained within the JSON value.</returns>
                internal static TEnum
                ToEnumValue<TEnum> (this JsonValue jsonValue, string elementName) where TEnum
                    : struct
                {
                        if (!jsonValue.IsString)
                                {
                ...
                /// <summary>
                /// Checks if the given JSON value is an array. Will throw an exception if it is
                /// not.
                /// </summary>
                /// <param name="jsonValue">The key value pair identifying the JSON value.</param>
                internal static void
                AssertIsArray (this KeyValuePair<string, JsonValue> jsonValue)
                {
                ...
                /// <summary>
                /// Checks if the given JSON value is an object. Will throw an exception if it is
                /// not.
                /// </summary>
                /// <param name="jsonValue">The key value pair identifying the JSON value.</param>
                internal static void
