	...
	get
	{
		if (object.ReferenceEquals(resourceMan, null))
		{
			global::System.Resources.ResourceManager temp =
				new global::System.Resources.ResourceManager("StyleCop.Analyzers.SpecialRules.SpecialResources",
...
/// <summary>
///   Looks up a localized string similar to XML comment analysis can only be performed when the project is
///   configured to parse documentation comments. To enable this functionality, update the project to produce an
///   XML documentation file as part of the build..
/// </summary>
...
/// <summary>
///   Looks up a localized string similar to Various errors in the stylecop.json file can prevent the file from
///   being loaded by the analyzers. In this case, the default settings are used instead.
///
///{0}.
/// </summary>
