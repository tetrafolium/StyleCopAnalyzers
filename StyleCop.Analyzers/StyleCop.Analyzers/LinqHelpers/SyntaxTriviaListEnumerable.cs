...
namespace System.Linq
{
        ...
        internal static class SyntaxTriviaListEnumerable
        {
                ...
                /// </summary>
                /// <remarks>
                /// <para>This method allows callers to avoid boxing the <see
                /// cref="SyntaxTriviaList"/> as an <see cref="IEnumerable{T}"/>.</para>
                /// </remarks>
                ...
                /// <summary>
                /// Determines if a <see cref="SyntaxTriviaList"/> contains any trivia matching the
                ...
                /// <param name="predicate">The predicate determining the matching conditions for
                ...
                /// <summary>
                /// Determines if all of the trivia in a <see cref="SyntaxTriviaList"/> match the
                /// conditions specified by a predicate.
                /// </summary>
                /// <remarks>
                /// <para>This method allows callers to avoid boxing the <see
                ...
                /// <param name="list">The <see cref="SyntaxTriviaList"/> to search.</param>
                /// <param name="predicate">The predicate determining the matching conditions for
                /// trivia.</param> <returns> <see langword="true"/> if all trivia in the specified
