...
namespace StyleCop.Analyzers {
        ...
        /// <summary>
        /// This attribute is applied to <see cref="DiagnosticAnalyzer"/>s for which no code fix is
        /// currently planned.
        /// </summary>
        /// <remarks>
        /// <para>There are several reasons an analyzer does not have a code fix, including but not
        /// limited to the following:</para> <list type="bullet"> <item><description>Visual Studio
        /// provides a built-in code fix.</description></item> <item><description>A code fix could
        /// not provide a useful solution.</description></item>
        /// </list>
