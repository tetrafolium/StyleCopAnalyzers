...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// <summary>
        /// A comma between two parameters in a call to a C# method or indexer, or in the
        /// declaration of a method or indexer, is not placed on the same line as the previous
        /// parameter.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when a comma between two parameters to a method or
        /// indexer is not placed on the same line as the previous parameter. The following examples
        /// show correct placement of the comma:</para> <code language="csharp"> public string
        ...
        internal class SA1113CommaMustBeOnSameLineAsPreviousParameter : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1113Description),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                ...
                HandleBaseMethodDeclaration (SyntaxNodeAnalysisContext context)
                {
                        ...
                        HandleBaseParameterListSyntax (context,
                                                       baseMethodDeclaration.ParameterList);
                }
