...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// <summary>
        /// A C# statement contains a comment between the declaration of the statement and the
        /// opening brace of the statement.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the code contains a comment in between the
        ...
        /// }
        /// </code>
        /// <para>The comment can legally be placed above the statement, or within the body of the
        /// statement:</para> <code language="csharp">
        /// // Make sure x does not equal y
        /// if (x != y)
        /// {
        /// }
        ...
        /// four forward slashes rather than two:</para> <code language="csharp"> if (x != y)
        /// ////if (x == y)
        /// {
        /// }
        /// </code>
        ...
        internal class SA1108BlockStatementsMustNotContainEmbeddedComments : DiagnosticAnalyzer {
                ...
                private static void FindAllComments(SyntaxNodeAnalysisContext context,
                    SyntaxToken previousToken, SyntaxToken openBraceToken)
                {
