...
namespace StyleCop.Analyzers.ReadabilityRules {
        ...
        /// <summary>
        /// A call to a member is not prefixed with the <c>this.</c>, <c>base.</c>, <c>object.</c>
        /// or <c>typename.</c> prefix to indicate the intended method call, within a C# code file.
        /// </summary>
        /// <remarks>
        /// <para>This diagnostic is not implemented in StyleCopAnalyzers.</para>
        ///
        /// <para>A violation of this rule occurs whenever the code contains a call to a member
        /// which is not prefixed correctly.</para>
        ///
        /// <para>In some case from source code analysis we cannot be sure which prefix is required.
        ...
        internal class SA1126PrefixCallsCorrectly : DiagnosticAnalyzer {
                /// <summary>
                /// The ID for diagnostics produced by the <see cref="SA1126PrefixCallsCorrectly"/>
                /// analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title =
                    new LocalizableResourceString(nameof(ReadabilityResources.SA1126Title),
