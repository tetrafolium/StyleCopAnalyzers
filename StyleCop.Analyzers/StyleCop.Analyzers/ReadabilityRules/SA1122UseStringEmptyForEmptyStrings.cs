...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the code contains an empty string. For
        /// example:</para>
        ///
        ...
        /// </code>
        ///
        /// <para>This will cause the compiler to embed an empty string into the compiled code.
        /// Rather than including a hard-coded empty string, use the static <see
        /// cref="string.Empty"/> field:</para>
        ///
        /// <code language="csharp">
        ...
        internal class SA1122UseStringEmptyForEmptyStrings : DiagnosticAnalyzer
        {
                ...
                /// cref="SA1122UseStringEmptyForEmptyStrings"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (ReadabilityResources.SA1122Title), ReadabilityResources.ResourceManager,
                ...
                private static readonly Action<SyntaxNodeAnalysisContext>
                    StringLiteralExpressionAction = HandleStringLiteralExpression;
                ...
                Initialize (AnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction (StringLiteralExpressionAction,
                ...
                private static bool
                HasToBeConstant (LiteralExpressionSyntax literalExpression)
                {
                        ExpressionSyntax outermostExpression
                            = FindOutermostExpression (literalExpression);
                        ...
                        if (outermostExpression.Parent is EqualsValueClauseSyntax equalsValueClause)
                                {
                                        ...
                                        if (!(equalsValueClause.Parent is VariableDeclaratorSyntax
                                                  variableDeclaratorSyntax)
                                            || !(variableDeclaratorSyntax?.Parent is
                                        ...
                                        if (variableDeclarationSyntax.Parent is
                                                FieldDeclarationSyntax fieldDeclarationSyntax
                                            && fieldDeclarationSyntax.Modifiers.Any (
                                        ...
                                        if (variableDeclarationSyntax.Parent is
                                                LocalDeclarationStatementSyntax
                                                    localDeclarationStatementSyntax
                                            && localDeclarationStatementSyntax.Modifiers.Any (
                                                SyntaxKind.ConstKeyword))
                                                {
                                                        return true;
                                                }
                ...
                FindOutermostExpression (ExpressionSyntax node)
                {
                        while (true)
                                {
