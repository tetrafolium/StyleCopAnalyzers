...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        internal class SA1116SplitParametersMustStartOnLineAfterDeclaration : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1116Description),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                ...
                HandleIndexerDeclaration (SyntaxNodeAnalysisContext context)
                {
                        ...
                        if (arguments.Count > 1)
                                {
                                        Analyze (context, argumentListSyntax.OpenBracketToken,
                        ...
                        foreach (var rankSpecifier in arrayCreation.Type.RankSpecifiers)
                                {
                                        ...
                                        if (sizes.Count > 1)
                                                {
                                                        Analyze (context,
                                                                 rankSpecifier.OpenBracketToken,
                                                                 sizes[0], sizes[1]);
                                                }
                                }
                }
                ...
                HandleAttribute (SyntaxNodeAnalysisContext context)
                {
                        ...
                        if (arguments.Count > 1)
                                {
                                        Analyze (context, argumentListSyntax.OpenParenToken,
                                                 arguments[0], arguments[1]);
                                }
                }
                ...
                private static void
                HandleImplicitElementAccess (SyntaxNodeAnalysisContext context)
                {
                ...
                private static void
                HandleArgumentListSyntax (SyntaxNodeAnalysisContext context,
                                          ArgumentListSyntax argumentList)
                {
                        ...
                        if (parameters.Count > 1)
                                {
                                        Analyze (context, argumentList.OpenParenToken,
                                                 parameters[0], parameters[1]);
                                }
                }

                private static void
                HandleParameterListSyntax (SyntaxNodeAnalysisContext context,
                                           ParameterListSyntax parameterList)
                {
                        ...
                        if (parameters.Count > 1)
                                {
                                        Analyze (context, parameterList.OpenParenToken,
                                                 parameters[0], parameters[1]);
                                }
                }
                ...
                private static void
                Analyze (SyntaxNodeAnalysisContext context, SyntaxToken openParenOrBracketToken,
