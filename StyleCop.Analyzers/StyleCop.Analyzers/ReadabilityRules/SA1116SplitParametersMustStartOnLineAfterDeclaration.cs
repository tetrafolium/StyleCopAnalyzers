...
namespace StyleCop.Analyzers.ReadabilityRules {
        ...
        internal class SA1116SplitParametersMustStartOnLineAfterDeclaration : DiagnosticAnalyzer {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString(
                    nameof(ReadabilityResources.SA1116Title), ReadabilityResources.ResourceManager,
                    typeof(ReadabilityResources));
                private static readonly LocalizableString MessageFormat =
                    new LocalizableResourceString(nameof(ReadabilityResources.SA1116MessageFormat),
                ...
                public override void Initialize(AnalysisContext context) {
                        ...
                        context.RegisterSyntaxNodeAction(ImplicitElementAccessAction,
                ...
                private static void HandleImplicitElementAccess(SyntaxNodeAnalysisContext context) {
                        ...
                        HandleBracketedArgumentListSyntax(context,
                                                          implicitElementAccess.ArgumentList);
                }

                private static void HandleArgumentListSyntax(SyntaxNodeAnalysisContext context,
                ...
                private static void HandleParameterListSyntax(SyntaxNodeAnalysisContext context,
                ...
                private static void Analyze(SyntaxNodeAnalysisContext context,
                                            ...
                                            SyntaxNode firstParameter, SyntaxNode secondParameter) {
