...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// <summary>
        /// A constructor initializer is on the same line as the constructor declaration, within a
        /// C# code file.
        /// </summary>
        ...
        internal class SA1128ConstructorInitializerMustBeOnOwnLine : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (ReadabilityResources.SA1128Title), ReadabilityResources.ResourceManager,
                ...
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1128Description),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                ...
                private static void
                Analyze (SyntaxNodeAnalysisContext context,
                        ...
                        if (!colon.IsFirstInLine ())
                                {
                                        context.ReportDiagnostic (Diagnostic.Create (
                                            Descriptor, initializer.GetLocation ()));
                                        return;
                                }
