...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs whenever a region is placed within the body of a
        /// code element. In many editors, including Visual Studio, the region will appear collapsed
        /// by default, hiding the code within the region. It is generally a bad practice to hide
        /// code within the body of an element, as this can lead to bad decisions as the code is
        /// maintained over time.</para>
        /// </remarks>
        [DiagnosticAnalyzer(LanguageNames.CSharp)]
        internal class SA1123DoNotPlaceRegionsWithinElements : DiagnosticAnalyzer {
                /// <summary>
                /// The ID for diagnostics produced by the <see
                /// cref="SA1123DoNotPlaceRegionsWithinElements"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title
                    = new LocalizableResourceString(nameof(ReadabilityResources.SA1123Title),
                        ReadabilityResources.ResourceManager, typeof(ReadabilityResources));
                private static readonly LocalizableString MessageFormat
                    = new LocalizableResourceString(
                        nameof(ReadabilityResources.SA1123MessageFormat),
                        ReadabilityResources.ResourceManager, typeof(ReadabilityResources));
                private static readonly LocalizableString Description
                    = new LocalizableResourceString(nameof(ReadabilityResources.SA1123Description),
                        ReadabilityResources.ResourceManager, typeof(ReadabilityResources));
                ...
                public override void Initialize(AnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction(
                            RegionDirectiveTriviaAction, SyntaxKind.RegionDirectiveTrivia);
                }

                /// <summary>
                /// Checks if a region is completely part of a body. That means that the
                /// <c>#region</c> and <c>#endregion</c> tags both have to have a common <see
                /// cref="BlockSyntax"/> as one of their ancestors.
                /// </summary>
                /// <param name="regionSyntax">The <see cref="RegionDirectiveTriviaSyntax"/> that
                /// should be analyzed.</param> <returns><see langword="true"/>, if both tags have a
                /// common <see cref="BlockSyntax"/> as one of their ancestors; otherwise, <see
                    ...
                    RegionDirectiveTriviaSyntax regionSyntax)
                {
                        ...
                        foreach (var directive in regionSyntax.GetRelatedDirectives()) {
                                BlockSyntax blockSyntax = directive.AncestorsAndSelf()
                                                              .OfType<BlockSyntax>()
                                                              .LastOrDefault();
                                if (blockSyntax == null) {
                                        return false;
