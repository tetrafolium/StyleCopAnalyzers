...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the code contain an extra semicolon.
        ...
        internal class SA1106CodeMustNotContainEmptyStatements : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1106Description),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                ...
                private static void
                HandleEmptyStatement (SyntaxNodeAnalysisContext context)
                {
                        ...
                        if (syntax.Parent is LabeledStatementSyntax labeledStatementSyntax)
                                {
                                        if (labeledStatementSyntax.Parent is BlockSyntax
                                                blockSyntax)
                                                {
                                                        for (int i
                                                             ...
                                                             i >= 0; i--)
                                                                {
                                                                        ...
                                                                        // allow an empty statement
                                                                        // to be used for a label,
                                                                        // but only if no non-empty
                                                                        // statements exist before
