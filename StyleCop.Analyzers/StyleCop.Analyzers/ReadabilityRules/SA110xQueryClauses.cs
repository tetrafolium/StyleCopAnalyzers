...
/// </summary>
/// <seealso href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1102.md">SA1102
/// Query clause should follow previous clause</seealso> <seealso
/// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1103.md">SA1103 Query
/// clauses should be on separate lines or all on one line</seealso> <seealso
/// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1104.md">SA1104 Query
/// clause should begin on new line when previous clause spans multiple lines</seealso> <seealso
/// href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/blob/master/documentation/SA1105.md">SA1105 Query
/// clauses spanning multiple lines should begin on own line</seealso>
...
public static DiagnosticDescriptor SA1102Descriptor
{
	get;
}
...
public static DiagnosticDescriptor SA1103Descriptor
{
	get;
}
...
public static DiagnosticDescriptor SA1104Descriptor
{
	get;
}
...
public static DiagnosticDescriptor SA1105Descriptor
{
	get;
}
...
private static void HandleQueryExpression(SyntaxNodeAnalysisContext context)
{
	...
	for (var i = 0; i < tokensToCheck.Count - 1; i++)
	{
		...
		if (((location2.StartLinePosition.Line - location1.EndLinePosition.Line) > 1) && isEnabledSA1102 &&
		...
		if (onSameLine && isEnabledSA1104 && !(parent1 is QueryContinuationSyntax) &&
	...
	if (!allOnSameLine && !allOnSeparateLine && !suppressSA1103 && isEnabledSA1103)
	{
		context.ReportDiagnostic(
			Diagnostic.Create(SA1103Descriptor, queryExpression.FromClause.FromKeyword.GetLocation()));
	}
}
