...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        internal class SA1135UsingDirectivesMustBeQualified : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1135Description),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                ...
                private static void
                HandleUsingDeclaration (SyntaxNodeAnalysisContext context)
                {
                ...
                private static void
                CheckUsingDeclaration (SyntaxNodeAnalysisContext context,
                ...
                private static bool
                AppendCanonicalString (StringBuilder builder, TypeSyntax type)
                {
                        switch (type)
                                {
