...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// <summary>
        /// The closing parenthesis or bracket in a call to a C# method or indexer, or the
        /// declaration of a method or indexer, is not placed on the same line as the last
        /// parameter.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when the closing bracket of a method or indexer
        /// call or declaration is not placed on the same line as the last parameter. The following
        /// examples show correct placement of the bracket:</para> <code language="csharp"> public
        ...
        internal class SA1111ClosingParenthesisMustBeOnLineOfLastParameter : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString MessageFormat
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1111MessageFormat),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1111Description),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                        ...
                        if (!localFunctionStatementSyntax.ParameterList.CloseParenToken.IsMissing)
                                {
                                        CheckIfLocationOfLastArgumentOrParameterAndCloseTokenAreTheSame (
                                            context, lastParameter,
                                            localFunctionStatementSyntax.ParameterList
                                                .CloseParenToken);
                                }
                }
