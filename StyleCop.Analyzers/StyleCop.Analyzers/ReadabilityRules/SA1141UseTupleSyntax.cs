...
private static bool IsValueTupleWithLanguageRepresentation(SyntaxNodeAnalysisContext context,
                                                           ExpressionSyntax syntax)
{
	var symbolInfo = context.SemanticModel.GetSymbolInfo(syntax, context.CancellationToken);
	return symbolInfo.Symbol is INamedTypeSymbol typeSymbol && typeSymbol.IsTupleType() &&
