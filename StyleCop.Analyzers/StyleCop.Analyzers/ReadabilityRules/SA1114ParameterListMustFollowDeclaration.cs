...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// <summary>
        /// The start of the parameter list for a method or indexer call or declaration does not
        /// begin on the same line as the opening bracket, or on the line after the opening bracket.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when there are one or more blank lines between the
        /// opening bracket and the start of the parameter list. For example:</para> <code
        /// language="csharp"> public string JoinName(
        ///
        ///     string first, string last)
        /// {
        /// }
        /// </code>
        /// <para>The parameter list should begin on the same line as the opening bracket, or on the
        /// next line. For example:</para> <code language="csharp"> public string JoinName(string
        /// first, string last)
        /// {
        /// }
        ///
        ...
        internal class SA1114ParameterListMustFollowDeclaration : DiagnosticAnalyzer {
                ...
                private static void AnalyzeAttributeList(
                    SyntaxNodeAnalysisContext context, AttributeListSyntax attributesList)
                {
                ...
                private static void AnalyzeArgumentList(
                    SyntaxNodeAnalysisContext context, ArgumentListSyntax argumentListSyntax)
                {
