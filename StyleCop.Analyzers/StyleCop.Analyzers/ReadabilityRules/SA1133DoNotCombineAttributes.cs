...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        internal class SA1133DoNotCombineAttributes : DiagnosticAnalyzer
        {
                ...
                /// cref="SA1133DoNotCombineAttributes"/> analyzer.
                /// </summary>
                ...
                private static readonly LocalizableString Title = new LocalizableResourceString (
                    nameof (ReadabilityResources.SA1133Title), ReadabilityResources.ResourceManager,
                    typeof (ReadabilityResources));
                private static readonly LocalizableString MessageFormat
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1133MessageFormat),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1133Description),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                        ...
                        if (attributeList.Attributes.Count > 1)
                                {
                                        context.ReportDiagnostic (Diagnostic.Create (
                                            Descriptor,
                                            attributeList.Attributes[1].Name.GetLocation ()));
                                }
                }
        }
}
