...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// declaration of a method or indexer, is not placed on the same line as the opening
        /// bracket when the element does not take any parameters.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when a method or indexer does not take any
        /// parameters and the closing bracket of a call or declaration for the method or indexer is
        /// not placed on the same line as the opening bracket. The following example shows correct
        /// placement of the closing parenthesis:</para> <code language="csharp"> public string
        /// GetName()
        /// {
        ...
        internal class SA1112ClosingParenthesisMustBeOnLineOfOpeningParenthesis : DiagnosticAnalyzer
        {
                ...
                private static readonly LocalizableString Description
                    = new LocalizableResourceString (
                        nameof (ReadabilityResources.SA1112Description),
                        ReadabilityResources.ResourceManager, typeof (ReadabilityResources));
                ...
                private static void
                HandleParameterList (SyntaxNodeAnalysisContext context,
