...
namespace StyleCop.Analyzers.ReadabilityRules
{
        ...
        /// <summary>
        /// The code uses one of the basic C# types, but does not use the built-in alias for the
        /// type.
        /// </summary>
        /// <remarks>
        /// <para>A violation of this rule occurs when one of the following types are used anywhere
        /// in the code: <c>Boolean</c>, <c>Byte</c>, <c>Char</c>, <c>Decimal</c>, <c>Double</c>,
        /// <c>Int16</c>, <c>Int32</c>, <c>Int64</c>, <c>Object</c>, <c>SByte</c>, <c>Single</c>,
        /// <c>String</c>, <c>UInt16</c>, <c>UInt32</c>, <c>UInt64</c>.</para>
        ///
        /// <para>A violation also occurs when any of these types are represented in the code using
        /// the full namespace for the type: <c>System.Boolean</c>, <c>System.Byte</c>,
        /// <c>System.Char</c>, <c>System.Decimal</c>, <c>System.Double</c>, <c>System.Int16</c>,
        /// <c>System.Int32</c>, <c>System.Int64</c>, <c>System.Object</c>, <c>System.SByte</c>,
        /// <c>System.Single</c>, <c>System.String</c>, <c>System.UInt16</c>, <c>System.UInt32</c>,
        /// <c>System.UInt64</c>.</para>
        ///
        /// <para>Rather than using the type name or the fully-qualified type name, the built-in
        /// aliases for these types should always be used: <c>bool</c>, <c>byte</c>, <c>char</c>,
        /// <c>decimal</c>, <c>double</c>, <c>short</c>, <c>int</c>, <c>long</c>, <c>object</c>,
        /// <c>sbyte</c>, <c> float</c>, <c>string</c>, <c>ushort</c>, <c>uint</c>,
        /// <c>ulong</c>.</para>
        ///
        ...
        internal class SA1121UseBuiltInTypeAlias : DiagnosticAnalyzer {
                ...
                private static void HandleCompilationStart(CompilationStartAnalysisContext context)
                {
                        ...
                        context.RegisterSyntaxNodeAction(
                            analyzer.HandleIdentifierNameSyntax, SyntaxKind.IdentifierName);
                }
                ...
                private sealed class Analyzer {
                            ...
                            SyntaxNodeAnalysisContext context, StyleCopSettings settings)
                        {
                                ...
                                if (identifierNameSyntax.FirstAncestorOrSelf<UsingDirectiveSyntax>()
                                        != null
                                ...
                                // We go straight to the symbol here. We don't need to check alias
                                // information because aliases will fall into one of two categories:
                                //
                                // 1. The alias to a built-in type matches the name of a built-in
                                // type (e.g. using Int32 = Int32;). In
                                //    this case, a diagnostic is reported even if
                                //    allowBuiltInTypeAliases=true.
                                // 2. The alias to a built-in type is a different name. In this
                                // case, if allowBuiltInTypeAliases is true
                                //    then the above code would have already returned due to the
                                //    renamed symbol not being in the set of strings checked by the
                                //    analyzer above.
                                INamedTypeSymbol symbol = semanticModel
