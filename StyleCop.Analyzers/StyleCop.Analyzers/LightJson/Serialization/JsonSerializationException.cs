...
namespace LightJson.Serialization {
        ...
        internal sealed class JsonSerializationException : Exception {
                ...
                public enum ErrorType {
                        ...
                        /// <summary>
                        /// Indicates that the writer encountered an invalid number value (NAN,
                        /// infinity) during serialization.
                        /// </summary>
                        InvalidNumber,

                        /// <summary>
                        /// Indicates that the object been serialized contains an invalid JSON value
                        /// type. That is, a value type that is not null, boolean, number, string,
                        /// object, or array.
                        /// </summary>
                        InvalidValueType,
