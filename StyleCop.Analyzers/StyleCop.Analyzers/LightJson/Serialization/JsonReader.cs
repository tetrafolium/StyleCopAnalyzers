...
namespace LightJson.Serialization
{
        ...
        internal sealed class JsonReader
        {
                ...
                Parse (string source)
                {
                        ...
                        using (var reader = new StringReader (source)) { return Parse (reader); }
                }
                ...
                private void
                ReadDigits (StringBuilder builder)
                {
                        while (true)
                                {
                ...
                private JsonObject
                ReadObject (JsonObject jsonObject)
                {
                        this.scanner.Assert ('{');
