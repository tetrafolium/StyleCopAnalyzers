...
namespace LightJson.Serialization
{
        ...
        internal sealed class JsonWriter : IDisposable {
                ...
                /// <summary>
                /// A set of containing all the collection objects (JsonObject/JsonArray) being
                ...
                /// <summary>
                /// Gets or sets a value indicating whether JsonObject properties should be written
                /// in a deterministic order.
                /// </summary>
                /// <value>
                /// A value indicating whether JsonObject properties should be written in a
                /// deterministic order.
                /// </value>
                ...
                {
                        if (this.SortObjects) {
                                var sortedDictionary = new SortedDictionary<string, JsonValue>(
