...
namespace StyleCop.Analyzers
{
        ...
        internal static class AnalyzerExtensions {
                /// <summary>
                /// Register an action to be executed at completion of parsing of a code document. A
                /// syntax tree action reports diagnostics about the <see cref="SyntaxTree"/> of a
                /// document.
                /// </summary>
                /// <param name="context">The analysis context.</param>
                /// <param name="action">Action to be executed at completion of parsing of a
                /// document.</param>
                public static void RegisterSyntaxTreeAction(this AnalysisContext context,
                ...
                /// <summary>
                /// Register an action to be executed at completion of semantic analysis of a <see
                /// cref="SyntaxNode"/> with an appropriate kind. A syntax node action can report
                /// diagnostics about a <see cref="SyntaxNode"/>, and can also collect state
                /// information to be used by other syntax node actions or code block end actions.
                /// </summary>
                /// <param name="context">The analysis context.</param>
                /// <param name="action">Action to be executed at completion of semantic analysis of
                /// a <see cref="SyntaxNode"/>.</param> <param name="syntaxKind">The kind of syntax
                ...
                /// <param name="context">The analysis context.</param>
                /// <param name="action">Action to be executed at completion of semantic analysis of
                /// a <see cref="SyntaxNode"/>.</param> <param name="syntaxKinds">The kinds of
                ...
                public static void RegisterSyntaxNodeAction<TLanguageKindEnum>(
                    this AnalysisContext context,
                    Action<SyntaxNodeAnalysisContext, StyleCopSettings> action,
                    ImmutableArray<TLanguageKindEnum> syntaxKinds) where TLanguageKindEnum
                    : struct {
                ...
                private static class LanguageKindArrays<TLanguageKindEnum> where TLanguageKindEnum
                    : struct {
                        private static readonly ConcurrentDictionary<TLanguageKindEnum,
                            ImmutableArray<TLanguageKindEnum>> Arrays
                            = new ConcurrentDictionary<TLanguageKindEnum,
                                ImmutableArray<TLanguageKindEnum>>();

                        private static readonly Func<TLanguageKindEnum,
                            ImmutableArray<TLanguageKindEnum>> CreateValueFactory
                            = CreateValue;
