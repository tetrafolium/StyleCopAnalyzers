...
namespace StyleCop.Analyzers
{
        ...
        /// <summary>
        /// This attribute is applied to <see cref="DiagnosticAnalyzer"/>s for which no
        /// implementation is currently planned.
        /// </summary>
        /// <remarks>
        /// <para>There are several reasons an analyzer for a StyleCop diagnostic does not have an
        /// implementation, including but not limited to the following:</para> <list type="bullet">
        /// <item><description>Visual Studio provides a built-in diagnostic.</description></item>
        /// <item><description>The diagnostic is vaguely defined, so there is no clear direction for
        /// the implementation.</description></item> <item><description>The diagnostic has been
        /// superseded by a fine-grained set of new rules for customization.</description></item>
        /// </list>
