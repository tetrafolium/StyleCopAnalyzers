...
namespace StyleCop.Analyzers.Lightup
{
        ...
        internal readonly partial struct WhenClauseSyntaxWrapper : ISyntaxWrapper<CSharpSyntaxNode>
        {
                ...
                static WhenClauseSyntaxWrapper ()
                {
                        ...
                        ConditionAccessor = LightupHelpers.CreateSyntaxPropertyAccessor<
                ...
                public WhenClauseSyntaxWrapper
                WithWhenKeyword (SyntaxToken whenKeyword)
                {
                        return new WhenClauseSyntaxWrapper (
                            WithWhenKeywordAccessor (this.SyntaxNode, whenKeyword));
                }
                ...
                {
                        return new WhenClauseSyntaxWrapper (
                            WithConditionAccessor (this.SyntaxNode, condition));
                }
        }
}
