...
namespace StyleCop.Analyzers.Lightup
{
        ...
        internal readonly partial struct CommonForEachStatementSyntaxWrapper
            : ISyntaxWrapper<StatementSyntax>
        {
                ...
                private static readonly Func<StatementSyntax, ExpressionSyntax, StatementSyntax>
                    WithExpressionAccessor;
                private static readonly Func<StatementSyntax, SyntaxToken, StatementSyntax>
                    WithCloseParenTokenAccessor;
                private static readonly Func<StatementSyntax, StatementSyntax, StatementSyntax>
                ...
                static CommonForEachStatementSyntaxWrapper ()
                {
                        ...
                        StatementAccessor
                            = LightupHelpers
                                  .CreateSyntaxPropertyAccessor<StatementSyntax, StatementSyntax> (
                        ...
                        WithCloseParenTokenAccessor
                            = LightupHelpers
                                  .CreateSyntaxWithPropertyAccessor<StatementSyntax, SyntaxToken> (
                                      WrappedType, nameof (CloseParenToken));
                        WithStatementAccessor = LightupHelpers.CreateSyntaxWithPropertyAccessor<
                            StatementSyntax, StatementSyntax> (WrappedType, nameof (Statement));
                }
                ...
                {
                        get { return AwaitKeywordAccessor (this.SyntaxNode); }
                }

                public SyntaxToken ForEachKeyword
                {
                        get { return ForEachKeywordAccessor (this.SyntaxNode); }
                }
                ...
                {
                        get { return InKeywordAccessor (this.SyntaxNode); }
                }
                ...
                {
                        get { return StatementAccessor (this.SyntaxNode); }
                }

                public static explicit
                operator CommonForEachStatementSyntaxWrapper (SyntaxNode node)
                {
                        if (node == null)
                                {
                                        return default;
                ...
                operator StatementSyntax (CommonForEachStatementSyntaxWrapper wrapper)
                {
                        return wrapper.node;
                }
                ...
                public CommonForEachStatementSyntaxWrapper
                WithAwaitKeyword (SyntaxToken awaitKeyword)
                {
                        return new CommonForEachStatementSyntaxWrapper (
                            WithAwaitKeywordAccessor (this.SyntaxNode, awaitKeyword));
                }

                public CommonForEachStatementSyntaxWrapper
                WithForEachKeyword (SyntaxToken forEachKeyword)
                {
                        return new CommonForEachStatementSyntaxWrapper (
                            WithForEachKeywordAccessor (this.SyntaxNode, forEachKeyword));
                }
                ...
                public CommonForEachStatementSyntaxWrapper
                WithInKeyword (SyntaxToken inKeyword)
                {
                        return new CommonForEachStatementSyntaxWrapper (
                            WithInKeywordAccessor (this.SyntaxNode, inKeyword));
                }
                ...
                public CommonForEachStatementSyntaxWrapper
                WithStatement (StatementSyntax statement)
                {
                        return new CommonForEachStatementSyntaxWrapper (
                            WithStatementAccessor (this.SyntaxNode, statement));
                }

                internal static CommonForEachStatementSyntaxWrapper
                FromUpcast (StatementSyntax node)
                {
