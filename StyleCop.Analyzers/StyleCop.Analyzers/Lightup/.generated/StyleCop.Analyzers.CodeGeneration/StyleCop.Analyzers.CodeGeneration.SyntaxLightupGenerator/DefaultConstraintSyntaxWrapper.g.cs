...
namespace StyleCop.Analyzers.Lightup
{
          ...
          : ISyntaxWrapper<TypeParameterConstraintSyntax>
        {
                ...
                private static readonly
                  Func<TypeParameterConstraintSyntax, SyntaxToken, TypeParameterConstraintSyntax>
                ...
                static DefaultConstraintSyntaxWrapper()
                {
                        ...
                        DefaultKeywordAccessor =
                          LightupHelpers.CreateSyntaxPropertyAccessor<TypeParameterConstraintSyntax,
                                                                      SyntaxToken>(
                            WrappedType, nameof(DefaultKeyword));
                        WithDefaultKeywordAccessor =
                          LightupHelpers
                            .CreateSyntaxWithPropertyAccessor<TypeParameterConstraintSyntax,
                                                              SyntaxToken>(WrappedType,
