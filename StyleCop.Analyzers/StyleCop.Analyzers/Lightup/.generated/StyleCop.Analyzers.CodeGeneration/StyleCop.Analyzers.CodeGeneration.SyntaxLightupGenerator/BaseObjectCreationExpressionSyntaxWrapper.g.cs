...
internal readonly partial struct BaseObjectCreationExpressionSyntaxWrapper : ISyntaxWrapper<ExpressionSyntax>
{
	...
	static BaseObjectCreationExpressionSyntaxWrapper()
	{
		...
		NewKeywordAccessor = LightupHelpers.CreateSyntaxPropertyAccessor<ExpressionSyntax, SyntaxToken>(
			WrappedType, nameof(NewKeyword));
		ArgumentListAccessor = LightupHelpers.CreateSyntaxPropertyAccessor<ExpressionSyntax, ArgumentListSyntax>(
		...
		WithNewKeywordAccessor = LightupHelpers.CreateSyntaxWithPropertyAccessor<ExpressionSyntax, SyntaxToken>(
			WrappedType, nameof(NewKeyword));
		WithArgumentListAccessor =
			LightupHelpers.CreateSyntaxWithPropertyAccessor<ExpressionSyntax, ArgumentListSyntax>(
				WrappedType, nameof(ArgumentList));
		WithInitializerAccessor =
