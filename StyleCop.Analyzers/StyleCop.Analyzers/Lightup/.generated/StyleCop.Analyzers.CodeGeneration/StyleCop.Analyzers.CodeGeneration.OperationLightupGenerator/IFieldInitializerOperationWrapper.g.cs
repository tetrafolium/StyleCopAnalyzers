...
namespace StyleCop.Analyzers.Lightup {
        ...
        internal readonly struct IFieldInitializerOperationWrapper : IOperationWrapper {
                ...
                private static readonly Func<IOperation, ImmutableArray<IFieldSymbol>>
                    InitializedFieldsAccessor;
                private readonly IOperation operation;
                static IFieldInitializerOperationWrapper() {
                        WrappedType = OperationWrapperHelper.GetWrappedType(
                            typeof(IFieldInitializerOperationWrapper));
                        InitializedFieldsAccessor = LightupHelpers.CreateOperationPropertyAccessor<
                            IOperation, ImmutableArray<IFieldSymbol>>(WrappedType,
                                                                      nameof(InitializedFields));
                }
                ...
                public ImmutableArray<IFieldSymbol> InitializedFields =>
                    InitializedFieldsAccessor(this.WrappedOperation);
                ...
                public static explicit operator IFieldInitializerOperationWrapper(
                ...
                public static implicit operator ISymbolInitializerOperationWrapper(
                    IFieldInitializerOperationWrapper wrapper) =>
                    ISymbolInitializerOperationWrapper.FromUpcast(wrapper.WrappedOperation);
                public static IFieldInitializerOperationWrapper FromOperation(
