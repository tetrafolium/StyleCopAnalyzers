...
namespace StyleCop.Analyzers.Lightup
{
    ...
    internal readonly struct IDiscardPatternOperationWrapper : IOperationWrapper
    {
        ...
        public static explicit operator IDiscardPatternOperationWrapper(IPatternOperationWrapper wrapper) =>
            FromOperation(wrapper.WrappedOperation);
        public static implicit operator IPatternOperationWrapper(IDiscardPatternOperationWrapper wrapper) =>
