...
namespace StyleCop.Analyzers.Lightup
{
        ...
        internal readonly struct IForToLoopOperationWrapper : IOperationWrapper
        {
                ...
                {
                        WrappedType =
                          OperationWrapperHelper.GetWrappedType(typeof(IForToLoopOperationWrapper));
                        ...
                        InitialValueAccessor =
                          LightupHelpers.CreateOperationPropertyAccessor<IOperation, IOperation>(
                            WrappedType, nameof(InitialValue));
                        LimitValueAccessor =
                          LightupHelpers.CreateOperationPropertyAccessor<IOperation, IOperation>(
                            WrappedType, nameof(LimitValue));
                        StepValueAccessor =
                          LightupHelpers.CreateOperationPropertyAccessor<IOperation, IOperation>(
                            WrappedType, nameof(StepValue));
                        IsCheckedAccessor =
                ...
                public static explicit operator IForToLoopOperationWrapper(
                ...
                public static implicit operator ILoopOperationWrapper(
                  IForToLoopOperationWrapper wrapper) =>
