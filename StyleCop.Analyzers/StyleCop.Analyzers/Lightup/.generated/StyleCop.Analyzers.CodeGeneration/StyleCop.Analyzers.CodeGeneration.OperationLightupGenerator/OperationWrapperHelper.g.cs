...
namespace StyleCop.Analyzers.Lightup
{
        ...
        internal static class OperationWrapperHelper
        {
                ...
                static OperationWrapperHelper ()
                {
                        ...
                        builder.Add (typeof (IPatternOperationWrapper),
                                     codeAnalysisAssembly.GetType (
                                         IPatternOperationWrapper.WrappedTypeName));
                        builder.Add (typeof (IMethodBodyBaseOperationWrapper),
                                     codeAnalysisAssembly.GetType (
                                         IMethodBodyBaseOperationWrapper.WrappedTypeName));
                        builder.Add (typeof (IInvalidOperationWrapper),
                                     codeAnalysisAssembly.GetType (
                                         IInvalidOperationWrapper.WrappedTypeName));
                        builder.Add (
                        ...
                        builder.Add (typeof (IForLoopOperationWrapper),
                                     codeAnalysisAssembly.GetType (
                                         IForLoopOperationWrapper.WrappedTypeName));
                        ...
                        builder.Add (typeof (ILabeledOperationWrapper),
                                     codeAnalysisAssembly.GetType (
                                         ILabeledOperationWrapper.WrappedTypeName));
                        builder.Add (
                        ...
                        builder.Add (typeof (ILiteralOperationWrapper),
                                     codeAnalysisAssembly.GetType (
                                         ILiteralOperationWrapper.WrappedTypeName));
                        ...
                        builder.Add (typeof (IDiscardOperationWrapper),
                                     codeAnalysisAssembly.GetType (
                                         IDiscardOperationWrapper.WrappedTypeName));
