        ...
        internal readonly struct IMethodBodyBaseOperationWrapper : IOperationWrapper
        {
                ...
                static IMethodBodyBaseOperationWrapper ()
                {
                        WrappedType = OperationWrapperHelper.GetWrappedType (
                            typeof (IMethodBodyBaseOperationWrapper));
                        BlockBodyAccessor
                            = LightupHelpers
                                  .CreateOperationPropertyAccessor<IOperation, IOperation> (
                                      WrappedType, nameof (BlockBody));
                ...
                public IBlockOperationWrapper BlockBody => IBlockOperationWrapper.FromOperation (
                    BlockBodyAccessor (this.WrappedOperation));
                public IBlockOperationWrapper
                    ExpressionBody => IBlockOperationWrapper.FromOperation (
                        ExpressionBodyAccessor (this.WrappedOperation));
                public static IMethodBodyBaseOperationWrapper
                ...
                internal static IMethodBodyBaseOperationWrapper
