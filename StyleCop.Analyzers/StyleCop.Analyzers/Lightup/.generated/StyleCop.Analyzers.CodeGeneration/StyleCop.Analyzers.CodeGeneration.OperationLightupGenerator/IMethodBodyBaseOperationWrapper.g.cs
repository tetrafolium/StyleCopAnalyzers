...
namespace StyleCop.Analyzers.Lightup
{
    ...
    internal readonly struct IMethodBodyBaseOperationWrapper : IOperationWrapper
    {
        ...
        static IMethodBodyBaseOperationWrapper()
        {
            ...
            BlockBodyAccessor =
                LightupHelpers.CreateOperationPropertyAccessor<IOperation, IOperation>(WrappedType, nameof(BlockBody));
            ExpressionBodyAccessor = LightupHelpers.CreateOperationPropertyAccessor<IOperation, IOperation>(
        ...
        public IBlockOperationWrapper BlockBody =>
            IBlockOperationWrapper.FromOperation(BlockBodyAccessor(this.WrappedOperation));
        public IBlockOperationWrapper ExpressionBody =>
            IBlockOperationWrapper.FromOperation(ExpressionBodyAccessor(this.WrappedOperation));
