...
internal readonly struct ITryOperationWrapper : IOperationWrapper
{
	...
	static ITryOperationWrapper()
	{
		...
		CatchesAccessor =
			LightupHelpers.CreateOperationListPropertyAccessor<IOperation>(WrappedType, nameof(Catches));
		FinallyAccessor =
			LightupHelpers.CreateOperationPropertyAccessor<IOperation, IOperation>(WrappedType, nameof(Finally));
