...
namespace StyleCop.Analyzers.Lightup
{
        ...
        internal readonly struct ISwitchCaseOperationWrapper : IOperationWrapper
        {
                ...
                static ISwitchCaseOperationWrapper ()
                {
                        ...
                        BodyAccessor = LightupHelpers.CreateOperationPropertyAccessor<
                            IOperation, ImmutableArray<IOperation> > (WrappedType, nameof (Body));
                ...
                public ImmutableArray<IOperation> Clauses => ClausesAccessor (
                ...
                public ImmutableArray<ILocalSymbol> Locals => LocalsAccessor (
                    this.WrappedOperation);
                public static ISwitchCaseOperationWrapper
