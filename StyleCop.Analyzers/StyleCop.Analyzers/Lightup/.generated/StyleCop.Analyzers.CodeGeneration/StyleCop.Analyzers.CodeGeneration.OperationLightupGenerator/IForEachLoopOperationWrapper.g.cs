...
internal readonly struct IForEachLoopOperationWrapper : IOperationWrapper
{
	...
	static IForEachLoopOperationWrapper()
	{
		...
		CollectionAccessor =
			LightupHelpers.CreateOperationPropertyAccessor<IOperation, IOperation>(WrappedType, nameof(Collection));
		...
		IsAsynchronousAccessor =
			LightupHelpers.CreateOperationPropertyAccessor<IOperation, bool>(WrappedType, nameof(IsAsynchronous));
	}
	...
	public static explicit operator IForEachLoopOperationWrapper(ILoopOperationWrapper wrapper) =>
	FromOperation(wrapper.WrappedOperation);
	public static implicit operator ILoopOperationWrapper(IForEachLoopOperationWrapper wrapper) =>
