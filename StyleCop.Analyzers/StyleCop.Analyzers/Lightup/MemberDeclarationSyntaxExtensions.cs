...
namespace StyleCop.Analyzers.Lightup
{
        ...
        internal static class MemberDeclarationSyntaxExtensions
        {
                ...
                private static readonly
                  Func<MemberDeclarationSyntax, SyntaxTokenList, MemberDeclarationSyntax>
                ...
                static MemberDeclarationSyntaxExtensions()
                {
                        AttributeListsAccessor =
                          LightupHelpers
                            .CreateSyntaxPropertyAccessor<MemberDeclarationSyntax,
                                                          SyntaxList<AttributeListSyntax>>(
                              typeof(MemberDeclarationSyntax), nameof(AttributeLists));
                        ModifiersAccessor =
                          LightupHelpers
                            .CreateSyntaxPropertyAccessor<MemberDeclarationSyntax, SyntaxTokenList>(
                              typeof(MemberDeclarationSyntax), nameof(Modifiers));
                        WithAttributeListsAccessor =
                          LightupHelpers
                            .CreateSyntaxWithPropertyAccessor<MemberDeclarationSyntax,
                                                              SyntaxList<AttributeListSyntax>>(
                              typeof(MemberDeclarationSyntax), nameof(AttributeLists));
                        WithModifiersAccessor =
