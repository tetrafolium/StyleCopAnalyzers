...
namespace StyleCop.Analyzers.Lightup
{
            ...
            : IEquatable<SeparatedSyntaxListWrapper<TNode> >, IReadOnlyList<TNode>
        {
                ...
                public abstract int SeparatorCount { get; }
                ...
                public static bool
                operator == (SeparatedSyntaxListWrapper<TNode> left,
                ...
                //   node:
                //     The node to add.
                public SeparatedSyntaxListWrapper<TNode>
                Add (TNode node) => this.Insert (this.Count, node);
                ...
                //     The nodes to add.
                public SeparatedSyntaxListWrapper<TNode>
                AddRange (IEnumerable<TNode> nodes) => this.InsertRange (this.Count, nodes);
                ...
                public bool
                Equals (SeparatedSyntaxListWrapper<TNode> other)
                {
                        throw new NotImplementedException ();
                }
                ...
                public abstract SeparatedSyntaxListWrapper<TNode>
                InsertRange (int index, IEnumerable<TNode> nodes);
                ...
                public abstract SeparatedSyntaxListWrapper<TNode>
                ReplaceRange (TNode nodeInList, IEnumerable<TNode> newNodes);

                public abstract SeparatedSyntaxListWrapper<TNode>
                ReplaceSeparator (SyntaxToken separatorToken, SyntaxToken newSeparator);
                    ...
                    : SeparatedSyntaxListWrapper<TNode> where TSyntax : SyntaxNode
                {
                        ...
                        First () => SyntaxWrapper.Wrap (this.syntaxList.First ());

                        public override TNode
                        FirstOrDefault () => SyntaxWrapper.Wrap (this.syntaxList.FirstOrDefault ());

                        public override int GetHashCode () => this.syntaxList.GetHashCode ();

                        public override SyntaxToken
                        GetSeparator (int index) => this.syntaxList.GetSeparator (index);
                        ...
                        public override TNode
                        Last () => SyntaxWrapper.Wrap (this.syntaxList.Last ());

                        public override int
                        LastIndexOf (TNode node) => this.syntaxList.LastIndexOf (
                            (TSyntax) SyntaxWrapper.Unwrap (node));
                        ...
                        public override TNode
                        LastOrDefault () => SyntaxWrapper.Wrap (this.syntaxList.LastOrDefault ());
                        ...
                        ReplaceRange (TNode nodeInList, IEnumerable<TNode> newNodes) => new AutoWrapSeparatedSyntaxList<
                            TSyntax> (this.syntaxList.ReplaceRange (
                        ...
                        ReplaceSeparator (SyntaxToken separatorToken, SyntaxToken newSeparator) => new AutoWrapSeparatedSyntaxList<
                            TSyntax> (this.syntaxList.ReplaceSeparator (separatorToken,
                                                                        newSeparator));
                ...
                private sealed class UnsupportedSyntaxList : SeparatedSyntaxListWrapper<TNode>
                {
                        ...
                        public override SyntaxToken
                        GetSeparator (int index) => SyntaxList.GetSeparator (index);
                        ...
                        public override int
                        IndexOf (TNode node) => SyntaxList.IndexOf (SyntaxWrapper.Unwrap (node));
                        ...
                        public override SeparatedSyntaxListWrapper<TNode>
                        Replace (TNode nodeInList, TNode newNode)
                        {
                                throw new NotSupportedException ();
                        }
