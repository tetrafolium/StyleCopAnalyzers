        ...
        internal sealed class SyntaxLightupGenerator : ISourceGenerator
        {
                                                   ...
                                                   NodeData nodeData)
                {
                          ...
                          : SyntaxFactory.VariableDeclaration(
                            ...
                            : SyntaxFactory.SingletonSeparatedList(SyntaxFactory.VariableDeclarator(
                              ...
                              : SyntaxFactory.EqualsValueClause(SyntaxFactory.LiteralExpression(
                                ...
                                SyntaxFactory.Literal("Microsoft.CodeAnalysis.CSharp.Syntax." +
                                                      nodeData.Name))))))));
                                  ...
                                  SyntaxFactory.FieldDeclaration(
                                    ...
                                    : SyntaxFactory.VariableDeclaration(
                                      ...
                                      : SyntaxFactory.GenericName(
                                        ...
                                        variables
                                      : SyntaxFactory.SingletonSeparatedList(
                                        SyntaxFactory.VariableDeclarator(field.AccessorName))));
                        ...
                        foreach (var field in nodeData.Fields) {
                                ...
                                // private static readonly Func<CSharpSyntaxNode, T,
                                // CSharpSyntaxNode> WithFieldAccessor;
                                members = members.Add(SyntaxFactory.FieldDeclaration(
                                  attributeLists
                                  : default, modifiers
                                  : SyntaxFactory.TokenList(
                          ...
                          members.Add(SyntaxFactory
                                        .FieldDeclaration(
                                          ...
                                          : SyntaxFactory.VariableDeclaration(
                                            ...
                                            : SyntaxFactory.SingletonSeparatedList(
                                              SyntaxFactory.VariableDeclarator("node"))))
                          ...
                          SyntaxFactory.ExpressionStatement(SyntaxFactory.AssignmentExpression(
                            ...
                            : SyntaxFactory.InvocationExpression(
                              ...
                              : SyntaxFactory.MemberAccessExpression(
                                  ...
                                  : SyntaxFactory.IdentifierName("SyntaxWrapperHelper"), name
                        ...
                        // {
                        //     WrappedType =
                        //     SyntaxWrapperHelper.GetWrappedType(typeof(SyntaxWrapper));
                        // }
                        members = members.Add(
                          SyntaxFactory
                                                    ...
                                                    : SyntaxFactory.ParenthesizedExpression(
                                                        SyntaxFactory.CastExpression(
                                                          ...
                                                          : SyntaxFactory.IdentifierName(
                                                              declaringNode
                                                                .WrapperName ?? declaringNode.Name),
                                                            expression
                        ...
                        //         '{node.GetType().FullName}' to '{WrappedTypeName}'");
                        //     }
                        //
                                                         ...
                                                         ImmutableArray<NodeData> wrapperTypes)
                {
                        ...
                        foreach (var node in wrapperTypes.OrderBy(node => node.Name,
                                ...
                                if (node.Name == nameof(CommonForEachStatementSyntax)) {
                                        ...
                                        // we fall back to using this type instead.
                                        //
                ...
                private sealed class FieldData
                {
                        ...
                        /// extension method in the lightup layer.
                        /// </summary>
