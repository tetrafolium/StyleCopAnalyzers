...
namespace StyleCop.Analyzers.CodeGeneration
{
        ...
        internal sealed class SyntaxLightupGenerator : ISourceGenerator
        {
                ...
                private void
                GenerateSyntaxWrappers (in GeneratorExecutionContext context, SyntaxData syntaxData)
                {
                ...
                private void
                GenerateSyntaxWrapper (in GeneratorExecutionContext context, SyntaxData syntaxData,
                                       NodeData nodeData)
                {
                        ...
                        foreach (var field in nodeData.Fields)
                                {
                                        ...
                                        if (field.IsOverride)
                                                {
                                                        // The 'get' accessor is skipped for
                                                        // override fields
                                                        continue;
                                                }
                                        ...
                                        if (first)
                                                {
                                                        fieldAccessor
                                                            = fieldAccessor.WithLeadingBlankLine ();
                                                        first = false;
                                                }
                        ...
                        foreach (var field in nodeData.Fields)
                                {
                                        ...
                                        if (field.IsWrappedSeparatedSyntaxList (
                                                syntaxData, out var elementNode))
                                                {
                                                        ...
                                                        // CreateSeparatedSyntaxListPropertyAccessor<SyntaxNode,
                                                        // T>
                                                ...
                                                {
                                                        // CreateSyntaxPropertyAccessor<SyntaxNode,
                                                        // T>
                                                        helperName = SyntaxFactory.GenericName (
                                                            identifier
                                                            : SyntaxFactory.Identifier (
                        ...
                        foreach (var field in nodeData.Fields)
                                {
                                        ...
                                        if (field.IsWrappedSeparatedSyntaxList (
                                                ...
                                                {
                                                        // CreateSyntaxWithPropertyAccessor<SyntaxNode,
                                                        // T>
                                                        helperName = SyntaxFactory.GenericName (
                                                            identifier
                                                            : SyntaxFactory.Identifier (
                        ...
                        foreach (var field in nodeData.Fields)
                                {
                                        ...
                                        if (field.IsOverride)
                                                {
                                                        var declaringNode
                                                            = field.GetDeclaringNode (syntaxData);
                                        ...
                                        else if (syntaxData.TryGetNode (field.Type)
                                                     is {} fieldNodeType)
                                                {
                                                        // PatternAccessor(this.SyntaxNode)
                                                        returnExpression = SyntaxFactory.InvocationExpression (
                             ...
                             baseNode = syntaxData.TryGetNode (baseNode.BaseName))
                                {
                                        ...
                                        // SyntaxWrapper(BaseSyntaxWrapper node)
                                        // {
                             ...
                             baseNode = syntaxData.TryGetNode (baseNode.BaseName))
                                {
                                        ...
                                        // BaseSyntaxWrapper(SyntaxWrapper wrapper)
                                        // {
                        ...
                        if (nodeData.Kind == NodeKind.Abstract)
                                {
                                        // internal static SyntaxWrapper FromUpcast(CSharpSyntaxNode
                                        // node)
                                        // {
                ...
                private void
                GenerateSyntaxWrapperHelper (in GeneratorExecutionContext context,
                        ...
                        foreach (var node in wrapperTypes.OrderBy (node => node.Name,
                                                                  StringComparer.OrdinalIgnoreCase))
                                {
                                        ...
                                        if (node.Name == nameof (CommonForEachStatementSyntax))
                                                {
                                                        // Prior to C# 7, ForEachStatementSyntax was
                                                        // the base type for all foreach statements.
                                                        // If the CommonForEachStatementSyntax type
                                                        // isn't found at runtime, we fall back to
                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                          SyntaxFactory
                                                                                                                                                                                                                              .Argument (SyntaxFactory
                                                                                                                                                                                                                                             .MemberAccessExpression (
                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                 expression
                                                                                                                                                                                                                                                 : SyntaxFactory
                                                                                                                                                                                                                                                       .IdentifierName (node.WrapperName),
                                                                                                                                                                                                                                                   name
                                                                                                                                                                                                                                                 : SyntaxFactory
                                                                                                                                                                                                                                                       .IdentifierName ("WrappedTypeName")))))),
                                                                                                                                                                             right
                                                                                                                                                                           : SyntaxFactory
                                                                                                                                                                                 .InvocationExpression (expression
                                                                                                                                                                                                        : SyntaxFactory
                                        ...
                                        if (first)
                                                {
                                                        statement
                                                            = statement.WithLeadingBlankLine ();
                                                        first = false;
                                                }
                ...
                private sealed class SyntaxData
                {
                        ...
                        public SyntaxData (in GeneratorExecutionContext context, XDocument document)
                        {
                                ...
                                foreach (var element in document
                                        ...
                                        {
                                                nodesBuilder.Add (
                                                    new NodeData (in context, element));
                                        }
                        ...
                        public NodeData?
                        TryGetConcreteType (NodeData? node)
                        {
                ...
                private sealed class FieldData
                {
                        ...
                        public NodeData
                        GetDeclaringNode (SyntaxData syntaxData)
                        {
                        ...
                        public bool
                        IsWrappedSeparatedSyntaxList (SyntaxData syntaxData,
                                                      [ NotNullWhen (true) ] out NodeData? element)
                        {
                        ...
                        public string
                        GetAccessorResultType (SyntaxData syntaxData)
                        {
                        ...
                        public string?
                        GetAccessorResultElementType (SyntaxData syntaxData)
                        {
                                if (this.IsWrappedSeparatedSyntaxList (syntaxData,
                                                                       out var elementTypeNode))
                                        {
