...
namespace StyleCop.Analyzers.CodeGeneration
{
    ...
    internal sealed class OperationLightupGenerator : ISourceGenerator
    {
        ...
        {
            var operationInterfacesFile =
                context.AdditionalFiles.Single(x => Path.GetFileName(x.Path) == "OperationInterfaces.xml");
        ...
        private void GenerateOperationInterface(in GeneratorExecutionContext context, InterfaceData node)
        {
            ...
            members = members.Add(SyntaxFactory.FieldDeclaration(
                ...
                : SyntaxFactory.VariableDeclaration(
                    type
                    : SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.StringKeyword)), variables
                    : SyntaxFactory.SingletonSeparatedList(SyntaxFactory.VariableDeclarator(
                        identifier
                        : SyntaxFactory.Identifier("WrappedTypeName"), argumentList
                        : null, initializer
                        : SyntaxFactory.EqualsValueClause(SyntaxFactory.LiteralExpression(
                            SyntaxKind.StringLiteralExpression,
                            SyntaxFactory.Literal("Microsoft.CodeAnalysis.Operations." + node.InterfaceName))))))));
            ...
            members = members.Add(SyntaxFactory.FieldDeclaration(
                ...
                : SyntaxFactory.VariableDeclaration(
                    ...
                    : SyntaxFactory.SingletonSeparatedList(SyntaxFactory.VariableDeclarator("WrappedType")))));
                ...
                members = members.Add(SyntaxFactory.FieldDeclaration(
                    ...
                    : SyntaxFactory.VariableDeclaration(
                        ...
                        : SyntaxFactory.GenericName(identifier
                                                    : SyntaxFactory.Identifier("Func"), typeArgumentList
                        ...
                        : SyntaxFactory.SingletonSeparatedList(
                            SyntaxFactory.VariableDeclarator(property.AccessorName)))));
            }
            ...
            members = members.Add(SyntaxFactory.FieldDeclaration(
                ...
                : SyntaxFactory.VariableDeclaration(
                    type
                    : SyntaxFactory.IdentifierName("IOperation"), variables
                    : SyntaxFactory.SingletonSeparatedList(SyntaxFactory.VariableDeclarator("operation")))));
            ...
            var staticCtorStatements = SyntaxFactory.SingletonList<StatementSyntax>(
                SyntaxFactory.ExpressionStatement(SyntaxFactory.AssignmentExpression(
                    ...
                    : SyntaxFactory.IdentifierName("WrappedType"), right
                    : SyntaxFactory.InvocationExpression(
                        expression
                        : SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression
                                                               : SyntaxFactory.IdentifierName("OperationWrapperHelper"),
                                                                 name
            ...
            foreach (var property in node.Properties)
            {
                ...
                if (property.IsDerivedOperationArray)
                {
                    ...
                    helperName = SyntaxFactory.GenericName(
                        identifier
                        : SyntaxFactory.Identifier("CreateOperationListPropertyAccessor"), typeArgumentList
                ...
                else
                {
                    ...
                    helperName = SyntaxFactory.GenericName(
                        identifier
                        : SyntaxFactory.Identifier("CreateOperationPropertyAccessor"), typeArgumentList
                        : SyntaxFactory.TypeArgumentList(SyntaxFactory.SeparatedList(new[]{
                            SyntaxFactory.IdentifierName("IOperation"),
                            property.AccessorResultType,
                        })));
                ...
                // ConstructorAccessor = LightupHelpers.CreateOperationPropertyAccessor<IOperation,
                // IMethodSymbol>(WrappedType, nameof(Constructor));
                staticCtorStatements =
                    staticCtorStatements.Add(SyntaxFactory.ExpressionStatement(SyntaxFactory.AssignmentExpression(
                        SyntaxKind.SimpleAssignmentExpression, left
                        : SyntaxFactory.IdentifierName(property.AccessorName), right
                        : SyntaxFactory.InvocationExpression(
                            expression
                            : SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression
                            ...
                            : SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList(new[]{
                                ...
                                SyntaxFactory.Argument(SyntaxFactory.InvocationExpression(
                                    expression
                                    : SyntaxFactory.IdentifierName("nameof"), argumentList
            ...
            members = members.Add(SyntaxFactory.ConstructorDeclaration(
                attributeLists
                : default, modifiers
                : SyntaxFactory.TokenList(SyntaxFactory.Token(SyntaxKind.StaticKeyword)), identifier
                : SyntaxFactory.Identifier(node.WrapperName), parameterList
            ...
            members = members.Add(SyntaxFactory.ConstructorDeclaration(
                attributeLists
                : default, modifiers
                : SyntaxFactory.TokenList(SyntaxFactory.Token(SyntaxKind.PrivateKeyword)), identifier
                : SyntaxFactory.Identifier(node.WrapperName), parameterList
                : SyntaxFactory.ParameterList(SyntaxFactory.SingletonSeparatedList(
                      SyntaxFactory.Parameter(attributeLists
                                              : default, modifiers
                                              : default, type
                                              : SyntaxFactory.IdentifierName("IOperation"), identifier
                                              : SyntaxFactory.Identifier("operation"), @default
                                              : null))),
                  initializer
                : null, body
            ...
            members = members.Add(SyntaxFactory.PropertyDeclaration(
                attributeLists
                : default, modifiers
                : SyntaxFactory.TokenList(SyntaxFactory.Token(SyntaxKind.PublicKeyword)), type
                : SyntaxFactory.IdentifierName("IOperation"), explicitInterfaceSpecifier
                : null, identifier
                : SyntaxFactory.Identifier("WrappedOperation"), accessorList
                : null, expressionBody
            ...
            members = members.Add(SyntaxFactory.PropertyDeclaration(
                ...
                : default, modifiers
                : SyntaxFactory.TokenList(SyntaxFactory.Token(SyntaxKind.PublicKeyword)), type
                : SyntaxFactory.IdentifierName("ITypeSymbol"), explicitInterfaceSpecifier
                : null, identifier
                : SyntaxFactory.Identifier("Type"), accessorList
                : null, expressionBody
                : SyntaxFactory.ArrowExpressionClause(SyntaxFactory.MemberAccessExpression(
                      SyntaxKind.SimpleMemberAccessExpression, expression
                      : SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression
                                                             : SyntaxFactory.ThisExpression(), name
                                                             : SyntaxFactory.IdentifierName("WrappedOperation")),
                        name
            ...
            foreach (var property in node.Properties)
            {
                if (property.IsSkipped)
                {
                    ...
                    {
                        // public object Constructor => throw new NotImplementedException("Property 'Type.Property' has
                        ...
                        members = members.Add(SyntaxFactory.PropertyDeclaration(
                            ...
                            : null, identifier
                            : SyntaxFactory.Identifier(property.Name), accessorList
                            : null, expressionBody
                            : SyntaxFactory.ArrowExpressionClause(
                                  SyntaxFactory.ThrowExpression(SyntaxFactory.ObjectCreationExpression(
                                      type
                                      : SyntaxFactory.IdentifierName(nameof(NotImplementedException)), argumentList
                                      : SyntaxFactory.ArgumentList(SyntaxFactory.SingletonSeparatedList(
                                            SyntaxFactory.Argument(SyntaxFactory.LiteralExpression(
                                                SyntaxKind.StringLiteralExpression,
                                                SyntaxFactory.Literal(
                                                    $"Property '{node.InterfaceName}.{property.Name}' has unsupported type '{property.Type}'"))))),
                                        initializer
                                      : null))),
                              initializer
                            : null, semicolonToken
                ...
                var propertyType =
                    property.NeedsWrapper ? SyntaxFactory.IdentifierName(property.Type + "Wrapper")
                    : property.AccessorResultType;

                // ConstructorAccessor(this.WrappedOperation)
                var evaluatedAccessor = SyntaxFactory.InvocationExpression(
                    expression
                    : SyntaxFactory.IdentifierName(property.AccessorName), argumentList
                    : SyntaxFactory.ArgumentList(SyntaxFactory.SingletonSeparatedList(SyntaxFactory.Argument(
                        expression
                        : SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression
                                                               : SyntaxFactory.ThisExpression(), name
                ...
                if (property.NeedsWrapper)
                {
                    ...
                    convertedResult = SyntaxFactory.InvocationExpression(
                        ...
                        : SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression
                                                               : propertyType, name
                                                               : SyntaxFactory.IdentifierName("FromOperation")),
                          argumentList
                        : SyntaxFactory.ArgumentList(
                            SyntaxFactory.SingletonSeparatedList(SyntaxFactory.Argument(evaluatedAccessor))));
                }
                else
                {
                ...
                members = members.Add(SyntaxFactory.PropertyDeclaration(
                    ...
                    : SyntaxFactory.Identifier(property.Name), accessorList
                    : null, expressionBody
                    : SyntaxFactory.ArrowExpressionClause(convertedResult), initializer
                    : null, semicolonToken
                    : SyntaxFactory.Token(SyntaxKind.SemicolonToken)));
            }
            ...
            if (node.BaseInterface is {} baseDefinition)
            {
                ...
                {
                    if (node.Properties.Any(derivedProperty =>
                                                derivedProperty.Name == property.Name && derivedProperty.IsNew))
                    {
                        continue;
                    }
                    ...
                    members = members.Add(SyntaxFactory.PropertyDeclaration(
                        ...
                        : SyntaxFactory.ArrowExpressionClause(SyntaxFactory.MemberAccessExpression(
                              ...
                              : SyntaxFactory.ParenthesizedExpression(SyntaxFactory.CastExpression(
                                    type
                                    : SyntaxFactory.IdentifierName(baseDefinition.WrapperName), expression
                ...
                members = members.Add(SyntaxFactory.ConversionOperatorDeclaration(
                    ...
                    : SyntaxFactory.IdentifierName(node.WrapperName), parameterList
                    : SyntaxFactory.ParameterList(SyntaxFactory.SingletonSeparatedList(
                          SyntaxFactory.Parameter(attributeLists
                                                  : default, modifiers
                                                  : default, type
                                                  : SyntaxFactory.IdentifierName(baseDefinition.WrapperName), identifier
                    ...
                    : SyntaxFactory.ArrowExpressionClause(SyntaxFactory.InvocationExpression(
                          expression
                          : SyntaxFactory.IdentifierName("FromOperation"), argumentList
                          : SyntaxFactory.ArgumentList(SyntaxFactory.SingletonSeparatedList(
                ...
                // public static implicit operator IMemberReferenceOperationWrapper(IFieldReferenceOperationWrapper
                // wrapper)
                ...
                members = members.Add(SyntaxFactory.ConversionOperatorDeclaration(
                    ...
                    : SyntaxFactory.Token(SyntaxKind.OperatorKeyword), type
                    : SyntaxFactory.IdentifierName(baseDefinition.WrapperName), parameterList
                    : SyntaxFactory.ParameterList(SyntaxFactory.SingletonSeparatedList(
                          SyntaxFactory.Parameter(attributeLists
                                                  : default, modifiers
                                                  : default, type
                                                  : SyntaxFactory.IdentifierName(node.WrapperName), identifier
                                                  : SyntaxFactory.Identifier("wrapper"), @default
                                                  : null))),
                      body
                    : null, expressionBody
                    : SyntaxFactory.ArrowExpressionClause(SyntaxFactory.InvocationExpression(
                          ...
                          : SyntaxFactory.MemberAccessExpression(
                                SyntaxKind.SimpleMemberAccessExpression, expression
                                : SyntaxFactory.IdentifierName(baseDefinition.WrapperName), name
            ...
            //     {
            //         throw new InvalidCastException($"Cannot cast '{operation.GetType().FullName}' to
            //         '{WrappedTypeName}'");
            //     }
            //
            ...
            members = members.Add(SyntaxFactory.MethodDeclaration(
                ...
                : SyntaxFactory.TokenList(SyntaxFactory.Token(SyntaxKind.PublicKeyword),
                                          SyntaxFactory.Token(SyntaxKind.StaticKeyword)),
                  returnType
                : SyntaxFactory.IdentifierName(node.WrapperName), explicitInterfaceSpecifier
                : null, identifier
                : SyntaxFactory.Identifier("FromOperation"), typeParameterList
                : null, parameterList
                : SyntaxFactory.ParameterList(SyntaxFactory.SingletonSeparatedList(
                      SyntaxFactory.Parameter(attributeLists
                                              : default, modifiers
                ...
                : SyntaxFactory.Block(
                      SyntaxFactory.IfStatement(
                          condition
                          : SyntaxFactory.BinaryExpression(SyntaxKind.EqualsExpression, left
                                                           : SyntaxFactory.IdentifierName("operation"), right
                      ...
                      SyntaxFactory.IfStatement(
                          ...
                          : SyntaxFactory.PrefixUnaryExpression(
                                ...
                                : SyntaxFactory.InvocationExpression(
                                    expression
                                    : SyntaxFactory.IdentifierName("IsInstance"), argumentList
                                    : SyntaxFactory.ArgumentList(SyntaxFactory.SingletonSeparatedList(
                          ...
                          : SyntaxFactory.Block(SyntaxFactory.ThrowStatement(SyntaxFactory.ObjectCreationExpression(
                              type
                              : SyntaxFactory.IdentifierName("InvalidCastException"), argumentList
                              : SyntaxFactory.ArgumentList(SyntaxFactory.SingletonSeparatedList(
                                    SyntaxFactory.Argument(SyntaxFactory.InterpolatedStringExpression(
                                        ...
                                        SyntaxFactory.List(new InterpolatedStringContentSyntax[]{
                                            SyntaxFactory.InterpolatedStringText(
                                                SyntaxFactory.Token(leading
                                                                    : default, SyntaxKind.InterpolatedStringTextToken,
                                                                      "Cannot cast '", "Cannot cast '", trailing
                                                                    : default)),
                                            SyntaxFactory.Interpolation(SyntaxFactory.MemberAccessExpression(
                                                ...
                                                : SyntaxFactory.InvocationExpression(
                                                      ...
                                                      : SyntaxFactory.MemberAccessExpression(
                                                            SyntaxKind.SimpleMemberAccessExpression, expression
                                                            : SyntaxFactory.IdentifierName("operation"), name
                                            ...
                                            SyntaxFactory.Interpolation(
                                                SyntaxFactory.IdentifierName("WrappedTypeName")),
                                            SyntaxFactory.InterpolatedStringText(SyntaxFactory.Token(
                                                leading
                                                : default, SyntaxKind.InterpolatedStringTextToken, "'", "'", trailing
                                                : default)),
                                        }))))),
                                initializer
                              : null)))),
                      SyntaxFactory.ReturnStatement(SyntaxFactory.ObjectCreationExpression(
                          type
                          : SyntaxFactory.IdentifierName(node.WrapperName), argumentList
                          : SyntaxFactory.ArgumentList(SyntaxFactory.SingletonSeparatedList(
                                SyntaxFactory.Argument(SyntaxFactory.IdentifierName("operation")))),
                            initializer
                          : null))),
            ...
            members = members.Add(SyntaxFactory.MethodDeclaration(
                ...
                : SyntaxFactory.TokenList(SyntaxFactory.Token(SyntaxKind.PublicKeyword),
                                          SyntaxFactory.Token(SyntaxKind.StaticKeyword)),
                  returnType
                : SyntaxFactory.PredefinedType(SyntaxFactory.Token(SyntaxKind.BoolKeyword)), explicitInterfaceSpecifier
                : null, identifier
                ...
                : SyntaxFactory.ParameterList(SyntaxFactory.SingletonSeparatedList(
                  ...
                  constraintClauses
                : default, body
                : SyntaxFactory.Block(SyntaxFactory.ReturnStatement(SyntaxFactory.BinaryExpression(
                      SyntaxKind.LogicalAndExpression, left
                      : SyntaxFactory.BinaryExpression(
                            SyntaxKind.NotEqualsExpression, left
                            : SyntaxFactory.IdentifierName("operation"), right
                      ...
                      : SyntaxFactory.InvocationExpression(
                          expression
                          : SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression
                                                                 : SyntaxFactory.IdentifierName("LightupHelpers"), name
                                                                 : SyntaxFactory.IdentifierName("CanWrapOperation")),
                            argumentList
                          : SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList(new[]{
                              SyntaxFactory.Argument(SyntaxFactory.IdentifierName("operation")),
                              SyntaxFactory.Argument(SyntaxFactory.IdentifierName("WrappedType")),
            ...
            if (node.IsAbstract)
            {
                ...
                members = members.Add(SyntaxFactory.MethodDeclaration(
                    ...
                    : SyntaxFactory.ParameterList(SyntaxFactory.SingletonSeparatedList(
                      ...
                      constraintClauses
                    : default, body
                    : SyntaxFactory.Block(SyntaxFactory.ReturnStatement(SyntaxFactory.ObjectCreationExpression(
                          type
                          : SyntaxFactory.IdentifierName(node.WrapperName), argumentList
                          : SyntaxFactory.ArgumentList(SyntaxFactory.SingletonSeparatedList(
                                SyntaxFactory.Argument(SyntaxFactory.IdentifierName("operation")))),
            ...
            var wrapperStruct = SyntaxFactory.StructDeclaration(
                attributeLists
                : default, modifiers
                : SyntaxTokenList.Create(SyntaxFactory.Token(SyntaxKind.InternalKeyword))
                ...
                : SyntaxFactory.BaseList(SyntaxFactory.SingletonSeparatedList<BaseTypeSyntax>(
                      SyntaxFactory.SimpleBaseType(SyntaxFactory.IdentifierName("IOperationWrapper")))),
                  constraintClauses
                : default, members
                : members);
            var wrapperNamespace = SyntaxFactory.NamespaceDeclaration(
                name
                : SyntaxFactory.ParseName("StyleCop.Analyzers.Lightup"), externs
                : default, usings
            ...
            context.AddSource(node.WrapperName + ".g.cs",
                              SourceText.From(wrapperNamespace.ToFullString(), Encoding.UTF8));
        }

        private void GenerateOperationWrapperHelper(in GeneratorExecutionContext context,
                                                    ImmutableArray<InterfaceData> wrapperTypes)
        {
            ...
            var wrappedTypes = SyntaxFactory.FieldDeclaration(
                ...
                : SyntaxFactory.VariableDeclaration(
                    ...
                    : SyntaxFactory.GenericName(
                          identifier
                          : SyntaxFactory.Identifier("ImmutableDictionary"), typeArgumentList
                      ...
                      variables
                    : SyntaxFactory.SingletonSeparatedList(
                        SyntaxFactory.VariableDeclarator(SyntaxFactory.Identifier("WrappedTypes")))));
            ...
            var staticCtorStatements =
                SyntaxFactory.List<StatementSyntax>()
                    .Add(SyntaxFactory.LocalDeclarationStatement(SyntaxFactory.VariableDeclaration(
                        ...
                        : SyntaxFactory.SingletonSeparatedList(SyntaxFactory.VariableDeclarator(
                            identifier
                            : SyntaxFactory.Identifier("codeAnalysisAssembly"), argumentList
                            : null, initializer
                            : SyntaxFactory.EqualsValueClause(SyntaxFactory.MemberAccessExpression(
                                SyntaxKind.SimpleMemberAccessExpression, expression
                                : SyntaxFactory.InvocationExpression(SyntaxFactory.MemberAccessExpression(
                                      SyntaxKind.SimpleMemberAccessExpression, expression
                                      : SyntaxFactory.TypeOfExpression(SyntaxFactory.IdentifierName("SyntaxNode")), name
                    ...
                    .Add(SyntaxFactory.LocalDeclarationStatement(SyntaxFactory.VariableDeclaration(
                        ...
                        : SyntaxFactory.SingletonSeparatedList(SyntaxFactory.VariableDeclarator(
                            ...
                            : SyntaxFactory.EqualsValueClause(
                                SyntaxFactory.InvocationExpression(SyntaxFactory.MemberAccessExpression(
                                    SyntaxKind.SimpleMemberAccessExpression, expression
                                    : SyntaxFactory.IdentifierName("ImmutableDictionary"), name
                                    : SyntaxFactory.GenericName(
                                        identifier
                                        : SyntaxFactory.Identifier("CreateBuilder"), typeArgumentList
                                        : SyntaxFactory.TypeArgumentList(SyntaxFactory.SeparatedList<TypeSyntax>(new[]{
                                            SyntaxFactory.IdentifierName("Type"),
                                            SyntaxFactory.IdentifierName("Type"),
                                        })))))))))));
            ...
            foreach (var node in wrapperTypes)
            {
                ...
                staticCtorStatements =
                    staticCtorStatements.Add(SyntaxFactory.ExpressionStatement(SyntaxFactory.InvocationExpression(
                        expression
                        : SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression
                        ...
                        : SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList(new[]{
                            ...
                            SyntaxFactory.Argument(SyntaxFactory.InvocationExpression(
                                ...
                                : SyntaxFactory.MemberAccessExpression(
                                      SyntaxKind.SimpleMemberAccessExpression, expression
                                      : SyntaxFactory.IdentifierName("codeAnalysisAssembly"), name
                                      : SyntaxFactory.IdentifierName("GetType")),
                                  argumentList
                                : SyntaxFactory.ArgumentList(SyntaxFactory.SingletonSeparatedList(
                                    SyntaxFactory.Argument(SyntaxFactory.MemberAccessExpression(
                                        SyntaxKind.SimpleMemberAccessExpression, expression
                                        : SyntaxFactory.IdentifierName(node.WrapperName), name
                                        : SyntaxFactory.IdentifierName("WrappedTypeName"))))))),
                        })))));
            }
            ...
            staticCtorStatements =
                staticCtorStatements.Add(SyntaxFactory.ExpressionStatement(SyntaxFactory.AssignmentExpression(
                    SyntaxKind.SimpleAssignmentExpression, left
                    : SyntaxFactory.IdentifierName("WrappedTypes"), right
                    : SyntaxFactory.InvocationExpression(
                        SyntaxFactory.MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, expression
                                                             : SyntaxFactory.IdentifierName("builder"), name
            ...
            var staticCtor = SyntaxFactory.ConstructorDeclaration(
                ...
                : default, modifiers
                : SyntaxFactory.TokenList(SyntaxFactory.Token(SyntaxKind.StaticKeyword)), identifier
                : SyntaxFactory.Identifier("OperationWrapperHelper"), parameterList
                : SyntaxFactory.ParameterList(), initializer
                : null, body
                : SyntaxFactory.Block(staticCtorStatements), expressionBody
                : null);
                ...
                : SyntaxFactory.Block(
                      SyntaxFactory.IfStatement(
                          ...
                          : SyntaxFactory.InvocationExpression(
                                ...
                                : SyntaxFactory.MemberAccessExpression(
                                      SyntaxKind.SimpleMemberAccessExpression, expression
                                      : SyntaxFactory.IdentifierName("WrappedTypes"), name
                                ...
                                : SyntaxFactory.ArgumentList(SyntaxFactory.SeparatedList(new[]{
                                    ...
                                    SyntaxFactory.Argument(nameColon
                                                           : null, refKindKeyword
                                                           : SyntaxFactory.Token(SyntaxKind.OutKeyword), expression
                                                           : SyntaxFactory.DeclarationExpression(
                                                               type
                                                               : SyntaxFactory.IdentifierName("Type"), designation
                                                               : SyntaxFactory.SingleVariableDesignation(
                                                                   SyntaxFactory.Identifier("wrappedType")))),
                                }))),
                            statement
                          : SyntaxFactory.Block(
            ...
            getWrappedType = getWrappedType.WithLeadingTrivia(
                SyntaxFactory.TriviaList(SyntaxFactory.Trivia(SyntaxFactory.DocumentationComment(
                    ...
                    SyntaxFactory.XmlSummaryElement(
                        ...
                        SyntaxFactory.XmlNewLine(Environment.NewLine), SyntaxFactory.XmlText(" ")),
                    SyntaxFactory.XmlNewLine(Environment.NewLine), SyntaxFactory.XmlText(" "),
            ...
            var wrapperHelperClass = SyntaxFactory.ClassDeclaration(
                ...
                : SyntaxTokenList.Create(SyntaxFactory.Token(SyntaxKind.InternalKeyword))
                  ...
                  identifier
                : SyntaxFactory.Identifier("OperationWrapperHelper"), typeParameterList
                : null, baseList
                : null, constraintClauses
                : default, members
                : SyntaxFactory.List<MemberDeclarationSyntax>().Add(wrappedTypes).Add(staticCtor).Add(getWrappedType));
            var wrapperNamespace = SyntaxFactory.NamespaceDeclaration(
                name
                : SyntaxFactory.ParseName("StyleCop.Analyzers.Lightup"), externs
                : default, usings
                : SyntaxFactory.List<UsingDirectiveSyntax>()
                      ...
                      .Add(SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("Microsoft.CodeAnalysis"))),
                  members
                : SyntaxFactory.SingletonList<MemberDeclarationSyntax>(wrapperHelperClass));
            ...
            context.AddSource("OperationWrapperHelper.g.cs",
                              SourceText.From(wrapperNamespace.ToFullString(), Encoding.UTF8));
        }

        private void GenerateOperationKindEx(in GeneratorExecutionContext context,
                                             ImmutableArray<InterfaceData> wrapperTypes)
        {
            var operationKinds =
                wrapperTypes.SelectMany(type => type.OperationKinds).OrderBy(kind => kind.value).ToImmutableArray();
            ...
            foreach (var operationKind in operationKinds)
            {
                ...
                members = members.Add(SyntaxFactory.FieldDeclaration(
                    ...
                    : SyntaxFactory.VariableDeclaration(
                        type
                        : SyntaxFactory.IdentifierName("OperationKind"), variables
                        : SyntaxFactory.SingletonSeparatedList(SyntaxFactory.VariableDeclarator(
                            identifier
                            : SyntaxFactory.Identifier(operationKind.name), argumentList
                            : null, initializer
                            : SyntaxFactory.EqualsValueClause(SyntaxFactory.CastExpression(
                                type
                                : SyntaxFactory.IdentifierName("OperationKind"), expression
                                : SyntaxFactory.LiteralExpression(
                                    SyntaxKind.NumericLiteralExpression,
                                    SyntaxFactory.Literal($"0x{operationKind.value:x}", operationKind.value)))))))));
            }

            var operationKindExClass =
                SyntaxFactory.ClassDeclaration(attributeLists
                                               : default, modifiers
                                               : SyntaxTokenList.Create(SyntaxFactory.Token(SyntaxKind.InternalKeyword))
                                                     .Add(SyntaxFactory.Token(SyntaxKind.StaticKeyword)),
                                                 identifier
                                               : SyntaxFactory.Identifier("OperationKindEx"), typeParameterList
                                               : null, baseList
                                               : null, constraintClauses
                                               : default, members
                                               : members);
            var wrapperNamespace = SyntaxFactory.NamespaceDeclaration(
                ...
                : SyntaxFactory.ParseName("StyleCop.Analyzers.Lightup"), externs
                : default, usings
                : SyntaxFactory.List<UsingDirectiveSyntax>().Add(
                      SyntaxFactory.UsingDirective(SyntaxFactory.ParseName("Microsoft.CodeAnalysis"))),
                  members
                : SyntaxFactory.SingletonList<MemberDeclarationSyntax>(operationKindExClass));
        ...
        private sealed class DocumentData
        {
            ...
            public ReadOnlyDictionary<string, InterfaceData> Interfaces
            {
                get;
            }
            ...
            private static ImmutableDictionary<
                string,
                ImmutableArray<(string name, int value, string? extraDescription)>> GetOperationKinds(XDocument
                                                                                                          document)
            {
                ...
                var builder =
                    ImmutableDictionary
                        .CreateBuilder<string, ImmutableArray<(string name, int value, string? extraDescription)>>();
                ...
                if (node.XPathSelectElement("OperationKind") is {} explicitKind)
                {
                    ...
                    {
                        var nodeBuilder =
                            ImmutableArray.CreateBuilder<(string name, int value, string? extraDescription)>();
        ...
        private sealed class InterfaceData
        {
            ...
            public InterfaceData(DocumentData documentData, XElement node,
                                 ImmutableArray<(string name, int value, string? extraDescription)> operationKinds)
            {
                this.documentData = documentData;

                this.OperationKinds = operationKinds;
                this.InterfaceName = node.Attribute("Name").Value;
                this.Name = this.InterfaceName.Substring("I".Length,
                                                         this.InterfaceName.Length - "I".Length - "Operation".Length);
                ...
                this.Properties = node.XPathSelectElements("Property")
                                      .Select(property => new PropertyData(property))
                                      .ToImmutableArray();
            }

            public ImmutableArray<(string name, int value, string? extraDescription)> OperationKinds
            {
                get;
            }
            ...
            public ImmutableArray<PropertyData> Properties
            {
                get;
            }
        ...
        private sealed class PropertyData
        {
            public PropertyData(XElement node)
            {
                ...
                this.IsDerivedOperationArray =
                    IsAnyOperationArray(this.Type) && this.Type != "ImmutableArray<IOperation>";

                if (this.IsDerivedOperationArray)
                {
                    this.AccessorResultType = SyntaxFactory.GenericName(
                        identifier
                        : SyntaxFactory.Identifier("ImmutableArray"), typeArgumentList
                        : SyntaxFactory.TypeArgumentList(SyntaxFactory.SingletonSeparatedList<TypeSyntax>(
                            SyntaxFactory.IdentifierName("IOperation"))));
                }
            ...
            public bool IsDerivedOperationArray
            {
                get;
            }

            public TypeSyntax AccessorResultType
            {
                get;
            }
