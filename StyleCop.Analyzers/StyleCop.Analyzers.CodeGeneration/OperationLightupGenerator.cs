...
namespace StyleCop.Analyzers.CodeGeneration
{
        ...
        internal sealed class OperationLightupGenerator : ISourceGenerator
        {
                ...
                private void
                GenerateOperationInterfaces (in GeneratorExecutionContext context,
                ...
                private void
                GenerateOperationInterface (in GeneratorExecutionContext context,
                                            InterfaceData node)
                {
                        ...
                        foreach (var property in node.Properties)
                                {
                                        if (property.IsSkipped)
                                                {
                                                        // Generate a NotImplementedException for
                                                        // public properties that do not have a
                                                        // supported type
                                                        if (property.IsPublicProperty)
                                                                {
                                                                        // public object Constructor
                                                                        // => throw new
                                                                        // NotImplementedException("Property
                                                                        // 'Type.Property' has
                                                                        // unsupported type
                                                                        // 'Type'");
                                                                        members = members.Add (
                                                  ...
                                                  SyntaxFactory.SingletonSeparatedList (
                                                      SyntaxFactory.Parameter (
                                                          ...
                                                          : SyntaxFactory.IdentifierName (
                                                            ...
                                                            identifier
                                                          : SyntaxFactory.Identifier ("wrapper"),
                                                            @default
                                                          : null))),
                                              body
                                            : null, expressionBody
                        ...
                        if (node.IsAbstract)
                                {
                                        ...
                                        // {
                                        //     return new
                                        //     IMemberReferenceOperationWrapper(operation);
                                        // }
                                        members = members.Add (SyntaxFactory.MethodDeclaration (
                                            attributeLists
                                            : default, modifiers
                                            ...
                                            : SyntaxFactory.IdentifierName (node.WrapperName),
                                              explicitInterfaceSpecifier
                                            : null, identifier
                                            : SyntaxFactory.Identifier ("FromUpcast"),
                                              typeParameterList
                                            : null, parameterList
                                            : SyntaxFactory.ParameterList (
                                                  SyntaxFactory.SingletonSeparatedList (
                                                      SyntaxFactory.Parameter (
                                                          ...
                                                          : SyntaxFactory.IdentifierName (
                                                                "IOperation"),
                                                            identifier
                                                          : SyntaxFactory.Identifier ("operation"),
                                                            @default
                                                          : null))),
                                              constraintClauses
                                            : default, body
                ...
                private void
                GenerateOperationKindEx (in GeneratorExecutionContext context,
                                         ImmutableArray<InterfaceData> wrapperTypes)
                {
                        ...
                        foreach (var operationKind in operationKinds)
                                {
                                        // public const OperationKind FieldReference =
                                        // (OperationKind)26;
                                        members = members.Add (SyntaxFactory.FieldDeclaration (
                                            attributeLists
                                            : default, modifiers
                ...
                private sealed class DocumentData
                {
                    ...
                    if (node.XPathSelectElement ("OperationKind") is {} explicitKind)
                        ...
                        if (node.Name == "AbstractNode" && explicitKind.Attribute("Include")?.Value != "true")
                        ...
                        else if (explicitKind.XPathSelectElements ("Entry").Any ())
                                {
                                        ...
                                        foreach (var entry in explicitKind.XPathSelectElements (
                                                     "Entry"))
                                                {
                    ...
                    builder.Add (nodeName,
                        ...
                        private static int
                        ParsePrefixHexValue (string value)
                        {
                ...
                private sealed class PropertyData
                {
                        ...
                        private static bool
                        IsAnyOperation (string type)
                        {
                                return type.StartsWith ("I") && type.EndsWith ("Operation");
                        }

                        private static bool
                        IsAnyOperationArray (string type)
                        {
