                ...
                foreach (var projectDiagnostics in allDiagnostics)
                        {
                                foreach (var diagnostic in projectDiagnostics.Value)
                                        {
                                                if (!codeFixProvider.FixableDiagnosticIds.Contains (
                                                        diagnostic.Id))
                                                        {
                                                                continue;
                                                        }
                                                ...
                                                if (diagnostic.Location.IsInSource)
                                                        {
                                                                ...
                                                                if (!relevantDocumentDiagnostics
                                                                         .TryGetValue (
                                                                ...
                                                                if (!projectDocumentDiagnostics
                                                                         .TryGetValue (
                                                                             sourcePath,
                                                                             out diagnosticsInFile))
                                                                        {
                                                                                diagnosticsInFile
                                                                                    = new List<
                                                                                        Diagnostic> ();
                                                        ...
                                                        {
                                                                List<Diagnostic>
                                                                    diagnosticsInProject;
                                                                if (!relevantProjectDiagnostics
                                                                         .TryGetValue (
                                                                             projectDiagnostics.Key,
                                                                             out diagnosticsInProject))
                                                                        {
                                                                                diagnosticsInProject
                                                                                    = new List<
                                                                                        Diagnostic> ();
                                                                                relevantProjectDiagnostics
                                                                                    .Add (
                                                                                        projectDiagnostics
                                                                                            .Key,
                                                                                        diagnosticsInProject);
                ...
                foreach (var diagnostic in relevantDocumentDiagnostics.Values
                             ...
                             .Concat (relevantProjectDiagnostics.Values.SelectMany (i => i)))
                        {
                                foreach (var codeAction in await GetFixesAsync (
                                             solution, codeFixProvider, diagnostic,
                                             cancellationToken)
